...
本文从安全角度介绍了主题体验的工作方式，以及知识管理员和知识管理员控制主题可见性时必须选择的选项。 阅读本文作为主题 [体验规划的一部分](plan-topic-experiences.md)。

在阅读本文之前，你应该熟悉主题体验[](topic-center-overview.md)、主题中心以及如何使用主题[](work-with-topics.md)中心中的主题。 [](knowledge-management-overview.md)
