...
- 约旦 (一) 新角色，或已新雇用并刚开始担任角色的员工。 约旦希望尽快参与并提高工作效率。 但是，约旦也需要帮助，以找到起点。
...
- 在约旦阅读上的新帖子SharePoint，他们会看到一个主题突出显示，并悬停在其中，以快速获取术语的定义以及与更多问题联系的联系人。 以前，Jordan 可能只能四处搜索此信息，并联系同事来咨询。
...
在较大的组织中，你可能还具有多个担任这些角色的人，你需要推动他们之间的协调。 在规模较小的公司中，单个人员可能同时担任其中多个角色。 不同角色可能更深入地参与项目的不同阶段。 例如，租户管理员更参与设置功能，而主题专家和冠军不会参与，直到你开始定义主题。
...
许多冠军网络都Yammer平台。 在Yammer中，用户可以发布问题并获取答案，并分享成功案例。 很难单独指出这一点，因此您可以依赖整个公司中的人员网络向同行提供建议，并展示团队如何使用 Viva 主题，以便其他团队能够考虑自己的方案。
