...
- 约旦 (员工) 担任新角色，或已新雇用并刚开始担任一个角色。 约旦希望尽快参与并提高工作效率。 但是，约旦也需要帮助，以找到起点。
...
1. 对搜索分析的正面影响。 由于主题出现在搜索体验中，随着时间的推移，您可能会发现放弃的搜索的速率降低，因为用户更容易在搜索中查找主题。 
...
一些组织使用黑客攻击 (正式或非正式、虚拟或) ，以收集一组人员以处理特定项目。 例如，你可以集合主题专家，让他们一起协作，共同制定一组主题页面。
