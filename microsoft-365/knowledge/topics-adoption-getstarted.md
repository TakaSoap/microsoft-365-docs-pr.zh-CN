...
- 正在 (一) ，或已新雇用并刚开始担任新角色的员工。 约旦希望尽快参与并提高工作效率。 但是，约旦也需要帮助，以找到起点。
- 一位同事 (Kim) 在 Jordan 创建主题页之前担任该角色，该页面可帮助新员工和其他任何人查找该信息。
- Kim 是一名 SME，有权查看未确认的主题页面。 未确认主题页面是 AI 发现和创建的内容，是很好的起点，而 Kim 可以编辑它们以添加专家资源、定义和固定其他资源。
- 在约旦阅读 SharePoint文章时，他们会看到一个主题突出显示，并悬停在其中，以快速了解术语的定义以及与更多问题联系的联系人。 以前，Jordan 可能只能四处搜索此信息，并联系同事来咨询。
...
某些组织使用黑客攻击 (正式或非正式、虚拟或) 来收集一组人员以处理特定项目。 例如，你可以集合主题专家，让他们一起协作，共同制定一组主题页面。
