...
> [!TIP]
> 必须在 Yammer 中创建与 office 365 相连的 Yammer 组，但可以在 Microsoft 365 管理中心（如其他 Office 365 组）中进行管理。 有关详细信息，请参阅 [Yammer 和 Office 365 组](https://support.office.com/article/d8c239dc-a48b-47ab-b85e-6b4b8191a869.aspx)。 
...
1. 在 "[管理中心](https://go.microsoft.com/fwlink/p/?linkid=848041)" 中，转到 "**组** > **组**" 页面。 

::: moniker-end

::: moniker range="o365-21vianet"

1. 在 "[管理中心](https://go.microsoft.com/fwlink/p/?linkid=850627)" 中，转到 "**组** > **组**" 页面。 
...
1. 在管理中心内刷新页面，以便显示新组，选择 "**组** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2052855" target="_blank">" 组</a>，然后选择要向其添加成员的组的名称。
...
## <a name="who-can-delete-email-from-the-group-inbox"></a>谁可以从"组收件箱"中删除电子邮件？
...
创建新组并添加成员后，可以进一步配置组，例如编辑组名称或说明、更改所有者或成员，以及指定外部发件人是否可以通过电子邮件发送组以及是否发送组的副本到成员的对话。 请参阅[管理 Office 365 组](manage-groups.md)。

## <a name="related-articles"></a>相关文章

[管理 Office 365 组](manage-groups.md)
