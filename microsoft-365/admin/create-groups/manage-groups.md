...
1. 在管理中心，展开 **"组"**，然后单击"组 <a href="https://go.microsoft.com/fwlink/p/?linkid=2052855" target="_blank">**"**</a>。
...
通过选择停止在电子邮件中跟踪组，组成员可以选择Outlook。

1. 在管理中心，展开 **"组"**，然后单击"组 <a href="https://go.microsoft.com/fwlink/p/?linkid=2052855" target="_blank">**"**</a>。

2. 单击要管理的组的名称以打开设置窗格。

3. 如果您希望 **设置** 收件箱中的组邮件和日历项目的副本，请在"组设置"选项卡上，选择"将组对话和事件的副本发送给组成员"。
...
[允许成员以组或代表组Microsoft 365发送](../../solutions/allow-members-to-send-as-or-send-on-behalf-of-group.md)
