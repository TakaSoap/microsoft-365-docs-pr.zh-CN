...
Office 365 德国在欧洲可提供的 Office 365 服务是一种不同的选择。 它通过为数字工作提供业界一流的工作效率服务（从德国数据中心起使用数据），帮助您满足德国最受管控客户的需求，即欧盟（EU）和欧洲自由贸易协会（EFTA）。通过由德语法律管理的独特的数据受信者模型，通过德国的派驻服务和严格的数据访问和控制措施。
...
- Office 365 专业增强版、Office 2016 和 Office 2013<sup>1</sup>。 请注意，Office 2013 需要[对 office 客户端使用 office 365 新式验证](https://docs.microsoft.com/office365/enterprise/modern-auth-for-office-2013-and-2016)。
...
<sup>1</sup>Office 365 Germany 计划包括最终用户设备上安装和运行的软件应用程序（客户端软件应用程序），例如 Office 365 ProPlus、Office 2013 和 Office 2016。客户端软件应用程序不会只在德国数据中心内专门运营，并且可以使最终用户访问不是[德语联机服务](http://microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&amp;DocumentTypeId=58)的联机服务。考虑到你与 Microsoft 之间的协议，客户端软件应用程序不是[德语联机服务](http://microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&amp;DocumentTypeId=58)。德国数据被信任方提供的德语数据驻留承诺和访问控制仅适用于[德语联机服务](http://microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&amp;DocumentTypeId=58)。
...
|IP 地址和 URL  <br/> |请参阅 [Office 365 德国版终结点](https://docs.microsoft.com/office365/enterprise/office-365-germany-endpoints)。  <br/> |
|Yammer  <br/> |不可用。  <br/> |
|早于 Office 2013 或 Office 365 ProPlus 的 Office 版本<sup>1</sup> <br/> |不支持。  <br/> |
|Office Lens  <br/> |不可用。  <br/> |
|从 Office 365 中购买域的能力  <br/> |不可用。  <br/> |
...
若要更详细了解每个 Office 365 计划的可用服务，请参阅 [Office 365 服务说明](https://docs.microsoft.com/office365/servicedescriptions/office-365-platform-service-description/office-365-platform-service-description)。
