...
|能否先预览更改或功能，然后再将更改或功能推出到我的组织？|通过选择加入定向发布计划，可以预览一些更改和新功能。 若要选择加入，在管理中心中，转到"设置"  >  **组织设置**  >  **""组织配置文件**  >  **""发布首选项"。**  (在管理中心中，可能需要选择左侧导航窗格底部的"全部显示"以查看 **设置**.) 可以选择整个组织的定向发布，或仅针对所选用户。 有关[计划的详细信息，请参阅 Microsoft 365](release-options-in-office-365.md)中的标准或定向发布选项。|
...
3. 摘要式电子邮件默认打开，并发送到主电子邮件地址。 若要停止接收每周摘要，请将"发送我的邮件的 **每周** 摘要"设置更改为"**关闭"。**
   ...
   可以选择或清除主电子邮件地址，但无法更改它。 若要指定将每周电子邮件摘要发送到的其他电子邮件地址，**请验证"** 每周发送我的邮件摘要"是否 **为"打开"。** 如果超过两个人应收到摘要电子邮件，Microsoft 365组或通讯组列表的电子邮件地址。
...
|标记|您可以从"标记"下拉列表 **中选择** 标记以筛选邮件。 可用的标记包括：**管理员影响**、**主要更新、****数据** 隐私、**功能更新**、**新功能**、**停用** 和 **用户影响**。|
...
[管理Office](../manage/show-hide-new-features.md)新增功能"一文 (显示哪些) \
