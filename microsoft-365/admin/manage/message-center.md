...
您还可以使用移动设备上的[Microsoft 365 管理](https://go.microsoft.com/fwlink/p/?linkid=627216)应用查看消息中心，这是一种使用推送通知保持最新状态的方式。
...
|类别| 默认情况下，这不会显示，但可以在"选择列" **面板中** 指定。 邮件由以下三个类别之一标识： <p> **防止或修复问题**：告知您影响组织的已知问题，并可能要求您采取措施以避免服务中断。 防止或修复问题不同于服务运行状况消息，因为它们会提示你主动避免问题。 <p> **规划更改**：通知你更改Microsoft 365可能需要你采取行动以避免服务中断。 例如，我们将让您了解对系统要求的更改或要删除的功能。 我们尝试至少提前 30 天通知任何需要管理员采取行动以保持服务正常运行的任何更改。 <p> **及时了解**：告知你在组织中即将启用的新功能或更新功能。 这些功能通常先在路线图 中Microsoft 365[公布](https://go.microsoft.com/fwlink/?linkid=2070821)。 <p> 还可根据我们的服务级别协议告知您计划维护。 计划的维护可能会导致关闭时间，你或你的用户无法访问Microsoft 365、特定功能或电子邮件或OneDrive for Business。|
