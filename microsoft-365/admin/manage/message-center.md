...
|这些邮件是否特定于我的组织？|我们会尽力确保只看到影响组织的邮件中心帖子。 该Microsoft 365路线图包含我们当前正在开发并推出的所有功能，但并非所有这些功能都适用于每个组织。|
...
如果管理分布在整个组织中，您可能不希望或不需要查看有关所有 Microsoft 365的文章。 每个管理员可以：
...
|标记| 您可以从"标记"下拉列表中选择标记以筛选邮件。 <br> <p> **数据隐私**：数据隐私 (仅限于全局管理员和消息中心隐私读者角色) 。 <p> **主要更新**：更改至少提前 30 天 ([主要更新)](#major-updates) 。 <p> **停用**：停用服务或功能。 <p> **新功能：** 新功能或服务。 <p> **功能更新**：更新到现有功能。 <p> **管理员影响**：当更改以以下方式明确影响管理员时 - UI 更改、工作流更改、控制可用和特定/潜在操作。 <p> **用户影响**：当服务更改明确影响用户时 - UI 更改和工作流更改。 <p> **更新消息**：更新邮件时。|
|类别| 默认情况下，这不会显示，但可以在"选择列" **面板中** 指定。 邮件由以下三个类别之一标识： <p> **防止或修复问题**：告知您影响组织的已知问题，并可能要求您采取措施以避免服务中断。 防止或修复问题不同于服务运行状况消息，因为它们会提示你主动避免问题。 <p> **规划更改**：告知您更改Microsoft 365可能需要您采取行动以避免服务中断。 例如，我们将让您了解对系统要求的更改或要删除的功能。 我们尝试至少提前 30 天通知任何需要管理员采取行动以保持服务正常运行的任何更改。 <p> **及时了解**：告知你在组织中即将启用的新功能或更新功能。 这些功能通常先在路线图中Microsoft 365[公布](https://go.microsoft.com/fwlink/?linkid=2070821)。 <p> 还可根据服务级别协议告知您有关计划维护。 计划的维护可能会导致关闭时间，你或你的用户无法访问Microsoft 365、特定功能或电子邮件或OneDrive for Business。|
