...
3. 摘要式电子邮件默认打开并发送到主电子邮件地址。 若要停止接收每周摘要，请将"发送我的邮件的 **每周** 摘要"设置更改为"**关闭"。**
   ...
   可以选择或清除主电子邮件地址，但无法更改它。 若要指定将每周电子邮件摘要发送到的其他电子邮件地址，**请验证"** 每周发送我的邮件摘要"是否 **为"打开"。** 如果超过两个人应收到摘要Microsoft 365，请输入组或通讯组列表的电子邮件地址。
