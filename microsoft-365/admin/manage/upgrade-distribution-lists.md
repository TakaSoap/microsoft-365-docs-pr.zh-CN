...
2. In the Classic Exchange admin center， go to **Recipients** \> **Groups**.<br/>你将看到一条通知，指示你拥有一个通讯 (也称为) 有资格升级到通讯组Microsoft 365组。<br/> ![选择"开始"按钮。](../../media/8cf838b4-2644-401f-a366-08c1eea183eb.png)
