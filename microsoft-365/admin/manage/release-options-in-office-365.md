...
> [!IMPORTANT]
> 本文中所述的 Microsoft 365 更新适用于 Microsoft 365、SharePoint Online 和 Exchange Online。 这些发布选项的目标是，将更改发布到 Microsoft 365 的最佳方法是，但不能始终保证，也不能保证所有更新。 它们不适用于 Microsoft 365 应用、Skype for Business、Microsoft 团队和相关服务。 有关 Microsoft 365 应用的版本选项的信息，请参阅 [microsoft 365 应用的更新通道概述](https://docs.microsoft.com/deployoffice/overview-update-channels)。
