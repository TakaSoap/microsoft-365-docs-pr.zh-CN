...
## <a name="give-feedback-on-a-post"></a>提供有关帖子的反馈
...
如果您看到一条不适合您的消息，或者您已对其进行处理，则可以将邮件存档以将其从 "消息中心" 视图中删除。 您在邮件中心中看到的视图特定于您的用户帐户，因此从您的视图存档它不会影响其他管理员。

::: moniker range="o365-worldwide"

- 在邮件中心的主页上，选择一封邮件，然后选择邮件列表上方的 "**存档**"。

- 打开邮件，然后选择邮件底部的 "**存档**"。

需要获取存档的邮件？ 没关系。
  
1. 选择邮件中心顶部的 "已**存档的邮件**" 选项卡。 将显示已存档的邮件的列表。 
...
1. 从 "**视图**" 下拉菜单中选择 "**存档的邮件**" 筛选器。 将显示已存档的邮件的列表。
