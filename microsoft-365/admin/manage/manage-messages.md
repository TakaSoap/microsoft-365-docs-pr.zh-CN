...
消息中心帖子是有关新功能和已更改功能的重要通知。 本文提供有关可以通过邮件执行来帮助你组织更改管理这一功能详细信息。
  
## <a name="read-a-message"></a>阅读邮件

要转到消息中心，请转到消息 [管理](https://go.microsoft.com/fwlink/p/?linkid=2024339)，然后选择 **运行状况** > **中心**。

选择邮件标题，在阅读窗格中将其打开。 每封邮件都包含更改的摘要、更改可能会影响您的声明、有关您的组织如何为更改做好准备的信息，以及（在大多数情况下）您可以在其中了解详细信息的其他信息链接。 即使邮件过期，其他信息仍可用。
