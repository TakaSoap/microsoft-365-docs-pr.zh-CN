...
若要更改与帐单或订阅关联的地址，请参阅更改适用于Microsoft 365[帐单地址](../../commerce/billing-and-payments/change-your-billing-addresses.md)。

## <a name="change-organization-settings-for-cloud-pcs"></a>更改云电脑的组织设置

默认情况下，使用 Windows 11 操作系统和标准用户帐户类型创建新的云电脑。 若要更改这些默认设置，请使用以下步骤：

1. 使用全局管理员Microsoft 365 管理中心登录帐户。
2. 转到"**设置** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2053743" target="_blank">**组织设置"**</a>页。
3. 在"服务 **"** 选项卡上，**选择"Windows 365"**。
4. 选择首选的操作系统和帐户类型，然后选择"保存 **"**。

组织设置仅适用于新创建的云电脑。 更改这些设置后，它们不会更改现有云电脑的 OS 或帐户类型。
...
|地址、城市、省/自治区/直辖市、邮政编码  <br/>     | 此处输入的地址就是将在帐单上看到的地址，位于"售达"下：帐单上的"售达"地址与配置文件页面上的组织地址相同 (请参阅了解 [Microsoft 365 商业版帐单或发票](../../commerce/billing-and-payments/understand-your-invoice2.md)。  <br/>        |
