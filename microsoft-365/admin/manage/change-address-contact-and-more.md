...
您可以更改组织配置文件，如组织名称、地址、电话和技术联系人。 **必须是全局管理员才能更新此信息。**
  
若要更改与帐单或订阅关联的地址，请参阅更改 [Microsoft 365 商业版帐单邮寄地址](../../commerce/billing-and-payments/change-your-billing-addresses.md)。
...
1. 在管理中心， **转到"设置** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2053743" target="_blank">**组织设置"**</a> 页。
