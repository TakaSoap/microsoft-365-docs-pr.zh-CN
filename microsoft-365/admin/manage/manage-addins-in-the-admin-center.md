...
> [!NOTE]
> 阻止用户访问 office 应用商店也会阻止用户 [旁加载 Office 外接程序进行测试](https://docs.microsoft.com/office/dev/add-ins/testing/create-a-network-shared-folder-catalog-for-task-pane-and-content-add-ins)。
