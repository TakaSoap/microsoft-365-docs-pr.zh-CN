...
可在“**活动用户**”页面或“**许可证**”页面上向用户分配许可证。 使用哪种方法取决于是要向特定用户分配产品许可证还是向特定产品分配用户许可证。
...
## <a name="assign-licenses-to-multiple-users-on-the-active-users-page"></a>在“活动用户”页面上向多名用户分配许可证
...
## <a name="assign-licenses-to-one-user-on-the-active-users-page"></a>在“活动用户”页面上向一名用户分配许可证

::: moniker range="o365-worldwide"

1. 在管理中心，转到“**用户**\><a href="https://go.microsoft.com/fwlink/p/?linkid=834822" target="_blank">活动用户</a>”页面。

2. 在“**活动用户**”页面上，选择要向其分配许可证的用户的行。
...
若有多个订阅，且某些用户已拥有某订阅的许可证，但你想要将其移动到其他订阅，则可将其现有许可证替换为不同的许可证。

::: moniker range="o365-worldwide"

1. 在管理中心，转到“**用户**\><a href="https://go.microsoft.com/fwlink/p/?linkid=834822" target="_blank">活动用户</a>”页面。

2. 选中要为其替换现有许可证的用户的姓名旁边的圆圈。

3. 在顶部选择“**更多选项(...)**”，然后选择“**管理产品许可证**”。

4. 在“**管理产品许可证**”窗格中，选择“**替换现有产品许可证分配**”\>“**下一步**”。

5. 将想要分配给这些用户的许可证的开关切换到“**开**”位置。
...
- 使用这些步骤向现有用户帐户添加许可证。请[了解如何同时添加用户帐户和分配许可证](../add-users/add-users.md)
...
[购买订阅的许可证](../../commerce/licenses/buy-licenses.md)