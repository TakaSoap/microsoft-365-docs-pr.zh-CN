...
- 保存OneDrive for Business文件不会删除，除非用户已从 active Directory Microsoft 365 管理中心或 Active Directory 同步删除。 有关详细信息，请参阅OneDrive[和删除](/onedrive/retention-and-deletion)。
