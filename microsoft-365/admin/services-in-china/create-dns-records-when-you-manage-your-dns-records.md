...
- 若要查看哪些 DNS 记录是必需的，并查找要用于每条记录的值，包括用于电子邮件的 MX 记录，请参阅 [收集创建 Office 365 DNS 记录时](../get-help-with-domains/information-for-dns-records.md)。 有关 DNS 记录功能的说明，请参阅 [DNS 基础知识](../get-help-with-domains/dns-basics.md)。
