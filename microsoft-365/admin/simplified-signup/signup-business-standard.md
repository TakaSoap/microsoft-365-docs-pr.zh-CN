...
2. 在下一页上，找到每月成本，然后向下滚动页面以了解有关该页面中包含的内容Microsoft 365。 在Microsoft 365 商业标准版下，选择立即 **购买**。
...
**适用于：之前使用简化Microsoft 365 商业标准版购买的用户的现有订阅者**。
...
- 您可以购买一个新域，使电子邮件地址更加 (mybusinessname@contoso.com) 。
- 使用已拥有的域名。
