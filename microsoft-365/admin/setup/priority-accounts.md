...
- **优先级帐户** 保护 - 适用于Office 365 (高级威胁Office 365的 Microsoft Defender) 支持优先帐户作为标记，可在警报、报告和调查的筛选器中使用。 有关详细信息，请查看 Microsoft Defender for Office 365 中的[用户标记](../../security/office-365-security/user-tags.md)。
...
2. 转到"**用户**""活动用户"，然后选择三个点 (页面上) 显示  >  更多操作。 选择 **管理优先级帐户**。
