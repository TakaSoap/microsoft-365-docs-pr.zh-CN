...
- 如果您的组织的域名 (如 contoso.com) **，并且** 您计划使用 Microsoft 电子邮件，则需要知道您的域的注册位置并具有登录信息。
...
组织中的每个人都可以在最高5台电脑和 Mac 上安装 Office 2016 套件应用程序 (Word、Excel、PowerPoint 等) 。 请参阅安装 [Office 2016 套件](https://go.microsoft.com/fwlink/?LinkId=534827)商业版的操作系统和计算机要求。
...
- 若要将您的业务电子邮件地址 (如 * \@ Contoso.com*) 从其他电子邮件服务移动到 Microsoft 365，您需要将您的邮件传递到新的 microsoft 365 邮箱。 若要执行此操作，请选择 "**设置**" 页上的 **"迁移用户的数据"** ，我们将指导您完成需要在域主机上进行的更新（分步步骤）。
...
- **是否想要与你的本地 Active Directory 集成？** 您可以使用 Azure Active Directory Connect 将本地 Active Directory 与 Microsoft 365 集成。 有关说明，请参阅 [设置 Microsoft 365 的目录同步](https://docs.microsoft.com/microsoft-365/enterprise/set-up-directory-synchronization)。
...
- **如果你的员工不到 50 人：**
  ...
  - **寻求帮助，我们将为你打电话**。 在购买 Microsoft 365 后，您可以访问管理中心 (无需运行安装程序即可) 获取它。 在管理中心的底部，选择 **"需要帮助？"** 描述你的问题，我们将为你打电话。 
  - 请**致电[Microsoft 365 以获取有关你的问题的商业支持](../contact-support-for-business-products.md)**。 We're here to help! 
  - **考虑雇用 [Microsoft 合作伙伴](https://go.microsoft.com/fwlink/?linkid=391089)** 。 如果你的时间较短，或者有高级要求 (例如将数千个文件移至 Microsoft 365 云存储或与其他软件) 集成，则有经验的合作伙伴可能是一个很大的帮助。 
