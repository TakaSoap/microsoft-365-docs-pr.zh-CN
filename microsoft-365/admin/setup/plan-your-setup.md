...
如果未完成安装向导，则你随时都可以从管理中心设置完成 [设置](https://go.microsoft.com/fwlink/p/?linkid=2024339) > **任务**。 你可以在此处从另一个电子邮件服务迁移电子邮件和联系人、更改管理员帐户的域、管理帐单信息、添加或删除用户、重置密码以及执行其他业务功能。 有关安装向导和"安装"页之间的差异详细信息，请参阅安装程序向导和Microsoft 365[设置页面之间的差异](o365-setup-wizard-and-setup-page.md)。
...
- 若要设置与本地 Active Directory 的目录同步，请参阅为 [Microsoft 365](../../enterprise/set-up-directory-synchronization.md) 设置目录同步，并了解 Microsoft 365 中的不同标识模型，请阅读部署 Microsoft 365 的标识[基础结构](../../enterprise/deploy-identity-solution-overview.md)。
...
- **是否要逐渐移动到Microsoft 365？** 如果要分步移动到Microsoft 365，请跳过运行 Microsoft 365 安装向导，并考虑按以下Microsoft 365采用这些功能：
    ...
    3. [设置Microsoft Teams](#plan-for-teams)用于会议。

    4. [将内容移动到Microsoft 365云存储](set-up-file-storage-and-sharing.md) (OneDrive或SharePoint团队) 。
...
如果计划从现有电子邮件服务移动到 Microsoft 365，通常需要两天时间进行切换。
...
对于大型组织，或者如果你从Skype for Business内部部署或混合部署开始，请参阅如何部署[Microsoft Teams。](/MicrosoftTeams/how-to-roll-out-teams)
...
- **您是否希望将Microsoft 365与其他公司的软件集成？** 如果需要将 Microsoft 365与组织的其他软件集成，建议考虑雇用合作伙伴来帮助进行部署。[](https://go.microsoft.com/fwlink/?linkid=391089)
...
- **如果你的员工不到 50 人：**
  ...
  - **考虑雇用 [Microsoft 合作伙伴](https://go.microsoft.com/fwlink/?linkid=391089)** 。 如果你的时间很短，或者对 (如将数千个文件移动到 Microsoft 365 云存储或与其他软件) 集成，经验丰富的合作伙伴可能会大有帮助。 
