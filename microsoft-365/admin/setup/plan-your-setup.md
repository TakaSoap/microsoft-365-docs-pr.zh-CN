...
如果未完成安装向导，则你随时都可以从管理中心安装程序 [完成安装](https://go.microsoft.com/fwlink/p/?linkid=2024339)  >  **任务**。 你可以在此处从另一个电子邮件服务迁移电子邮件和联系人、更改管理员帐户的域、管理帐单信息、添加或删除用户、重置密码以及执行其他业务功能。 有关安装向导和"安装"页之间的差异详细信息，请参阅安装程序向导和["Microsoft 365"页面之间的差异](o365-setup-wizard-and-setup-page.md)。
...
- 若要设置与本地 Active Directory 的目录同步，请参阅为[Microsoft 365](../../enterprise/set-up-directory-synchronization.md)设置目录同步，若要了解 Microsoft 365 中的不同标识模型，请阅读了解[Microsoft 365 标识和 Azure Active Directory。](../../enterprise/about-microsoft-365-identity.md)
...
- **是否要逐渐移动到Microsoft 365？** 如果要分步移动到 Microsoft 365，请跳过运行 Microsoft 365 安装向导，并考虑按以下Microsoft 365采用这些功能：
...
- 若要将企业电子邮件地址 (（如 *rob \@ contoso.com*) ）从另一个电子邮件服务移动到 Microsoft 365，需要将邮件传递到新的 Microsoft 365 邮箱。 为此，在"设置"页上选择"迁移用户数据"，我们会逐步指导你在域主机上完成所需的更新。
...
- **是否要将Microsoft 365与其他公司的软件集成？** 如果需要将 Microsoft 365与组织的其他软件集成，建议考虑雇用合作伙伴来帮助你进行部署。 [](https://go.microsoft.com/fwlink/?linkid=391089)
...
- **如果你的员工不到 50 人：**
  ...
  - **如果 [Microsoft 365问题，请致电](../../business-video/get-help-support.md)商业支持人员**。 We're here to help! 
