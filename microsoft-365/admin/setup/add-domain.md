...
5. 选择要验证您是否拥有域的方式。
    ...
    1. 如果你的域注册机构使用[域连接](#domain-connect-registrars-integrating-with-microsoft-365)，**请选择 "**  >  **下一步**"，Microsoft[将自动设置你的记录](../get-help-with-domains/domain-connect.md)。
    ...
    4. 您可以向域的网站中添加文本文件。 从安装向导中选择并下载 .txt 文件，然后将该文件上传到网站的顶层文件夹中。 文件的路径看起来应类似于： `http://mydomain.com/ms39978200.txt` 。 我们将通过在你的网站上查找文件来确认你是否拥有此域。
