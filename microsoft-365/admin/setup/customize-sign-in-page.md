...
如果你有适用于企业Microsoft 365、Microsoft Dynamics CRM Online、Enterprise Mobility Suite 或其他 Microsoft 服务 的付费订阅，那么你可以免费订阅 Azure Active Directory。 可以使用 Azure Active Directory创建和管理用户和组帐户，以及向页面添加公司品牌。 若要激活此订阅并Microsoft Azure管理门户，必须完成一次注册过程。 之后，你可以从Azure Active Directory Microsoft 服务访问它。 有关如何注册你的 Microsoft 365 订阅的说明，请参阅注册你的免费[Azure Active Directory](../../compliance/use-your-free-azure-ad-subscription-in-office-365.md)订阅，并参阅在[Azure](/azure/active-directory/fundamentals/active-directory-how-subscriptions-associated-directory)中管理 Microsoft 365 订阅的目录，了解常规管理说明。 
...
[设置向导和安装程序页面之间的差异 (](o365-setup-wizard-and-setup-page.md) 文章) \
