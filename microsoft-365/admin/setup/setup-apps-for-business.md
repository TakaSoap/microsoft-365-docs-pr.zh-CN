...
你还可以将自定义域（如 *contoso.com*）添加到你的帐户，以个性化设置电子邮件（如果尚未这样做）。 有关详细信息，请参阅[添加域](add-domain.md)。

## <a name="finish-setting-up"></a>完成设置

按照以下步骤设置 Outlook 和 OneDrive。
...
## <a name="set-up-onedrive-for-business"></a>设置 OneDrive for Business
