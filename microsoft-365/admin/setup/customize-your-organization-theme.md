...
您将立即在管理中心中看到新主题，并在短暂延迟之后看到365它，其中包括 Outlook、SharePoint 以及适用于 iOS 和 Android 的 SharePoint 移动应用程序中的页面。 下图突出显示了您可以为 Sharepoint 移动应用程序自定义的主题元素。

![SharePoint 移动应用程序的默认 Office 365 主题和自定义 Office 365 主题]()
