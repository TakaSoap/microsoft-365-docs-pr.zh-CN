...
Office 365 提供了两种安装体验： 

- 使用安装向导初始设置
- 使用**设置**页面的持续和高级设置

安装向导提供了设置基本 Office 365 配置的指导性演练。 完成初始设置后，可以转到 "**设置**" 页，完成设置和配置订阅附带的服务。
...
若要访问[管理中心](https://go.microsoft.com/fwlink/p/?linkid=2024339)中的 "**设置**" 页面，请在导航窗格中选择 "**设置**"。 根据你购买的产品，你已设置的功能以及管理员角色、来自 Office 365 的任务和相关信息都在此处介绍。
