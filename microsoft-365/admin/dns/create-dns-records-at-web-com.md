...
---
# <a name="create-dns-records-at-webcom-for-microsoft"></a>在 Microsoft web.com 创建 DNS 记录

 如果找不到要查找的内容，请 **[查看域常见问题解答](../setup/domains-faq.yml)**。 
  
如果 web.com DNS 托管提供商，请按照本文中的步骤验证域，并设置电子邮件、Skype for Business Online 等的 DNS 记录。
  
在添加这些记录 web.com，域将设置为使用 Microsoft 服务。
...
4. 在 **"邮件服务器 (MX** 记录) ，单击"编辑 **MX** 记录"，然后从下表中选择值。 
    
    |**优先级**|**TTL**|**邮件服务器**|
    |:-----|:-----|:-----|
    |1  <br/> 有关优先级的详细信息，请参阅[什么是 MX 优先级？](../setup/domains-faq.yml) <br/> |3600  <br/> |*\<domain-key\>*  .mail.protection.outlook.com  <br/> **注意：** 从  *\<domain-key\>*  Microsoft 帐户获取你的信息。   [如何查找此项？](../get-help-with-domains/information-for-dns-records.md) |
...
> [!IMPORTANT]
> 请记住，web.com 负责提供此功能。 如果您看到以下步骤与图形用户界面用户界面中的 web.com GUI (差异) ，请利用 web.com [Community](https://community.web.com.com/)。 
...
4. 添加两条 SRV 记录中的第一条记录。
    ...
    在 **" (SRV** 记录) 下，单击"编辑 **SRV** 记录"，然后从下表中选择值。 
