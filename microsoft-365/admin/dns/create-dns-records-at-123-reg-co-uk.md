...
7. 添加其他 5 条 CNAME 记录。
    ...
    在 **"高级 DNS"** 部分中，使用表中下一行的值创建记录，然后再次选择"添加"以完成该记录。 
