...
---
# <a name="create-dns-records-at-dreamhost-for-microsoft"></a>在 Dreamhost 为 Microsoft 创建 DNS 记录

 如果找不到要查找的内容，请 **[查看域常见问题解答](../setup/domains-faq.yml)**。 
  
如果 DreamHost 是 DNS 托管提供商，请按照本文中的步骤验证域并设置电子邮件、Lync 等的 DNS 记录。
 
在 DreamHost 添加这些记录后，你的域将设置为使用 Microsoft 服务。
...
1. To get started， go to your domains page at DreamHost by using [this link.](https://panel.dreamhost.com/) 系统将提示你登录。
    
    ![Dreamhost-BP-Configure-1-1](../../media/1919b810-b6ba-4e29-a774-de1e7c67d078.png)
  
2. 在" **仪表板"** 页上，选择 **"域**"，然后 **管理域**。
    
    ![Dreamhost-BP-Configure-1-2](../../media/ab05c16a-79f6-491f-ad07-9a2e6674671d.png)
  
3. 在 **"管理域**"页上的"域"部分，选择要编辑的域的 **DNS。** 
...
2. 在"**仪表板"** 页上，**选择"邮件**"，然后选择"**自定义 MX"。**
    
    ![Dreamhost-BP-Configure-2-1](../../media/58478679-4018-49cc-9d83-371dc5fa4a22.png)
  
3. 在 **"管理邮件传递"部分** 中的"操作 **"列中**，选择要编辑的域的"编辑"。 
    
    ![Dreamhost-BP-Configure-2-2](../../media/6eed0be2-6477-4f49-9f90-39e190499a53.png)
  
4. 在 **"自定义 MX 记录** "部分的新记录的框中，键入或复制粘贴下表中的以下值。 
    
    （您可能需要向下滚动。）
    
     (如果存在任何其他现有 MX 记录，请标记要删除的记录。) 
    
    |**MX 记录 (必需)**|
    |:-----|
    |0  *\<domain-key\>*  .mail.protection.outlook.com.  <br/> **此值必须以句点 (.) 结尾。** <br/> 0 是 MX 优先级值。 将其添加到 MX 值的开头，使用一个空格将其与其余部分隔开。  <br/> **注意：** 从  *\<domain-key\>*  Microsoft 帐户获取你的帐户。           [如何查找此项？](../get-help-with-domains/information-for-dns-records.md)          |
   
    ![Dreamhost-BP-Configure-2-3](../../media/90da1816-e186-4016-ab22-7962f8b86add.png)
  
5. 选择 **"更改此域"以现在使用自定义 MX 记录！**
    
    ![Dreamhost-BP-Configure-2-4](../../media/3221c767-83d3-4f30-9d08-dc998772d2a3.png)
  
6. 如果存在任何其他现有 MX 记录，请通过选择该条目，然后按键盘上的 **Delete** 键来删除每条记录。 
    
    ![Dreamhost-BP-Configure-2-5](../../media/1827733c-3609-4b0f-bba1-531ab090da91.png)
  
7. 如果已删除任何记录，请选择"立即 **更新自定义 MX 记录"！**
...
4. 在 **"添加自定义 DNS** 记录"部分的新记录的框中，键入或复制粘贴下表中第一行的值。 
...
6. 使用上述两个步骤和表中其他五行的值，添加其他五条 CNAME 记录。
...
6. 使用上述两个步骤和表中第二行的值，添加另一条 SRV 记录。
