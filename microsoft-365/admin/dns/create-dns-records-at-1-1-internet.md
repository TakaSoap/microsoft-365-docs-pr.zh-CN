...
请执行以下步骤或 [观看视频 (从 3:22) 开始 ](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-1-1-internet)。
...
5. 在 " **MX 记录** " 部分的 **邮件交换器 (MX 记录) ** 区域中，选择 " **其他邮件服务器**"。<br/>（您可能需要向下滚动。）<br/>![1 &amp; 1-BP-配置-2-1](../../media/b0db72ae-9431-460f-ba7a-3268590b892e.png) <br/>
  
6. 如果已列出任何 MX 记录，请选择该记录，然后按键盘上的 **delete** 键，将其删除。<br/> (如果尚未列出任何 MX 记录，请继续执行下一步。 ) <br/>![1 &amp; 1-BP-配置-2-2](../../media/4a39bac7-7310-481d-bda4-1dd5c220c60f.png)<br/>
  
7. 在 " **MX 1** " 记录的框中，键入或复制并粘贴下表中的值。 
    
    |**MX 1**|**Priority**|
    |:-----|:-----|
    | *\<domain-key\>*  .mail.protection.outlook.com  <br/>  注意： \<domain-key\> 从你的 Microsoft 帐户获取。 如何查找此内容？[](../get-help-with-domains/information-for-dns-records.md)          |10    <br/> 有关优先级的详细信息，请参阅[什么是 MX 优先级？](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq) <br/> | 
    
    ![1和 1-配置2和3](../../media/3afb04d1-7bbf-4147-89ae-561e14ded26d.png)<br/>
  
8. 选择“**保存**”。<br/>（您可能需要向下滚动。）<br/>![1 &amp; 1-BP-配置-2-4](../../media/355b3ba7-4d2b-45ed-aa17-ac4affb54fe3.png)
...
请执行以下步骤或 [观看视频 (从 3:57) 开始 ](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-1-1-internet)。
...
7. 在 " **子域概述** " 部分，找到刚创建的 " **自动发现** " 子域，然后选择该子域的 **" (v) 控制" 面板 ** 。 <br/>![1 &amp; 1-BP-配置-3-4](../../media/10e2e446-3e54-4fb2-8a29-8c442536cc31.png)
  
8. 在 " **子域设置** " 区域中，选择 " **编辑 DNS 设置**"。 <br/>![1 &amp; 1-BP-配置-3-5](../../media/5c602118-b89b-4897-9faf-0736be8a6a0d.png)
  
9. 在 " **A/AAAA 记录 (Ip 地址) ** 部分的" **Ip 地址 (记录) ** 区域中，选择 " **CNAME**"。<br/>![1 &amp; 1-BP-配置-3-6](../../media/7f57f468-fbee-4440-a53d-3e334d8e5b71.png)
...
5. 在 " **子域概述** " 部分中，找到您刚创建的 **lyncdiscover.** 子域，然后选择该子域 ** (v) ** 控件的面板。 <br/>在 " **子域设置** " 区域中，选择 " **编辑 DNS 设置**"。
    
6. 在 " **A/AAAA 记录 (Ip 地址) ** 部分的" **Ip 地址 (记录) ** 区域中，选择 " **CNAME**"。
...
14. 在 " **子域概述** " 部分，找到您刚创建的 **sip** 子域，然后选择该子域的 **" (v) 控制" 面板 ** 。 <br/>在 " **子域设置** " 区域中，选择 " **编辑 DNS 设置**"。
    
15. 在 " **A/AAAA 记录 (Ip 地址) ** 部分的" **Ip 地址 (记录) ** 区域中，选择 " **CNAME**"。
...
请执行以下步骤或 [观看视频 (从 5:09) 开始 ](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-1-1-internet)。
...
5. 在 " **TXT 和 SRV 记录** " 部分中，选择 " **添加记录**"。 <br/>（您可能需要向下滚动。）
...
请执行以下步骤或 [观看视频 (从 5:51) 开始 ](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-1-1-internet)。
