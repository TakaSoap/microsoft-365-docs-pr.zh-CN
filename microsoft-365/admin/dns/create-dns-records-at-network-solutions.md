...
在 Network Solutions 中添加这些记录后，域将设置为使用 Microsoft 服务。
...
6. 在四条新记录的框中，键入或复制并粘贴下表中的值。
    
    |**Alias**|**TTL**|**引用主机名**|**其他主机 (选择" **其他主机** "选项按钮)**|
    |:-----|:-----|:-----|:-----|
    |自动发现  <br/> |3600  <br/> | (没有设置)   <br/> |autodiscover.outlook.com.  <br/> **此值必须以句点 (.) 结尾。** <br/> |
    |sip  <br/> |3600  <br/> | (没有设置)   <br/> |sipdir.online.lync.com.  <br/> **此值必须以句点 (.) 结尾。** <br/> |
    |lyncdiscover  <br/> |3600  <br/> | (没有设置)   <br/> |webdir.online.lync.com.  <br/> **此值必须以句点 (.) 结尾。** <br/> |
    |enterpriseregistration  <br/> |3600  <br/> | (没有设置)   <br/> |enterpriseregistration.windows.net  <br/> **此值必须以句点 (.) 结尾。** <br/> |
    |enterpriseenrollment  <br/> |3600  <br/> | (没有设置)   <br/> |enterpriseenrollment-s.manage.microsoft.com  <br/> **此值必须以句点 (.) 结尾。** <br/> |
    
    ![键入或粘贴新记录的值](../../media/5ce0b30c-b46c-4778-aa5a-fb5e2f0961c1.png)
  
7. 添加所需的所有 CNAME 记录后，选择"继续 **"。**
