...
请执行以下步骤或 [观看视频 (从 3:51) 开始 ](https://support.microsoft.com/office/c49698c2-6991-47fb-b5ac-18e49a505099)。
...
6. 在新记录的框中，键入或复制并粘贴下表中的值。
    ...
    |**Priority**|**TTL**|**邮件服务器**|
    |:-----|:-----|:-----|
    |10    <br/> 有关优先级的详细信息，请参阅[什么是 MX 优先级？](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq) <br/> |3600  <br/> | *\<domain-key\>*  . mail.protection.outlook.com。  <br/> **此值必须以句点 (.) 结尾。** <br/> **注意：***\<domain-key\>* 从你的 Microsoft 帐户获取你的。 [如何查找此项？](../get-help-with-domains/information-for-dns-records.md)          |
...
请执行以下步骤或 [观看视频 (从 4:43) 开始 ](https://support.microsoft.com/office/c49698c2-6991-47fb-b5ac-18e49a505099)。
...
5. 向下滚动到 " ** (CNAME 记录 ** " 部分的 "主机别名") 部分，然后选择 " **编辑 CNAME 记录**"。
...
6. 在四个新记录的框中，键入或复制并粘贴下表中的值。
    ...
    |:-----|:-----|:-----|:-----|
    |自动发现  <br/> |3600  <br/> | (设置)   <br/> |autodiscover.outlook.com.  <br/> **此值必须以句点 (.) 结尾。** <br/> |
    |sip  <br/> |3600  <br/> | (设置)   <br/> |sipdir.online.lync.com.  <br/> **此值必须以句点 (.) 结尾。** <br/> |
    |lyncdiscover  <br/> |3600  <br/> | (设置)   <br/> |webdir.online.lync.com.  <br/> **此值必须以句点 (.) 结尾。** <br/> |
    |enterpriseregistration  <br/> |3600  <br/> | (设置)   <br/> |enterpriseregistration.windows.net  <br/> **此值必须以句点 (.) 结尾。** <br/> |
    |enterpriseenrollment  <br/> |3600  <br/> | (设置)   <br/> |enterpriseenrollment-s.manage.microsoft.com  <br/> **此值必须以句点 (.) 结尾。** <br/> |
...
请执行以下步骤或 [观看视频 (从 5:35) 开始 ](https://support.microsoft.com/office/c49698c2-6991-47fb-b5ac-18e49a505099)。
...
请执行以下步骤或 [观看视频 (从 6:18) 开始 ](https://support.microsoft.com/office/c49698c2-6991-47fb-b5ac-18e49a505099)。
