...
在 Namecheap 中添加这些记录后，您的域将设置为与 Office 365 服务配合使用。
...
7. 在新记录的框中，键入或复制并粘贴下表中的值。
    ...
    |**类型**|**主机**|**值**|**TTL**|
    |:-----|:-----|:-----|:-----|
    |TXT  <br/> |@  <br/> |MS=ms *XXXXXXXX*  <br/>**注意：** 此为示例。 在这里使用来自 Office 365 中的表的具体**目标地址或指向的地址**值。  [如何查找此项？](../get-help-with-domains/information-for-dns-records.md)          |30分钟  <br/> |
