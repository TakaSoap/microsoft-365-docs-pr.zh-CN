...
- [添加 MX 记录，以便你的域的电子邮件发送到 Microsoft。](#add-an-mx-record-so-email-for-your-domain-will-come-to-microsoft)
    
- [添加 Microsoft 所需的五条 CNAME 记录](#add-the-five-cname-records-that-are-required-for-microsoft)。
...
在 Wix 添加这些记录后，你的域将设置为使用 Microsoft 服务。
