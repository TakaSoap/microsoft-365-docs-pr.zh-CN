...
Cortana处理来自用户的查询、Office用户请求所需的数据，以及由 Microsoft 系统生成的其他遥测以运行该服务。 由企业Cortana收集的数据包括用户说出的查询的文本表示形式 (即来自语音识别和语音识别) 。 此文本数据是客户数据，根据联机服务条款  [进行管理](https://www.microsoft.com/licensing/product-licensing/products)。 它仅用于开发和改进与联机服务条款一致的机器学习模型。
...
### <a name="cortana-in-windows-10-version-2004-and-later"></a>Cortana 2004 Windows 10 (更高版本中的) 

Cortana中的 Windows 10 应用可帮助用户快速获取 Microsoft 365 信息，使用键入或说出的查询与人员联系、检查日历、设置提醒等。

Cortana Windows可帮助用户更好地管理其日程安排和任务。 他们可以通过搜索功能微软待办他们的列表、查找本地信息、获取定义，以及跟踪最新新闻、天气必应信息。
...
选择退出Cortana Windows 10不会选择退出单独控制的其他体验。 管理员可以使用 Experience\AllowCortana MDM 策略Windows 10通过组策略在 Windows 10 中为组织配置 Windows：计算机配置\管理模板\Windows 组件\搜索\允许Cortana。 Cortana

从 Windows 10 版本 2004 开始，Cortana 是预安装有 Windows 的通用 Windows 平台 (UWP) 应用，并通过 Microsoft Store 定期更新。 若要接收最新更新Cortana更新，你需要通过["Microsoft Store"启用更新](/windows/configuration/stop-employees-from-using-microsoft-store)。
...
> [!NOTE]
> Cortana适用于 iOS 和 Android 的 Microsoft Teams 移动应用和[Microsoft Teams](/microsoftteams/devices/teams-displays)为美国、英国、加拿大、印度和澳大利亚的用户以英语显示支持语音协助。  Microsoft Teams 会议室Windows仅支持美国用户登录。 Cortana当前不适用于 GCC、GCC-High、DoD、EDU 租户。 扩展至其他语言和地区将作为未来发行版的一部分进行，管理员客户将通过消息中心和用户指南Microsoft 365[通知](https://www.microsoft.com/microsoft-365/roadmap?filters=&searchterms=65346)。
...
使用基于 Microsoft AI 技术的自然语言、语音识别、机器学习和语言，Cortana 可了解你的上下文，以帮助你保持井井有条、与重要人脉和重要事物保持联系，并控制你的一天。
...
最初，使用 Cortana 的新对话 AI 功能将适用于使用 Outlook for iOS 和 Microsoft 365 工作帐户在美国的客户。 若要了解更多信息，请转到使用 Outlook 中的"开始与个人生产力[Cortana"。](https://techcommunity.microsoft.com/t5/outlook-blog/start-a-conversation-with-your-personal-productivity-assistant/ba-p/2071416#:~:text=Conversational%20AI%20allows%20you%20to,time%2C%20all%20with%20your%20voice)
...
Cortana发送包含你所做的任务和承诺的个性化简介电子邮件，以便捷方式将其标记为已完成或安排专注时间以完成它们。 它还包括当天的会议和相关文档的摘要。 Cortana从用户的电子邮件中提取信息，Exchange Online邮箱中存储该信息，直到合并到"简介"电子邮件中。 个人数据不会在邮箱外部访问Exchange Online访问。 只有当用户拥有包含会议服务计划的许可证时，他们才有权访问Exchange Online电子邮件。
...
## <a name="how-is-the-delivery-of-cortana-enterprise-services-different-from-the-delivery-of-other-cortana-features-i-may-have-previously-experienced"></a>企业服务的交付Cortana我之前可能体验过的其他Cortana功能如何？
...
1. In the Microsoft 365 管理中心， select **设置**  >  **Org 设置** and select **Cortana**.

2. 取消选中"允许 Windows 10 (版本 **1909** 和更早) 中的 Cortana 以及 iOS 和 Android 上的 Cortana 应用代表组织人员访问 Microsoft 托管的数据"复选框以禁用 Cortana 连接体验。
