...
1. 如需设置连接器，则必须先获得分配的权限，然后才能开始设置。 若要查看您需要获得哪些权限，请参阅 [Feature permissions in EOP](https://docs.microsoft.com/microsoft-365/security/defender-365-security/feature-permissions-in-eop) 主题中的“Microsoft 365 和 Office 365 连接器”条目。
