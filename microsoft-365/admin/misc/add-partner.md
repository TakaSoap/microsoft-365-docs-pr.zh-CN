...
> [!NOTE]
> 本文适用于由中国世纪互联运营的 Office 365。 它适用于希望让世纪互联合作伙伴管理其 Office 365 订阅的组织。
...
作为 Office 365 管理员，您可以创建或编辑用户、重置用户密码、管理用户许可证、管理域以及将管理员权限分配给组织中的其他用户，等等。 但是，如果您希望其他人执行这些管理任务，则可以通过创建合作伙伴关系将此角色委派给受世纪互联许可的合作伙伴。
...
2. 选择要购买的产品，然后选择 " **购买**"。
3. 若要添加新合作伙伴，请展开 **"需要有关订单的帮助？"** ，然后选择 " **从 Microsoft 合作伙伴获取帮助**"。<br>
按照 "提供程序" 页上的步骤进行搜索或获取与合作伙伴的匹配项。
...
1. 在 " [管理中心](https://go.microsoft.com/fwlink/p/?linkid=848041)" 中，转到 " **付费** \> **购买服务**  " 页。
2. 选择要购买的产品，然后选择 " **购买**"。
3. 若要添加新合作伙伴，请展开 **"需要有关订单的帮助？"** ，然后选择 " **从 Microsoft 合作伙伴获取帮助**"。<br>
按照 "提供程序" 页上的步骤进行搜索或获取与合作伙伴的匹配项。
4. 如果您已经有一个合作伙伴，则在 "签出向导" 的第二步中，在 "合作伙伴信息" 下的 "合作伙伴信息" 下，选择 " **添加**"。
...
3. 在 "订阅详细信息" 页上的 " **合作伙伴信息**" 下，键入 **合作伙伴网络 ID**。 你可以向合作伙伴提供合作伙伴的 Microsoft 合作伙伴网络 ID，并向合作伙伴索要合作伙伴的网络 ID。
4. 选择“**添加**”。
...
此过程由您的授权合作伙伴启动。 合作伙伴向你发送一封电子邮件，询问你是否要向其授予充当记录合作伙伴的权限。
  
接受此优惠
  
1. 阅读电子邮件中的合作伙伴条款。
2. 若要授权协议，请选择链接（转到 Office 365 中的授权页面）。
3. 在 " **合作伙伴关系**" 下，选择 **"是"** 以授权合作伙伴成为您委派的管理员，然后选择 " **下一步**"。
4. 如果为合作伙伴关系提供了试用订阅或购买优惠，请创建试用版或订阅帐户。
...
1. 在管理中心中，转到“**计费**”\>“<a href="https://go.microsoft.com/fwlink/p/?linkid=842054" target="_blank">你的产品</a>”页面。
2. 在 "订阅详细信息" 页的 " **合作伙伴信息**" 下，选择 " **删除**"。
3. 键入新合作伙伴的 **Microsoft 合作伙伴网络 ID** 。 可询问合作伙伴获得合作伙伴的 Microsoft 合作伙伴 ID。
4. 选择“**添加**”。
