...
当你使用个人电子邮件地址注册 Office 365 并暂时跳过添加自定义[](../get-help-with-domains/what-is-a-domain.md)域时，你将限制对某些功能的访问权限。 
  
如果选择现在添加自定义域，则有权访问以下所有高级功能：
  
|**功能**|**Office 365 个人电子邮件**|**具有自定义域的 Office 365**|
|:-----|:-----|:-----|
