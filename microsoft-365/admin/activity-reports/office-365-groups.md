...
|8.  <br/> |您可以通过选择图例中的项目来筛选您在图表上看到的系列。 例如，在 "**组**" 图表中，选择 "**总**" 或 "**活动** ![ 总" 和 "活动总数量 ](../../media/8eebd496-5955-4419-8d53-5f3ba1ad1c88.png) "，以仅查看与每个组相关的信息。 更改选择不会更改网格表中的信息。  <br/> |
...
|10  <br/> |选择或点击 "**更多操作**" 按钮 ![ 标题旁边的 "移动 OWA 更多" 操作 ](../../media/80044eef-2368-4c7e-8d31-7155b029e0cf.png) 可在报告中添加或删除列。  <br/> ![组报告-选择列](../../media/d7fb95d6-2a2e-4144-b80d-581223e48043.png)|
