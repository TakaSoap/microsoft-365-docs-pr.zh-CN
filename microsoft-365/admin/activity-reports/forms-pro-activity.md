...
2. 从 " **选择报表** " 下拉下，选择 " **Dynamics 365 Customer Voice** \> **活动** "。

## <a name="interpret-the-dynamics-365-customer-voice-activity-report"></a>解释 Dynamics 365 Customer Voice 活动报告

您可以通过查看 " **活动** " 和 " **用户** " 图表，获取用户的 Dynamics 365 客户语音活动的视图。 

![表单活动报告](../../media/formsproactivity.png)

|项目|说明|
|:-----|:-----|
|1.  <br/> |可以查看 " **Dynamics 365 Customer Voice** 活动" 报表，了解过去7天、30天、90天或180天的趋势。 但是，如果您在报告中选择某一天，则表 (7) 将显示从当前日期起的最长28天的数据 (而不是生成报告的日期) 。   <br/> |
|2.  <br/> |每个报告中的数据通常在最近的48小时内。  <br/> |
|3.  <br/> |[！注意] [！注意] [！注意] **用户** 视图可帮助您了解活动 Dynamics 365 客户语音用户数的趋势。 如果用户已在特定时间段内的 Pro 调查 (创建、编辑、查看等 ) 执行了活动，则认为该用户处于活动状态。  <br/> |
...
|5.<br/>|在 " **用户** " 图表上，Y 轴表示唯一用户数。 X 轴是唯一用户处于活动状态的日期。 图例为：<br/><br/>**设计人员** 表示用户已创建或编辑 Dynamics 365 客户语音调查。<br><br>在 " **活动** " 图表中，Y 轴表示每个调查的 Dynamics 365 客户语音响应数。 X 轴表示调查或响应活动发生的日期。 图例为：<br/><br/>所 **创建的调查** 是用户已创建的独特 Dynamics 365 客户语音调查的计数<br>**响应** 是接收调查的用户提交的匿名或非匿名响应的计数。 |
