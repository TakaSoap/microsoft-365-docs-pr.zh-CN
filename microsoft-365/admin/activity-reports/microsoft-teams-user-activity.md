...
可通过查看" **活动**"和" **用户**"图表，了解 Microsoft Teams 用户活动。<br/>![Microsoft 365 报表 - Microsoft Teams 用户活动。](../../media/40359f81-25f7-416d-bb1e-37289133ef6b.png)
...
|7.  <br/> |通过选择图例中的项目，可以筛选在图表上看到的系列。 例如，在"**活动"** 图表上，选择"频道消息"、"聊天消息"、"通话"或"会议"，以仅查看与每个消息有关的信息。   更改选择不会更改网格表中的信息。  <br/> ![筛选 Microsoft Teams 活动图表](../../media/c819c4ea-6e9a-4411-a0dd-9f800d64ce38.png)|
...
|9.  <br/> |选择 **"列** "以在报表中添加或删除列。  <br/> ![Teams user activity report - choose columns](../../media/eb5fbcee-e371-4d36-a0c6-fa54732311ec.png)|
