...
您可以通过选择 " **活动** " 选项卡来查看 SharePoint 报表中的活动。<br/>![Microsoft 365 报告-Microsoft SharePoint 活动报告。](../../media/5a0a96f-0e4f-4fb9-8baa-3262275b3d1f.png)

选择 " **选择列** " 可在报告中添加或删除列。  <br/> ![SharePoint 活动报告-选择列](../../media/3c396cd1-9701-4712-8eaa-eb7bba702aa8.png)
...
| (UTC) 的上次活动日期  <br/> |对所选日期范围执行文件活动或访问页面的最新日期。 要查看指定日期发生的活动，请直接在图表中选择该日期。  <br/> |
|查看或编辑的文件  <br/> |用户上载、下载、修改或查看的文件数。   <br/> |
|已同步文件  <br/> |已从用户的本地设备同步到 SharePoint 网站的文件数。 <br/> |
|内部共享的文件  <br/> | 与组织中的用户或 (组中的用户共享的文件的计数，这些用户可能包括外部用户) 。  <br/> |
|外部共享的文件  <br/> |与组织外部的用户共享的文件数。 <br/>|
|访问的页面  <br/> |用户对独特页面的访问。 <br/>|
