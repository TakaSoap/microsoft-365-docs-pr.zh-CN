...
3. 将切换设置为 **"开**"，然后输入一个电子邮件地址以将邮件转发给。 它可以是任何有效的电子邮件地址。 若要转发到多个地址，您需要为地址 [创建通讯组](https://docs.microsoft.com/office365/admin/setup/create-distribution-lists) ，然后在此框中输入组的名称。
