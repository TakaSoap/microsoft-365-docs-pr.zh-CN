...
description: 了解各种类型的组以及如何将它们与 Office 365 的各种协作功能一起使用。
ms.openlocfilehash: 26f24f0a27981e0901f9f8f57fd7c6c22d15de21
ms.sourcegitcommit: ca2b58ef8f5be24f09e73620b74a1ffcf2d4c290
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/24/2020
ms.locfileid: "42251177"
---
# <a name="email-collaboration-in-office-365"></a>Office 365 中的电子邮件协作

Office 365 鼓励通过 Outlook 中的组、通讯组列表（也称为通讯组）、共享邮箱和公用文件夹进行协作。 上述每个选项都有不同的用途、用户体验和功能集。 应使用哪个选项要取决于用户需要执行的操作，以及您的组织提供的工具。
...
|**协作工具**|**说明**|
|:-----|:-----|
|Outlook 中的组  <br/> |Office 365 中跨所有应用程序工作的一个共享工作区。 包括共享收件箱、日历和用于存储文件的 OneDrive for Business 网站。 用户可以从其电子邮件或日历中创建、查找和加入 Outlook 中的组。 具有 Exchange Online 或 Office 365 订阅的新用户和现有用户可以使用 Outlook 中的组。  <br/> |
...
|**Access** <br/> |Exchange Online 和 Office 365 用户  <br/> |对于通讯组，必须手动添加成员。 对于动态通讯组，成员添加基于筛选条件。  <br/> |可以向用户授予完全访问权限和/或"发送方式"权限。如果授予完全访问权限，则用户还必须将共享邮箱添加到他们的 Outlook 配置文件中才能访问共享邮箱。  <br/> |您的组织中的任何人都可以访问  <br/> |
...
[使用 Office 365 组而不是网站邮箱](https://support.office.com/article/737d6b1f-67cc-41fe-8db8-f2d09dd1673b.aspx)
    
[在 Office 365 中创建共享邮箱](create-a-shared-mailbox.md)
    
[Office 365 和 Exchange Online 中的公用文件夹](https://technet.microsoft.com/library/jj200758%28v=exchg.150%29.aspx)
