---
title: 保护功能如何映射到Microsoft 365 商业高级版 Intune 设置
f1.keywords:
- NOCSH
ms.author: sharik
author: skjerland
...
description: 了解保护功能如何Microsoft 365 商业高级版 Intune 设置。 订阅会提供修改 Intune 设置的许可证。
ms.openlocfilehash: 9a6dcf014e009389e49860fa96486c264c22f501
ms.sourcegitcommit: 251551539b1532fdac7b7e3dd2733a75c62e8a54
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/16/2021
ms.locfileid: "58360299"
---
...
若要查找 Intune 设置，使用你的 Microsoft 365 商业高级版凭据登录，然后转到管理中心 **，然后****转到 Intune**。
...
|登录失败此次数时重置 PIN (如果登录不需要 PIN，则禁用)   <br/> |重置 PIN 前的尝试次数  <br/> |
...
若要查找 Intune 设置，请通过你的 Microsoft 365 商业高级版 管理员凭据登录，然后转到[Azure 门户](https://portal.azure.com)。 选择 **"更多服务**"，在筛选器中键入Intune。 选择 **Intune 应用保护** \> **应用策略**。
 ...
 > [!IMPORTANT]
 >
 >一Microsoft 365 商业高级版订阅会为你提供一个许可证，用于仅修改映射到 Microsoft 365 商业高级版 中可用的设置的 Intune 设置。 
...
|防止用户将公司数据复制到个人文件。  <br/> |" **必需设置**"\>" **Windows 信息保护模式**"。 **在** 中Microsoft 365 商业高级版映射到：**隐藏替代****，在** Microsoft 365 商业高级版中关闭映射到：**关闭**。  <br/> |
...
若要查找 Intune 设置，使用 Microsoft 365 商业高级版 管理员凭据登录，然后转到 [Azure](https://portal.azure.com)门户，然后选择"更多服务"，然后在 Intune 中键入 **筛选器**，选择 **Intune** \> **设备配置文件** \> 。 Then select **Device policy for Windows 10** \> **Properties** \> **Settings**.
