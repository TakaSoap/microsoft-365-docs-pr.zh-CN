---
title: 如何将保护功能Microsoft 365 商业高级版映射到 Intune 设置
f1.keywords:
- NOCSH
ms.author: sharik
author: skjerland
...
ms.locfileid: "63313757"
---
# <a name="how-do-protection-features-in-microsoft-365-business-premium-map-to-intune-settings"></a>如何将保护功能Microsoft 365 商业高级版映射到 Intune 设置
...
若要查找 Intune 设置，请Microsoft 365 商业高级版管理员凭据登录，然后转到管理中心，然后 **转到 Intune**。
  
 > [!IMPORTANT]
 > 
 > 一Microsoft 365 商业高级版订阅会为你提供修改所有 Intune 设置的许可证。 请参阅 [Intune 简介以开始。](/intune/introduction-intune)
...
若要查找 Intune 设置，请Microsoft 365 商业高级版管理员凭据登录，然后转到 [Azure 门户](https://portal.azure.com)。 选择 **"更多服务**"，在筛选器中键入 **Intune。** 选择 **Intune 应用保护** \> **应用策略**。
...
|防止用户将公司数据复制到个人文件。  <br/> |" **必需设置**"\>" **Windows 信息保护模式**"。 **In** Microsoft 365 商业高级版映射到：**隐藏替代****，关闭** Microsoft 365 商业高级版映射到：**关闭**。  <br/> |
