...
若要查找 Intune 设置，使用你的 Microsoft 365 商业高级版 凭据登录，然后转到[Azure 门户](https://portal.azure.com)。 选择 **"更多服务**"，在"筛选器"中键入 Intune。 选择 **Intune 应用保护** \> **应用策略**。
