...
若要查找 Intune 设置，使用你的 Microsoft 365 商业高级版 管理员凭据登录，然后转到 Azure[门户](https://portal.azure.com)。 选择 **"更多服务**"，在"筛选器"中键入 Intune。 选择 **Intune 应用保护** \> **应用策略**。
...
|防止用户将公司数据复制到个人文件。  <br/> |" **必需设置**"\>" **Windows 信息保护模式**"。 **在** 中Microsoft 365 商业高级版映射到：**隐藏覆盖****，关闭** Microsoft 365 商业高级版映射到：**关闭**。  <br/> |
