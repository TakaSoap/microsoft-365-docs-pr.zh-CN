...
若要开始使用Microsoft 365分析，必须先在应用中提供数据Microsoft 365 管理中心，然后在 Power BI 中启动模板Power BI。 <a href="https://go.microsoft.com/fwlink/p/?linkid=2024339" target="_blank"></a>
...
3. 在"**应用"** 选项卡Microsoft 365搜索框中键入"应用"，然后选择Microsoft 365使用情况分析 \> **""现在获取它"。**
...
6. 选择 **"连接"，** 在"连接 至 **Microsoft 365** 使用情况分析"屏幕上，键入租户 ID (不带短划线) 在步骤 (1) 中复制，然后选择"下一步"。
...
8. 实例化模板应用后Microsoft 365使用情况分析仪表板将在Power BI中可用。 仪表板的初始加载需要 2 到 30 分钟。
...
[导航和利用Microsoft 365使用情况分析 (](navigate-and-utilize-reports.md)中的) 
