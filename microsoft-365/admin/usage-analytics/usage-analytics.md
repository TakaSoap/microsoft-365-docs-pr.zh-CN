...
description: 大致了解组织如何采用Microsoft 365进行通信和协作。
ms.openlocfilehash: a3c77fe9a4e6d26e62525c6267ab32a81c78289b
ms.sourcegitcommit: b1066b2a798568afdea9c09401d52fa38fe93546
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/13/2021
ms.locfileid: "61422815"
---
# <a name="microsoft-365-usage-analytics"></a>Microsoft 365 使用情况分析

在Microsoft 365内使用Power BI使用情况分析，以深入了解组织在组织中采用各种Microsoft 365。 你可以可视化和分析Microsoft 365数据、创建自定义报告并在组织内部共享见解。 您还可以深入了解特定区域或部门如何使用Microsoft 365。
...
执行摘要是 Microsoft 365 for Business 采用、使用情况、移动性、通信、协作和存储报告高级概览视图，适用于业务决策者。 它基于已启用的所有用户和处于活动状态的用户，提供一些单独服务的使用方式的视图。 报告中显示的月的所有值都指最新完整月份。 
...
- **采用** &ndash; 提供采用趋势的汇总。 使用本节中的报告可了解用户如何采用Microsoft 365，以及各个服务的整体使用情况在一个月内是如何更改的。 你可以查看用户是如何启用的、组织中有多少人正在使用 Microsoft 365、有多少是返回用户以及有多少用户第一次使用该产品。
...
- **协作** &ndash;了解组织中人员如何使用 OneDrive 和 SharePoint 来存储文档和相互协作，以及这些趋势如何逐渐变化。 还可以查看在内部或外部共享文档的用户数，以及使用网站或 SharePoint 帐户的用户数OneDrive所有者和其他协作者细分。

- **存储** 使用此报告跟踪邮箱、OneDrive和SharePoint &ndash; 存储。

- **移动性** &ndash;跟踪用户用于连接到电子邮件、Teams、Skype 或 Yammer 的客户端和设备。

## <a name="activation-and-licensing"></a>激活和许可

激活和许可证页面提供了有关Microsoft 365激活的报告;即，有多少用户已下载并激活 Office 应用，以及您的组织已分配多少许可证。 顶部月份值表示当前月，指标反映从该月开始到当前日期聚合的值。
...
用户活动报告可用于某些单个服务。 这些报告提供与 Active Directory 属性联接的用户级别详细使用情况数据。 此外，通过部门采用报告，你可以按 Active Directory 属性进行切片，以便你可以查看所有单个服务中的活动用户。 所有指标将聚合到最新完整月份。 若要查看内容日期，请导航到表页面并选择 UserActivity 表，其中 TimeFrame 下的值提供报告时间段。 
...
你必须是全局管理员、Exchange管理员、Skype for Business 管理员 **、SharePoint** 管理员、全局读取者、报表读取者、使用情况摘要报表读取者，才能建立与模板应用的连接。   有关详细信息 [，请参阅](../add-users/about-admin-roles.md) 关于管理员角色。 **注意：****全局读者** 和使用情况摘要报告阅读器仅允许访问 Microsoft 365 使用情况分析中的租户级别聚合，并且他们无权查看用户活动报告。 

### <a name="who-can-customize-the-usage-analytics-reports"></a>Who自定义使用率分析报告吗？

只有与模板应用建立初始连接的用户才能自定义报告或在 web 界面中Power BI报告。 有关[说明，请参阅自定义Microsoft 365使用情况分析](customize-reports.md)中的报告。
...
通过连接到 Microsoft 报告 API，可以对此数据进行[Graph，](https://go.microsoft.com/fwlink/p/?linkid=848843)以从数据提取其他字段Azure Active Directory并加入数据集。 
...
可以使用管理中心活动概述页面中的反馈按钮，也可以打开支持案例 ([获取](../get-help-support.md) 模板应用的帮助。 
