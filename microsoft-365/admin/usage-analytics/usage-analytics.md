...
可以通过 Microsoft 365 Api 检索模板应用程序中的数据（在预览中）。 在交付生产时，它们将合并到[Microsoft Graph 报告 api](https://go.microsoft.com/fwlink/p/?linkid=848843)中。 
...
### <a name="is-it-possible-to-see-usage-by-plan-ie-e1-e3"></a>是否可以按计划（即 E1、E3）查看使用情况？
...
您可以使用 Power BI Desktop 连接到 Microsoft 365 Api （在 "预览" 中），以使其他数据源与模板应用数据相结合。
