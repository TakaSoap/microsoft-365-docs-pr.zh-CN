...
2. 通过选择 "Power BI 中的其他页面" 按钮上的 " **编辑** " 按钮，进入编辑模式 ![ ](../../media/d8da3c19-3f2d-4bf6-811e-faa804f74770.png) 。 
...
4. 在右下方，选择显示根据 OS （如 Android、iOS、Mac 等）激活的用户计数的任意条形图。
    
5. 在右侧的 **可视化** 区域中，若要从 visual 中删除 **Mac 计数** ，请选择它旁边的 **X** 。
...
1. 使用左侧导航转到 " **产品使用情况** " 报表，然后选择 " **Yammer** " 选项卡。
    
2. 通过选择 ![ POWER BI 和 edit 中的 "更多页面" 按钮切换到编辑模式 ](../../media/d8da3c19-3f2d-4bf6-811e-faa804f74770.png) 。 **Edit** 
    
3. 在页面底部，选择 ![Power BI 中的 "添加页面" 按钮](../../media/d3b8c117-17d4-4f53-b078-8fefc2155b24.png) 创建新页面。
  
4. 在右侧的 **可视化** 区域中，从左) 中依次选择 **堆积条形图** (顶行。

    ![选择条形图](../../media/214c3fed-6eae-43e6-83fb-708a2d74406e.png)
    
5. 选择该可视化效果的右下角并拖动以使其更大。
...
12. 在可视化效果列表的正下方，选择 **Format** ![ Power BI Visualizaions 中的格式图标格式图标 ](../../media/ee0602f3-3df5-4930-b862-db1d90ae4ae2.png) 。
