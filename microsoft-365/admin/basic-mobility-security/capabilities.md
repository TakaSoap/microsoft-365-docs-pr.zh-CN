...
ms.locfileid: "59169893"
---
# <a name="capabilities-of-basic-mobility-and-security"></a>基本移动性和安全性的功能

基本移动性和安全性可帮助你保护和管理组织中许可的 Microsoft 365 用户使用的移动设备，如 iPhone、iPad、Android 和 Windows 电话。 可以使用设置创建移动设备管理策略，这些设置可帮助控制对Microsoft 365移动设备和应用的电子邮件和文档的访问。 如果设备丢失或被盗，你可以远程擦除设备以删除敏感的组织信息。
...
下图显示了当具有新设备的用户登录支持具有基本移动性和安全性的访问控制的应用时会发生什么情况。 在用户注册设备之前，Microsoft 365访问应用中的源资源。
...
可以通过将 Windows 10注册为移动设备来管理这些设备。 部署适用的策略后，具有 Windows 10 设备的用户在首次使用内置电子邮件应用访问其 Microsoft 365 电子邮件 (时需要注册基本移动性和安全性，这要求 Azure AD 高级订阅) 。
