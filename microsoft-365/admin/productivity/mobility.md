...
组织的移动分数在组织 (聚合) 级别衡量，无论用户使用的是 Microsoft 365 应用版 -Outlook、Teams、Word、Excel、PowerPoint、OneNote、Yammer 和 Skype-不同的平台 - 桌面、Web 和移动。
...
3. **可视化：** 显示仅远程工作的每日百分比和每天也现场工作人员百分比的趋势线。 如果用户在一天中至少执行三小时的活动，Microsoft 365 应用版现场。
