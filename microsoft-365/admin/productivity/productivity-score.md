...
[使用报告监视 Microsoft 365 活动](https://docs.microsoft.com/microsoft-365/admin/activity-reports/activity-reports)（文章）

[启用 Microsoft 365 使用情况分析](https://docs.microsoft.com/microsoft-365/admin/usage-analytics/enable-usage-analytics)（文章）

[Microsoft 365 管理中心概述](https://docs.microsoft.com/microsoft-365/business-video/admin-center-overview)（视频）