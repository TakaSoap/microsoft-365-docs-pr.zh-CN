...
1. **标头：** 显示在过去 28 天内Microsoft Teams在会议期间共享视频或屏幕的会议所占的百分比。
...
下图显示了主要见解中分子和关键指标的分母的趋势线。 换言之，它显示了具有最佳做法的在线 Microsoft Teams 会议（如视频或屏幕共享）的数量，以及过去 180 天内召开的联机 Microsoft Teams 会议总数。 图表上的每个数据点都是最近 28 天的活动聚合。
...
组织的会议分数衡量组织中在线会议Microsoft Teams过去 28 天内遵循最佳做法的程度。 它根据组织中的参加会议人数和会议持续时间进行加权。
...
1. **标头**：好友动态主要见解和评分中考虑Microsoft Teams视频最佳做法的在线会议数的百分比。  
...
3. **可视化：** 可视化中的细分旨在表示联机Microsoft Teams会议遵循以下每个最佳做法的程度： 
    ...
    - **屏幕共享**：彩色部分和分数代表Microsoft Teams使用屏幕共享功能的在线会议百分比。 该分数包括： 
...
3. **可视化：** 基于他们过去 28 天内每周在会议中的平均时间，提供组织中人员视图。 下面提供了每个类别的以下信息：
      - **与会者总数：** 根据最近 28 天的平均会议持续时间范围，显示组织中参加会议的人数。 例如，"6-10 小时"类别指示过去 28 天内每周平均参加会议数为多小时的人数。
      - **通过视频参加会议的与会者：** 对于每个类别，这将显示过去 28 天内组织中有多少人参加过任何带视频的会议。
...
1. **标头：** 显示最近 28 天 (30 分钟) 联机Microsoft Teams会议之前未安排的即时消息的百分比。
...
1. **标头**：好友动态前 28 天（少于 30 分钟）Microsoft Teams联机联机会议所占的百分比。
...
3. **可视化：** 显示参加任何联机会议或联机会议Microsoft Teams类型的会议。 每种会议类型都表示为水平条，其中的颜色部分和分数表示以下内容：
   ...
   - **立即在频道中开会**：
        - 数字：过去 &quot; 28 天内，Microsoft Teams频道 (会议) 会议的数量 &quot;
        - Denominator：过去 28 天内参加任何联机Microsoft Teams会议的数量
    - **安排的一次会议：**
        - 数字：过去 28 天内Microsoft Teams日历上参加一 (一) 会议的数量
        - Denominator：过去 28 天内参加任何联机Microsoft Teams会议的数量
    - **安排定期会议：**
