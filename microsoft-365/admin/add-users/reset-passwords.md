...
本文介绍当你拥有 Microsoft 365 for business 订阅时，如何为你自己和你的用户重置密码。
...
## <a name="watch-reset-a-business-password-for-a-user"></a>手表：重置用户的业务密码
...
有关概述信息，请参阅 [使用 PowerShell 管理 Microsoft 365](https://docs.microsoft.com/microsoft-365/enterprise/manage-microsoft-365-with-microsoft-365-powershell)。
...
## <a name="i-dont-have-a-microsoft-365-for-business-subscription"></a>我没有 Microsoft 365 for business 订阅
