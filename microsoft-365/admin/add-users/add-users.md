...
- **使用 ActiveDirectory？** [设置 Office 365 的目录同步](https://docs.microsoft.com/office365/enterprise/set-up-directory-synchronization)。 使用 Azure AD Connect 工具在 Microsoft 365 中复制 Active Directory 用户帐户（和其他 Active Directory 对象）。 同步只添加用户帐户。 您必须先将许可证分配给已同步的用户，然后才能使用电子邮件和其他 Office 应用。
...
[同时将多个用户添加到 Microsoft 365](https://docs.microsoft.com/office365/enterprise/add-several-users-at-the-same-time) （文章） \
[在 Microsoft 365 （文章）中还原用户](restore-user.md)\
