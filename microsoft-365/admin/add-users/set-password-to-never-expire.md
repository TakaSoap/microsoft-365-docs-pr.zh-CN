...
本指南适用于其他提供程序，如 Intune 和 Microsoft 365，这些提供程序还依赖Azure AD和目录服务。 密码过期是策略中唯一可以更改的部分。
...
[在本文中为组织设置密码 (](../manage/set-password-expiration-policy.md) 策略) 
