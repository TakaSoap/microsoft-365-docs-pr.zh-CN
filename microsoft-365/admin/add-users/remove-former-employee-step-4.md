...
1. [将前员工](https://support.microsoft.com/office/6e27792a-9267-4aa4-8bb6-c84ef146101b)的电子邮件添加到你的Outlook (如果你重置用户密码，你可以将其设置为[](reset-passwords.md)仅你知道) 
...
- 如果要创建一个 Outlook.pst (.pst) ，则可选密码可以帮助保护文件。 当出现 **"Outlook数据文件**"对话框时，在"密码"和"验证密码"框中键入密码，然后选择"确定 **"**。 在"**Outlook数据文件密码**"对话框中，键入 *密码*，然后选择"确定 **"**。
...
> [!TIP]
> 如果希望仅导入或还原 Outlook Data File (.pst) 中的几个项目，可以打开 Outlook 数据文件。 然后，在导航窗格中，将项目从Outlook"数据文件"文件夹中拖动到现有Outlook文件夹中。
...
[在管理员帐户上添加OneDrive删除 (](/sharepoint/manage-user-profiles#add-and-remove-admins-for-a-users-onedrive)文章) 
