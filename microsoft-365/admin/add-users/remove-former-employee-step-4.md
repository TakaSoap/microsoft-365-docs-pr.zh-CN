...
10. 用户现在将能够使用 OneDrive URL 访问OneDrive服务器。 
...
7. 如果密码已分配给 Outlook 数据文件 (.pst) ，请输入密码，然后选择"确定 **"。**
...
[在管理员帐户上添加OneDrive (](/sharepoint/manage-user-profiles#add-and-remove-admins-for-a-users-onedrive)管理员) 

[Restore a deleted OneDrive](/onedrive/restore-deleted-onedrive) (article) 

[OneDrive保留和删除 (](/onedrive/retention-and-deletion)一) 
