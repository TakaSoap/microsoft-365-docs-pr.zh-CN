...
3.  在"**添加自定义 DNS** 记录"窗格中，从"类型"下拉列表中选择 **"CNAME (别名) "。**
4.  在" **主机名"或"别名"** 框中，键入 **www**。
5.  在" **指向地址"** 框中，键入网站的 (FQDN) 完全限定的域名。 例如，**contoso.com**。
6.  如果要更改记录的 TTL 设置，请从 **TTL** 下拉列表中选择一个新的时间长度。 否则，继续执行步骤 6。
7.  选择“**保存**”。
