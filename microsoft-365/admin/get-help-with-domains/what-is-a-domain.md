...
使用自定义域（如 *rob@contoso）。 <span>com* with Microsoft 365 can help build brandbility and recognition for your brand. 
...
如果你已拥有类似  *you@yourcompany。 <span>com，*  你可以添加它，立即开始使用 OneDrive 和 Microsoft 应用。 需要花费几分钟来设置邮件和 Skype for Business。 
...
可以使用默认域，如  *yourcompany.onmicrosoft。 <span>com*  可现在登录，稍后添加自定义域。 不能对默认域进行更改或重命名，因此请确保它满足需求再继续操作。 
