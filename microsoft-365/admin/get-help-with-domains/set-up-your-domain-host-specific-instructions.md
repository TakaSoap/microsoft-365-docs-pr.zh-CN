...
## <a name="let-office-365-manage-your-dns-records"></a>允许 Office 365 管理 DNS 记录
...
或者，了解如何[更改名称服务器以使用任何域注册机构设置 Office 365](change-nameservers-at-any-domain-registrar.md)。
...
| [eNomCentral](../dns/create-dns-records-at-enomcentral.md)| [适用于 Office 365 的 Register365](../dns/create-dns-records-at-register365.md)  |
