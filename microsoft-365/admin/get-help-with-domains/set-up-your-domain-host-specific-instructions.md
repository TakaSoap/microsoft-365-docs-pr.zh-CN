...
若要开始将自定义域（contoso.com）与 Microsoft 365 一起使用，您需要验证您的域并配置您的域的 DNS 记录。 
...
## <a name="let-microsoft-365-manage-your-dns-records"></a>让 Microsoft 365 管理你的 DNS 记录
...
|[Google 域](../dns/change-nameservers-at-google-domains.md) |
...
或者，了解如何[更改名称服务器以使用任何域注册机构设置 Microsoft 365](change-nameservers-at-any-domain-registrar.md)。

## <a name="manage-your-own-dns-records"></a>管理自己的 DNS 记录
...
| [eNomCentral](../dns/create-dns-records-at-enomcentral.md)| [适用于 Microsoft 365 的 Register365](../dns/create-dns-records-at-register365.md)  |
...
|[Hostgator](../dns/create-dns-records-at-hostgator.md)  | [Yahoo！  小型企业版](../dns/create-dns-records-at-yahoo-small-business.md)  |

[我需要常规说明，因为我的域主机不在此列表中。](create-dns-records-at-any-dns-hosting-provider.md)
