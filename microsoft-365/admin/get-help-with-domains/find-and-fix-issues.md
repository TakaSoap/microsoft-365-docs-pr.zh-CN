...
- [每个人的电子邮件都切换为Microsoft 365，而您只想切换您的电子邮件？](#everyones-email-got-switched-to-microsoft-365-and-you-only-wanted-your-email-to-switch)
...
如果您不想将域中的每个人的电子邮件移动到其他域，Microsoft 365？ 你可以采取一些[步骤来Microsoft 365只需几个电子邮件地址。](../setup/domains-faq.yml)
