...
- [使用 Microsoft 365 Defender 防御威胁](https://docs.microsoft.com/learn/paths/m365-security-threat-protection/)
...
- **Microsoft defender For office 365** -如果授权你的组织使用 Microsoft Defender for office 365 且尚未对其进行配置或将其打开，你将看到此页面。 请转到 " **设置** " 以试用。
