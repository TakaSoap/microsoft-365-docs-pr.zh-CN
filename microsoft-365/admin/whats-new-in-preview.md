...
> [!NOTE]
> 您是否知道 YouTube 上的[Microsoft 365 视频系列中有哪些新增功能](https://go.microsoft.com/fwlink/p/?linkid=2118096)？ 它突出显示了我们向用户推出的最新功能。 在每个月，我们将开始链接到 "[视频、培训和文档](#videos-training-and-docs)" 部分中的最新剧集。 <br> <br> 以下是 January's： [1 月 2020-Microsoft 365 中的新增功能](https://go.microsoft.com/fwlink/p/?linkid=2118096)

### <a name="dark-mode"></a>深色模式

当我们首次推出深色模式时，它仅在主页上可用。 深色模式现在处于预览阶段，位于管理中心内的大多数页面的目标版本中。

1. 首先，需要打开目标版本：转到 "**设置** \> **** \> " "**组织配置文件** \> **发布首选项**"。 
...
- [Microsoft 365-使用 Windows 10 和 Office 365 专业增强版现代化企业级部署](https://docs.microsoft.com/learn/paths/m365-getmodern/)
...
- [使用 Microsoft 365 保护身份和访问](https://docs.microsoft.com/learn/paths/m365-identity/)
...
> [!IMPORTANT]
> 现在，你可以使用常规 URL 访问 SharePoint 管理中心：https://admin.microsoft.com/SharePoint
...
### <a name="featured-feedback-fix--the-option-to-convert-the-deleted-users-mailbox-to-a-shared-mailbox-is-back"></a>特色反馈修复–将已删除用户的邮箱转换为共享邮箱的选项将会恢复！
...
## <a name="march-2019---weve-officially-released-the-admin-center"></a>2019年3月-我们正式发布了管理中心！
...
将其签出：**用户 > 活动用户 > 编辑**或**添加用户 > 许可证和应用**。

## <a name="december-2018"></a>2018 年 12 月

- **服务 & 外接**程序-在10月，我们使用新的设计样式更新了**settings** \> **Services & 加载项**，但所有设置页仍在经典样式中。 本月，我们已开始将实际设置更新为新的设计。 查看 "**预订**" 以查看新的外观。
- **User management** -管理用户名、别名、主电子邮件地址。
- 我们已将两个家庭卡片添加到库中。 您可以在库中阅读它们的完整说明。
  - **Intune 设备注册**
  - **域**
- **建议**-你可能会在管理中心看到一个新的建议弹出窗口。 当然，如果我们认为它将对你的组织有益，你将只会看到建议。 但请不要等到我们向你提出建议-你可以从卡片库添加它。
  - **保护敏感信息**-我们建议创建数据丢失防护（DLP）策略，以检测何时将包含敏感信息的项目与组织外部的人员共享。

## <a name="november-2018"></a>2018 年 11 月

- 搜索框为后退！ 我们会略微移动它。 它仍在主页的顶部，但现在位于页面右侧的 "**添加卡**" 按钮旁边。 <br> ![屏幕捕获解释了搜索框位于主页的右上方。](../media/M365PreviewSearchBox.png)

- 我们为仪表板添加了卡片。 只需转到管理中心并选择 "**添加卡**" 即可查看新卡：
  - **Office 365 活动用户报告**-监视你购买的 office 365 服务的使用情况。
  - **Office 365 软件**-安装或部署 Office 365 专业增强版软件，并查看许可用户已激活的用户数。
  - **Azure Active Directory** -使您能够快速访问常见的 Azure AD 任务，如自助密码重置、自定义登录和添加应用。
- "**导出用户**快速任务" 已添加到 "活动用户" 页面上的命令栏中。 ![屏幕截图显示在 "刷新" 旁边的命令栏上导出用户。](../media/M365PreviewExportUsersQT.png)
- 购买服务在11月中有额外的增强功能。 它们都很棒！ 若要获取此服务，请转到 "付费 > 购买服务"。 <br>![显示了3个新增强功能的 "购买服务" 页面的屏幕截图。](../media/M365PreviewBillingPurchasServices.png)
  > 1.  在页面顶部，您可以在业务和教育计划之间进行透视。 这将帮助您找到要查找的内容。
  > 2.  我们添加了一个搜索框，因此无需进行无限滚动即可找到您要查找的内容。
  > 3.  最后，我们以逻辑方式对您可以购买到可以展开和折叠的部分的计划进行排序。 不需要购买任何**Office 应用和服务**？ 折叠该部分并重点关注 Microsoft 365 计划。

## <a name="october-2018"></a>2018 年 10 月

- 有一种在 Microsoft 365 管理中心购买订阅的新方法。 转到 "**购买服务**" 以查看完全重新设计的购物体验，使其易于搜索、比较计划和其他强大的新功能，从而更轻松地购买订阅。 <br/>![Microsoft 365 管理中心预览版中的购买服务计划比较](../media/0ad5acf1-8ffc-44bf-aac2-c21269910e65.png)

- "**服务和外接程序**" 页已更新为新的外观，但所有其他内容的工作方式完全相同。 当然，您应查看命令栏以查看您可以执行的新操作，如筛选和更改列表以压缩视图。 在导航窗格中，转到 "**设置** \> **服务&amp;外接程序**" 以将其签出。 <br/>![Microsoft 365 管理中心预览中的 "设置和外接程序" 页](../media/af9a3ed3-bfe6-438b-b4b5-2ca4164f8e3f.png)

## <a name="september-2018"></a>2018 年 9 月

- **主页改进**主页已完全重新完成，我们无法等待你试用并查看你的想法。 这是你的个人主页，不会影响组织中其他管理员的主页。 <br/>![屏幕捕获： Microsoft 365 管理中心预览主页。](../media/d1a497f1-30e6-4c1a-9bb2-d4d7895906da.png)

  - 您可以在主页周围添加、删除和移动主页卡。 在右上角选择 " **+ 添加卡片**" 以查看哪些卡在卡片库中可用，然后将其拖动到主页上的任意位置。 不喜欢它的进入到？ 将其拖动到所需位置。 您甚至不必再保存更多。

  - 通过将卡片分组为几个部分，将组织转到下一个级别。 我们已为你创建了两个默认部分：**基本**和**设备和更新。** 很快，你将能够添加、删除和重命名分区，以设计适合你的主页。

  - 大部分卡片都是信息性的，这意味着你将提供实时信息，以帮助你更快、更智能地完成日常任务。

  - 导航窗格已重新组织，您可以对其进行自定义，以实现快速任务。 只需从导航窗格底部选择 "**编辑**" 即可开始自定义。 <br/>![Microsoft 365 管理中心预览导航窗格](../media/7d5568cc-9ce8-40b2-aa87-e777fcd455e3.png)

- **帐单**你可能会注意到 "帐单" 部分中的 Microsoft 365 管理中心的一些最大更改。 您可以管理从 Microsoft 或其他供应商购买的订阅和应用程序，包括库存管理、订单历史、付款方式和开票的新体验。

  - 订阅管理已经过重新设计，为您提供了有关更多产品类型（包括应用程序、软件和外接程序）的新清单管理体验。现在它称为**产品&amp;服务**，可更好地反映对要添加的新产品类型的支持。 现在，您可以选择拥有产品和服务的卡片或表格视图，并且可以搜索和筛选以快速查找您要查找的内容。 <br/>![Microsoft 365 管理中心预览版中的产品和服务](../media/f1bba7dc-2034-4a53-b4ad-b7fbef3fb442.png)

  - 现在，将产品许可证分配给用户比以往更轻松。 选择您购买的产品，然后可以分配产品。 您还可以查看已为哪些用户分配了特定产品。 <br/>![Microsoft 365 管理中心预览中帐单中的产品详细信息](../media/82422685-e1b7-4f3f-aea8-1819df9d9311.png)

  - **切换计划**现在称为 * * upgrade * *，最后订阅升级在幕后发生，因此您无需观看升级完成。 最后，升级不会再提供许可证限制。

- **用户管理**我们已对用户管理进行了大量更改，以帮助你更快地完成工作。 我们已更新了 * * 活动用户 * * 页面和用户的详细信息窗格。 以下是一些更超想的更改：

  - 向 "**活动用户**" 页面提供了新的设计和新布局。 不喜欢列表的显示方式？ 选择 "**更改视图**" （"**筛选**" 旁边），然后可以将列表从 "**普通" 列表**更改为 "**压缩**列表"。 如果你的组织中有大量用户，压缩列表尤其有用。 <br/>![预览中的 "活动用户" 页](../media/4dd9f1c9-ef23-4194-9ff8-5206ba2930f8.png)

  - 命令栏（**搜索**生存情况）是动态的，并且操作列表将根据您选择的用户数量而发生变化：无用户、一个用户或多个用户。 您还将看到您在**搜索**旁边选择了多少个用户。 <br/>![Microsoft 365 预览活动用户命令栏。](../media/9576bd19-31a5-4e59-a8dd-0663a833def0.png)

  - 您可以执行快速任务，如直接从列表视图重置单个或多个用户的密码。

  - 现在，用户的详细信息和设置按以下选项卡进行组织：**帐户**、**设备**、**许可证**、**应用**、**邮件**和**OneDrive**。 以前，其中很多设置都位于多个屏幕上。 <br/>![管理员中心预览中的用户详细信息窗格。](../media/60c6b9d3-d62f-4b8d-97db-41ff247b1bf0.png)<br/>
