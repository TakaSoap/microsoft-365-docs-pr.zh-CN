...
- **还原已删除的 microsoft 365 组**：无需再转到 Exchange 管理中心即可还原已删除的 microsoft 365 组。 转到**Microsoft 365 管理中心** \> **组** \> **已删除的组** \> （从列表中选择一个组\> ）**还原组**。 它会将组还原回 "**组**" 列表，并还原组的电子邮件、对话、笔记本、文件和日历。
...
- [Microsoft 365 for business security 概述](https://support.office.com/article/3274b159-a825-46d7-9421-7d6e209389d1)
