...
30 | 默认<BR>必填 | 否 | `sharepoint.de` | **TCP：** 443、80
...
33 | 默认<BR>必填 | 否 | `res.delve.office.com` | **TCP：** 443
34 | 默认<BR>必填 | 否 | `lpcres.delve.office.com` | **TCP：** 443
