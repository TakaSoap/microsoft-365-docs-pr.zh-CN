...
- 如果不存在信任Azure Active Directory，则使用证书创建信任
...
2. 确保相关用户有权管理 Microsoft Endpoint Manager 中的终结点安全设置，或者通过配置 Microsoft 365 Defender 门户中的角色授予这些权限。 转到设置  >  **角色**  >  **添加项**：
...
3. 配置角色时，请添加用户并确保选择以下选项中的"管理 **终结点安全设置Microsoft Endpoint Manager：**
...
5. 选择 **终结点安全** Microsoft Defender for  >  **Endpoint，** 将 **允许 Microsoft Defender for Endpoint 强制实施** 终结点安全配置 (预览版) **设置为"打开"。**
...
可以在管理中心内或Azure AD[为](/azure/active-directory/fundamentals/active-directory-groups-create-azure-portal)这些设备Microsoft Endpoint Manager[组](/mem/intune/fundamentals/groups-add)。
