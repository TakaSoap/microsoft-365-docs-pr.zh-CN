...
ID | 类别 | ER | Addresses | 端口
-- | ------------------- | --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------
11x17 | 允许<BR>必填 | 是 | `*.gov.online.office365.us`<BR>`52.127.37.0/24, 52.127.82.0/23` | **TCP：** 443
...
16  | 允许<BR>必填 | 是 | `portal.office365.us, webshell.suite.office365.us, www.office365.us`<BR>`13.72.179.48/32, 52.227.167.206/32, 52.227.170.242/32` | **TCP：** 443、80
...
合 | 默认<BR>必填 | 否 | `cdn.odc.officeapps.live.com, odc.officeapps.live.com, officeclient.microsoft.com` | **TCP：** 443、80
上午 | 默认<BR>必填 | 否 | `*.office365.us` | **TCP：** 443、80
24 | 默认<BR>必填 | 否 | `lpcres.delve.office.com` | **TCP：** 443
word | 默认<BR>必填 | 否 | `*.cdn.office.net` | **TCP：** 443
26 | 允许<BR>必填 | 是 | `*.compliance.microsoft.us, *.security.microsoft.us, compliance.microsoft.us, security.microsoft.us`<BR>`13.72.179.197/32, 13.72.183.70/32, 23.103.191.0/24, 23.103.199.128/25, 23.103.208.0/22, 52.227.170.14/32, 52.227.170.120/32, 52.227.178.94/32, 52.227.180.138/32, 52.227.182.149/32, 52.238.74.212/32, 2001:489a:2202:4::/62, 2001:489a:2202:c::/62, 2001:489a:2202:2000::/63` | **TCP：** 443、80
27 | 允许<BR>必填 | 是 | `*.gov.microsoftstream.us`<BR>`20.140.160.0/24, 20.140.162.0/24` | **TCP：** 1935、1936、2935、2936、443
