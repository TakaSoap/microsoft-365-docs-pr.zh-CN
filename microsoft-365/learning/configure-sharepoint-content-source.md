---
title: '将 SharePoint 配置为 Microsoft Viva Learning (Preview) '
ms.author: chucked
...
ms.locfileid: "52782773"
---
# <a name="configure-sharepoint-as-a-learning-content-source-for-microsoft-viva-learning-preview"></a><span data-ttu-id="e82e1-103">将 SharePoint 配置为 Microsoft Viva Learning (Preview) </span><span class="sxs-lookup"><span data-stu-id="e82e1-103">Configure SharePoint as a learning content source for Microsoft Viva Learning (Preview)</span></span>

> [!NOTE]
> <span data-ttu-id="e82e1-104">此功能在产品预览中尚不可用。</span><span class="sxs-lookup"><span data-stu-id="e82e1-104">This feature is not yet available in product preview.</span></span> 
