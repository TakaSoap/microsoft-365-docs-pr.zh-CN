...
---
# <a name="increase-threat-protection-for-microsoft-365-business-premium"></a>增强威胁防护Microsoft 365 商业高级版
...
如果尚未看到租户中带卡的"安装"页面，请参阅安全与合规中心&这些步骤。 请参阅[在安全保险箱](#set-up-safe-attachments-in-the-security--compliance-center)合规中心设置&附件"和在安全与保险箱中心中设置&[链接](#set-up-safe-links-in-the-security--compliance-center)。
...
4. 在打开的窗格中，选中电子邮件中的链接和附件、扫描 **SharePoint、OneDrive 和 Teams** 中的文件以及扫描 Office 桌面和 **Office Online** 应用中的链接旁边的复选框，在扫描恶意内容的项目下。
...
2. 在 **设置适用于** 电子邮件之外的内容"下，选择"Microsoft 365 企业应用版 **，Office适用于 iOS 和 Android 的内容**"。
...
1. 若要打开"审核日志"，请转到 的管理中心 ，<https://admin.microsoft.com>然后选择左侧导航中"管理中心"下的"安全性"。
...
1. 转到管理中心 ，<https://admin.microsoft.com>然后选择左侧导航 **SharePoint中的"** 管理中心"下选择"管理中心"。
...
可以使用活动警报跟踪管理员和用户活动，并检测组织中恶意软件和数据丢失防护事件。 你的订阅包括一组默认策略，但你也可以创建自定义策略。 有关详细信息，请参阅 [警报策略](../compliance/alert-policies.md)。 例如，如果您将一个重要文件存储在 SharePoint您不希望任何人在外部共享，您可以创建一条通知，提醒您是否有人共享它。
...
1. 选择 **"** 日历"，并选择组织成员是否可以与外部拥有日历Office 365或Exchange共享日历。
