...
ms.locfileid: "47332696"
---
# <a name="microsoft-365-technology-controls"></a>Microsoft 365 技术控件 

Microsoft 使用多种工具和技术来控制、管理和审核对其在线服务中的客户数据的访问。 这些应用于 Exchange Online、SharePoint Online、密码箱和客户密码箱、多重身份验证等。 Yammer 使用 [Yammer Enterprise Access 控件](microsoft-365-yammer-enterprise-access-controls.md)中所述的类似控件。
