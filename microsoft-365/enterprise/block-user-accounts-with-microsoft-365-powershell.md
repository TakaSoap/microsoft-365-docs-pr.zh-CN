...
当您阻止对 Microsoft 365 帐户的访问时，您可以阻止任何人使用该帐户登录并访问您的 Microsoft 365 组织中的服务和数据。 您可以使用 PowerShell 阻止对单个或多个用户帐户的访问。
...
本示例阻止对用户帐户 *fabricec@litwareinc.com*的访问。
...
若要阻止对多个用户帐户的访问，请在以下各行上创建包含一个帐户登录名的文本文件，如下所示：
...
在以下命令中，示例文本文件为 *C:\My Documents\Accounts.txt*。 将此文件名替换为您的文本文件的路径和文件名。
...
### <a name="block-access-for-multiple-user-accounts"></a>阻止对多个用户帐户的访问
