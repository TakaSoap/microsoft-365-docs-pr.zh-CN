...
必须先激活权限管理服务 (RMS) ，然后才能使用 Microsoft 365 应用程序和服务的信息权限管理 (IRM) 功能。 激活 RMS 后，组织可以开始使用 Azure RMS 保护重要文档和电子邮件。 此信息保护解决方案可以保护所有文件类型，并与客户端应用程序（如 Excel、Microsoft Word 和其他应用程序、Exchange Online 和 SharePoint Online）以及服务器（如 Microsoft Exchange 和 Microsoft SharePoint）集成。
...
- 有关为 Microsoft 365 激活 RMS 的说明，请参阅从 [Azure 信息保护激活保护服务](/azure/information-protection/activate-service)。