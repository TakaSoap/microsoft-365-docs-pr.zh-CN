...
由于用户帐户仅存储在 Azure AD 中，因此使用管理中心等工具管理Microsoft 365[云](../admin/add-users/index.yml)[Windows PowerShell。](manage-user-accounts-and-licenses-with-microsoft-365-powershell.md) 
...
在 Azure AD 中，Microsoft 365管理中心或 PowerShell Microsoft 365管理同步的用户帐户。
