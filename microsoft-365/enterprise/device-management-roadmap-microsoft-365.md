...
拥有自己的个人设备的用户可能不希望注册其设备或由 Intune 和组织的策略进行管理。 但你仍然需要保护组织的资源和数据。 在此方案中，可以使用移动应用程序管理来保护应用。 例如，可以使用移动应用程序管理策略，该策略要求用户在设备上访问 SharePoint Online 时输入 PIN。

你还将确定如何管理个人设备和组织拥有的设备。 你可能希望根据设备的用途以不同方式处理设备。
...
## <a name="choose-between-the-two-options"></a>在两个选项之间选择

为了帮助你更好地评估最适合你的设备管理选项，请参阅"在基本移动性安全性与[Intune 之间选择"。](https://docs.microsoft.com/office365/securitycompliance/choose-between-mdm-and-intune)
...
## <a name="how-contoso-did-device-management-for-microsoft-365"></a>Contoso 如何对 Microsoft 365 进行设备管理

有关虚构但具有代表性的多媒体企业如何使用 Microsoft 365 云服务部署其移动设备管理基础结构的信息，请参阅 [Contoso](contoso-mdm.md)的移动设备管理。
