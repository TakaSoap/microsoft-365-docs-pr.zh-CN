...
> [!IMPORTANT]
> 对于未预配OneDrive用户，请许可帐户，并等待至少 48 小时，设置用户的 PDL 后，更改才能传播，然后用户登录到 OneDrive。 （在用户登录预配 OneDrive for Business 前设置首选数据位置，可确保在正确的位置中预配用户的新 OneDrive。）
