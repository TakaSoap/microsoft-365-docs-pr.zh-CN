...
> [!NOTE]
> Exchange Online PLD 发生更改且 MailboxRegion 不再与邮箱数据库地理位置代码匹配，则自动重定位用户的邮箱。 有关详细信息，请参阅[在多地理位置Exchange Online管理](./administering-exchange-online-multi-geo.md)邮箱。
