...
对于第二个建议，您可以通过将网关子网使用的位设置为 0，将 VNet 地址空间中的其余位设置为 1 来确定网关子网的地址空间。 若要快速计算网关子网地址空间，而无需转换为二进制并转换回十进制，可以使用用 C# 或 Python 编写的控制台应用程序或 PowerShell 命令块。
