...
ms.custom: ''
description: 新式桌面部署中心概述。
ms.openlocfilehash: d9c91c57fda8c1438ae7233002508c51b7b0ff5e
ms.sourcegitcommit: eb1a77e4cc4e8f564a1c78d2ef53d7245fe4517a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/28/2018
ms.locfileid: "26865763"
---
# <a name="modern-desktop-deployment-center"></a>新式桌面部署中心
...
请按照以下步骤操作，计划和执行 Windows 10 和 Office 365 专业增强版的大规模部署。下列每一步都是总体计划和部署过程的一部分，而且这些步骤通常都是与阶段性部署中的步骤相互并行进行。下载免费的[新式桌面部署和管理实验室工具包](https://aka.ms/howtoshiftlabs)，以获取有关部署过程中突出显示的工具的实操培训。
...
<p>确保应用程序已打包，且可进行自动安装。了解 Office 365 专业增强版的即点即用打包如何为你提供新选项来配置、交付和保持最新的 Office 应用版本。</p></td>
...
<p>Windows 10 和 Office 365 专业增强版提供了保护数据、设备和用户以及快速检测和响应威胁的新方法。此外，请了解在迁移到 Windows 10 时，如何处理与磁盘加密、防恶意软件应用和策略相关的常见问题。</p></td>
...
<td><p><strong><a href="https://aka.ms/mdd7">步骤 7：为实现 Windows 和 Office 即服务做好准备</a></strong></p>
...
<td><p><strong><a href="https://transform.microsoft.com" target="_blank">获得领导层的支持：价值发现和业务案例</a></strong></p>
<p>如果你已经完成了部署研究、评估了应用和设备的就绪情况、指定了部署计划并已开始进行试点部署，但却未能从领导团队获得如期执行各项部署工作所需的支持或资源，Microsoft 的业务价值计划可为你提供相关帮助。请了解如何打造有关新式桌面的业务案例并获得所有人的支持。</p></td>
