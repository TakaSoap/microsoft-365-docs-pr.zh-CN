        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>将 ConfigMgr 升级到 Current Branch</h3>
            <p>使用 Configuration Manager 的组织的目录和网络就绪情况的一部分</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>验证设备和应用就绪情况</h3>
            <p>设备和应用就绪情况的一部分；可通过桌面应用保证获得帮助</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>将 Windows 7 电脑升级到 Windows 10</h3>
            <p>适用于用户保留的电脑的 OS 部署和功能更新的一部分</p>
                    </div>
                </div>
            </div>
        </div>
