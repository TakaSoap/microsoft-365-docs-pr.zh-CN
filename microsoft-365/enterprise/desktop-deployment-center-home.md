...
<table>
    ...
    <tr>
    <td>
使用 System Center Configuration Manager 的组织的目录和网络准备步骤的一部分 </td>
    <td>
...
<p>如果你已经完成了部署研究、评估了应用和设备的就绪情况、指定了部署计划并已开始进行试点部署，但却未能从领导团队获得如期执行各项部署工作所需的支持或资源，Microsoft 的业务价值计划可为你提供相关帮助。 请了解如何建立业务案例以迁移至 Windows 10 和 Office 365 专业增强版并帮助每个人加入。</p></td>
