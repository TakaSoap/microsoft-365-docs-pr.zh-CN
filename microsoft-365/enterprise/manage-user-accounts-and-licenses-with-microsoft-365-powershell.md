...
Microsoft 365 管理员需要管理用户帐户、许可证和组。 虽然您可以在 Microsoft 365 管理中心执行这些任务中的大多数，但在 PowerShell 中有些任务更容易。
...
## <a name="groups"></a>组
- [维护组成员身份](maintain-group-membership-with-microsoft-365-powershell.md)
