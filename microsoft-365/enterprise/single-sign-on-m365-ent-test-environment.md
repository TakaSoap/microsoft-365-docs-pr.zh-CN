...
按照 Microsoft [365 的密码哈希同步中的说明进行操作](password-hash-sync-m365-ent-test-environment.md)。 
...
- 在 APP1 上运行的 Azure AD Connect 定期将 TESTLAB Active Directory 域服务 (AD DS) 域同步到 Microsoft 365 订阅的 Azure AD 租户。
...
2. 从 APP1 桌面运行 Azure AD Connect。
...
8. 在 **Windows 安全** 对话框中，输入 **user1** 和 user1 帐户的密码，选择"**确定**"，然后选择"下一步 **"。**

9. 在"**准备配置"页上，** 选择"配置 **"。**

10. 在"**配置完成"页上**，选择"退出 **"。**

11. 从 Azure 门户的左侧窗格中，选择 **"Azure Active Directory**  >  **Azure AD Connect"。** 验证无缝 **单一登录** 功能是否显示为 **已启用**。
...
- Azure AD 无缝 SSO 已启用，以便模拟 Intranet 上的计算机无需指定用户帐户密码即可登录到 Microsoft 365 云资源。
