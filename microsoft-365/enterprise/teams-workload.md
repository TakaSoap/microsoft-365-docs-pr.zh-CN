...
>[!Note]
>只有在完成 Microsoft 365 企业版的[底层基础结构](deploy-foundation-infrastructure.md)之后，才应按照这些部署说明进行操作。
>
...
Teams 可用于很多不同的目的。你需要将组织、业务组、部门和各个工作和项目小组的业务需求与相关目的进行对应。有关帮助你定义 Teams 应用场景的示例，请查阅 [Microsoft 365 生产力库](https://www.microsoft.com/microsoft-365/success)。 
