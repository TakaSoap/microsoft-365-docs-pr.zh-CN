...
|:-------|:-------|:-----|
| 适用于高科技用户和开发人员。 <br><br> 率先使用最新代码访问开发周期中最早的最新版本。 <br><br> 会有边缘粗糙和一些不稳定的情况。 | 开发 | 不适用 |
| 适合希望获得更可靠版本且仍在开发中的早期采用者和 IT 专业人员。 <br><br> 看看接下来会发生什么，并帮助验证新功能。 | Beta 版频道 | Beta 版频道 |
| 适用于那些希望尽早访问即将发布的版本的人员。 <br><br> 公司可以在广泛部署前预览和验证即将发布的版本。 <br><br> 以下版本受支持。 <br>  | 发布预览版 | 当前频道（预览） <br><br> 半年企业频道（预览）|
||||
