...
如果你对德国 Microsoft 云实例中的 Office 365 和 Azure 使用单一登录，则必须相应地准备和计划 Azure 订阅迁移。 确保你了解适用于[Microsoft Azure 的Microsoft Azure。](ms-cloud-germany-transition-add-pre-work.md#microsoft-azure)
