...
本文是 Network [planning and performance tuning for Microsoft 365 的一部分](./network-planning-and-performance.md)。
...
有关如何使用数字证书确保内部部署组织与 Exchange之间的通信安全的Exchange Online，请参阅 TechNet 文章[了解证书要求](/previous-versions/exchange-server/exchange-141/gg476123(v=exchg.141))。
