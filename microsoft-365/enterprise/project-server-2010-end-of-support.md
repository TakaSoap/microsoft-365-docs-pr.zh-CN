...
下面是避免停止支持 Project Server 2010 的两个路径。
...
- 移动到联机解决方案，Project Online或Project Web 解决方案

#### <a name="move-to-a-newer-version-of-project-client"></a>移动到较新版本的 Project 客户端

如果要从 Project Standard 2010 进行迁移，可以迁移到较新版本的 Project Standard (Project Standard 2016 或 Project Standard 2019) 。 我们建议你移动到最新版本，以利用最新功能。 迁移到更新版本 (Project Standard 2016) 也意味着需要更快重新迁移。
...
- **从 Microsoft 解决方案提供商获取帮助**- 从 Project Server 2010 进行升级可能是一个挑战。 这需要做很多准备和规划。 如果您不是最初在 Server 2010 中设置 Project人员，则它尤其具有挑战性。 无论你计划迁移到 Project Server 2019 还是迁移到 Project Online，Microsoft 解决方案提供商都Project Online。 在 Microsoft 解决方案提供商中心 [中搜索解决方案提供商](https://go.microsoft.com/fwlink/p/?linkid=841249)。
...
> [!NOTE]
> 如果您仅限于本地解决方案，并考虑仅迁移到 Project Server 2013，请注意，此版本仅还有几年的支持。 Project Server 2013 Service Pack 2 的支持结束日期 2023 年 10 月 13 日。 有关停止提供支持日期的信息，请参阅 [Microsoft 产品生命周期策略](/lifecycle/)。
...
有关从 Project Server 2010 升级到 Project Server 2013 的全面信息，请参阅[Upgrade to Project Server 2013。](/project/upgrade-to-project-server-2016)
