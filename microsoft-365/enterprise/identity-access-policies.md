...
---
# <a name="common-identity-and-device-access-policies"></a>通用身份识别与设备访问策略建议
...
9. 选择 "**授予访问权限**", 选择 "**需要批准的客户端应用**"。 对于多个控件, 选择 "**需要选定的控件**", 然后选择 "**选择**"。 
...
|类型|属性|值|注意|
|:---|:---------|:-----|:----|
|Windows Defender 高级威胁防护规则|要求设备在计算机风险得分|中等||
