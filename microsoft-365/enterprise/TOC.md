...
#### [第 1 步：计划用户和组](identity-plan-users-groups.md)
#### [第 2 步：保护全局管理员帐户](identity-designate-protect-admin-accounts.md)
#### [第 3 步：设置按需全局管理员](identity-privileged-identity-management.md)
#### [第 4 步：简化密码重置](identity-password-reset.md)
#### [第 5 步：设置多重身份验证](identity-multi-factor-authentication.md)
#### [第 6 步：防范凭据泄漏](identity-azure-ad-identity-protection.md)
#### [第 7 步：同步目录](identity-azure-ad-connect.md)
#### [第 8 步：监视同步运行状况](identity-azure-ad-connect-health.md)
#### [第 9 步：简化密码更新](identity-password-writeback.md)
#### [第 10 步：简化用户登录](identity-single-sign-on.md)
#### [第 11 步：自定义 Office 365 登录页](identity-customize-office-365-sign-in.md)
#### [第 12 步：设置自动授权](identity-group-based-licensing.md)
#### [第 13 步：监视租户和登录活动](identity-azure-ad-access-usage-reporting.md)
#### [第 14 步：允许用户创建和管理自己的组](identity-self-service-group-management.md)
#### [第 15 步：设置动态组成员资格](identity-automatic-group-membership.md)
...
#### [第 3 步：配置增强的 Office 365 安全性](infoprotect-configure-increased-security-office-365.md)
#### [第 4 步：配置 Office 365 Privileged Access Management](infoprotect-configure-privileged-access-management.md)
...
### [适用于高度受管制数据的团队和网站](teams-sharepoint-online-sites-highly-regulated-data.md)
...
### [适用于高度受管制数据的 SharePoint Online 网站](contoso-sharepoint-online-site-for-highly-confidential-assets.md)

# [新式桌面部署中心](desktop-deployment-center-home.md)
...
## [第 6 步：OS 部署和功能更新](step-6-os-deployment-and-feature-updates.md)
## [第 7 步：Windows 和 Office 即服务](step-7-windows-and-office-as-a-service.md)
## [第 8 步：用户通信和培训](step-8-user-communications-and-training.md)
## [新式桌面部署和管理实验室工具包](modern-desktop-deployment-and-management-lab.md)
## [发掘领导力：价值发现和业务案例](https://transform.microsoft.com)
...
## [ISO - 建议行动计划](../compliance/iso-action-plan.md)
## [NIST - 建议行动计划](../compliance/nist-action-plan.md) 
## [GDPR](../compliance/gdpr.md?toc=/microsoft-365/enterprise/toc.json)

### [适用于 GDPR 的建议行动计划](../compliance/gdpr-action-plan.md)

### [当责就绪清单](../compliance/gdpr-arc.md)
...
#### [Visual Studio 系列产品](../compliance/gdpr-dsr-visual-studio-family.md?toc=/microsoft-365/enterprise/toc.json)
...
### [漏洞通知](../compliance/gdpr-breach-notification.md?toc=/microsoft-365/enterprise/toc.json)
...
### [Microsoft 数据保护主管](../compliance/gdpr-data-protection-officer.md)