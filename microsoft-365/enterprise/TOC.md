...
#### [步骤 2: 保护你的特权身份](identity-designate-protect-admin-accounts.md)
#### [步骤 3: 配置混合标识](identity-azure-ad-connect.md)
#### [步骤 4: 配置安全的用户身份验证](identity-multi-factor-authentication.md)
#### [步骤 5: 简化对用户的访问](identity-password-reset.md)
#### [步骤 6: 使用组便于管理](identity-self-service-group-management.md)
...
#### [步骤 3: 为 Microsoft 365 配置增强的安全性](infoprotect-configure-increased-security-office-365.md)
#### [第 4 步：配置 Office 365 的特权访问管理](infoprotect-configure-privileged-access-management.md)
...
#### [设备合规性策略](mam-policies-for-your-microsoft-365-enterprise-dev-test-environment.md)
### [信息保护]()
...
#### [因素](../compliance/gdpr-dpia-dynamics.md)
#### [Microsoft 支持和专业服务](../compliance/gdpr-dpia-prof-services.md)

### [Microsoft 数据保护官员](../compliance/gdpr-data-protection-officer.md)