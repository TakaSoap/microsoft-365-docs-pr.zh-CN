...
---
# <a name="automate-licensing-and-group-membership-for-your-microsoft-365-for-enterprise-test-environment"></a>自动化 Microsoft 365 企业版测试环境的许可和组成员身份

*本测试实验室指南仅适用于 Microsoft 365 企业版测试环境。*

基于组的许可根据组成员身份自动分配或删除用户帐户的许可证。 动态组成员身份基于用户帐户属性（如部门或国家/地区）向组添加或删除 **成员**。  本文将分步演示在 Microsoft 365 企业版测试环境中添加和删除组的成员。
...
1. 在 Internet 浏览器的专用实例中，使用 [Microsoft 365](https://admin.microsoft.com) E5 测试实验室订阅的全局管理员帐户登录 Microsoft 365 管理中心。
...
接下来，配置"销售"组，以便自动为成员分配 Microsoft 365 E5 许可证。
...
5. 在产品 **许可证窗格中**，禁用 **Microsoft 365 E5** 许可证，然后选择保存  >  **关闭**。
...
- **使用** **Microsoft 365 E5** 许可证更新了产品许可证属性。

请参阅以下文章以在生产中部署动态组成员身份和自动许可：

- [Azure Active Directory 中基于组的许可](/azure/active-directory/fundamentals/active-directory-licensing-whatis-azure-portal)
