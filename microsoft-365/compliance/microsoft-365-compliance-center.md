...
我们仍在开发 Microsoft 365 合规性中心，我们在未来的几个月中添加了更多的功能和解决方案。 同时，在安全 & 合规中心（）中必须完成一些任务 [https://protection.office.com](https://protection.office.com) 。 在这些情况下，你将自动转到你可以在其中完成任务的位置，例如创建或编辑监督策略。
...
- **查看 Microsoft 合规性分数**以提高合规性分数。 若要了解详细信息，请参阅[合规性分数（预览）](compliance-score.md)。
