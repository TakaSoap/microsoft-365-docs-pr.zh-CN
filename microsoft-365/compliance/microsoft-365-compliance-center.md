...
- **查看 Microsoft 合规性分数** 以提高合规性分数。 若要了解详细信息，请参阅 [合规性分数 (Preview) ](compliance-score.md)。
