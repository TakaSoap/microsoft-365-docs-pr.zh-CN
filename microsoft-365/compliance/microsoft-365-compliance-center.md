...
- 若要访问Microsoft 365 合规中心全局管理员、合规性管理员或合规性数据管理员转到 [https://compliance.microsoft.com](https://compliance.microsoft.com) 并登录。
