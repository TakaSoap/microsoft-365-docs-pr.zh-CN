...
Microsoft SharePoint 2013 支持信息权限管理 (IRM) PDF 文档保护。 借助该支持，用户可以将 PDF 文档上载到受 IRM 保护的库，下载后，这些文件将受 IRM Microsoft Office保护。
  
若要在所有者使用 IRM 保护的库中使用 PDF 文件，用户需要获取以下 PDF 兼容读者之一：
  
| 操作系统 | 兼容读者 | 下载链接 |
|:-----|:-----|:-----|
|Windows Vista  <br/> |Foxit Reader  <br/> NitroPDF  <br/> |[下载 Foxit Reader](https://go.microsoft.com/fwlink/?linkid=2139326) <br/> [下载 NitroPDF](https://go.microsoft.com/fwlink/?linkid=2139327) <br/> |
|Windows 7  <br/> |Azure 信息保护应用  <br/> Foxit Reader  <br/> NitroPDF  <br/> Edge Chromium  <br/>|[下载 Azure 信息保护应用](https://go.microsoft.com/fwlink/?linkid=837797) <br/> [下载 Foxit Reader](https://go.microsoft.com/fwlink/?linkid=2139326) <br/> [下载 NitroPDF](https://go.microsoft.com/fwlink/?linkid=2139327) <br/> [下载 Edge Chromium](https://support.microsoft.com/microsoft-edge/download-the-new-microsoft-edge-based-on-chromium-0f4a3dd7-55df-60f5-739f-00010dba52cf) <br/>|
|Windows 8 (经典模式)   <br/> |Azure 信息保护应用  <br/> Foxit Reader  <br/> NitroPDF  <br/> Edge Chromium  <br/>|[下载 Azure 信息保护应用](https://go.microsoft.com/fwlink/?linkid=837797) <br/> [下载 Foxit Reader](https://go.microsoft.com/fwlink/?linkid=2139326) <br/> [下载 NitroPDF](https://go.microsoft.com/fwlink/?linkid=2139327) <br/> [下载 Edge Chromium](https://support.microsoft.com/microsoft-edge/download-the-new-microsoft-edge-based-on-chromium-0f4a3dd7-55df-60f5-739f-00010dba52cf) <br/> |
|Windows 8.1  <br/> |Azure 信息保护应用  <br/> Foxit Reader  <br/> NitroPDF  <br/> |[下载 Azure 信息保护应用](https://go.microsoft.com/fwlink/?linkid=837797) <br/> [下载 Foxit Reader](https://go.microsoft.com/fwlink/?linkid=2139326) <br/> [下载 NitroPDF](https://go.microsoft.com/fwlink/?linkid=2139327) <br/> |
