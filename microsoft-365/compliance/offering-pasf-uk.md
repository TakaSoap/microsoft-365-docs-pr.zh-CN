...
英国国家监察信息风险管理团队（NPIRMT）已完成对 Microsoft Azure 数据中心在英国的物理基础结构的全面安全评估，最终结论为符合 NPIRMT 要求，而无需执行任何补救措施。 这一成功的实地审核意味着 Microsoft 商业云服务现在可以支持在英国的警察强制实施，这需要有警方的安全设施（PASF）来处理并将其数据存储在云中。
