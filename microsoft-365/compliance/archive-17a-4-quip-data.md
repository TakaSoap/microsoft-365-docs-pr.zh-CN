...
使用[Quip DataParser](https://www.17a-4.com/quip-dataparser/) from 17a-4 LLC 将数据从 Quip 导入并存档到组织Microsoft 365邮箱。 DataParser 包括配置为捕获第三方数据源中的项目，以及将这些项目导入到第三方数据源的 Quip Microsoft 365。 Quip DataParser 连接器将 Quip 数据转换为电子邮件格式，然后将这些项目导入 Microsoft 365。
