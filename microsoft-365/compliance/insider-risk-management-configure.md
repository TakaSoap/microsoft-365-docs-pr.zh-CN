...
2. 在 **"内部** 风险管理概述"选项卡上的"扫描 **组织卡中的** 内部风险"中选择" **运行扫描** "。此操作将打开组织的分析扫描。 还可以导航到预览体验成员风险设置 分析 (预览版) 并启用扫描租户的用户活动，以确定潜在的内部风险，从而在组织中  >  **启用扫描**。
