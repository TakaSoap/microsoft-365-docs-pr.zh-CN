---
title: 使用Windows 10 Windows 11载入设备和设备
f1.keywords: NOCSH
ms.author: chrfox
author: chrfox
manager: laurawi
...
ms.locfileid: "60950819"
---
# <a name="onboard-windows-10-and-windows-11-devices-using-configuration-manager"></a>使用Windows 10 Windows 11载入设备和设备
...
1. 从 Microsoft 合规性.zip获取 *(DeviceComplianceOnboardingPackage.zip)*[文件](https://compliance.microsoft.com/)。
...
> [!NOTE]
> Microsoft 365 [OOBE](https://answers.microsoft.com/en-us/windows/wiki/windows_10/how-to-complete-the-windows-10-out-of-box/47e3f943-f000-45e3-8c5c-9d85a1a0cf87)体验阶段期间， (信息保护) 载入。 确保用户在运行完安装或升级Windows OOBE。
...
> 如果由于挂起的 OOBE (或其他任何原因) 未载入设备，Configuration Manager 将重试载入设备，直到规则检测到状态更改。
>
...
2. 检查设备是否符合 Microsoft 365 设备载入服务 (这可确保设备可以完成载入过程，并可以继续将数据报告给服务) 。
...
- [使用Windows 10 Windows 11载入设备和设备](device-onboarding-gp.md)
