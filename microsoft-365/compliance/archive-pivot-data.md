...
description: 管理员可以设置连接器，以从 Microsoft 365 中导入和存档来自 Microsoft 365。 此连接器允许您在 Microsoft 365 中存档来自第三方数据源的数据，以便您可以使用合规性功能（如合法保留、内容搜索和保留策略）来管理组织的第三方数据。
ms.openlocfilehash: 76f18c80ed9c1c4ee8fa9c20fd19a75d6022ff61
ms.sourcegitcommit: 36a19d80fe3f053df0fec398a7ff2dfc777f9730
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/30/2021
ms.locfileid: "61643620"
---
# <a name="set-up-a-connector-to-archive-pivot-data"></a>设置连接器以存档透视数据

使用 Microsoft 365 合规中心 中的一个 Microsoft 365 合规中心 将数据从透视平台导入并存档到组织的用户Microsoft 365邮箱。 对于第三方数据源[](https://globanet.com/pivot/) (，则系统为您提供一个配置为定期捕获项目的数据透视) 然后将这些项导入Microsoft 365。 Pivot 是一个即时消息平台，允许与金融市场参与者进行协作。 连接器将聊天消息等项目从用户的透视帐户转换为电子邮件格式，然后将这些项目导入 Microsoft 365。

将透视数据存储在用户邮箱中后，可以应用 Microsoft 365合规性功能，如诉讼保留、电子数据展示、保留策略和保留标签以及通信合规性。 使用透视连接器在数据透视表中导入和存档Microsoft 365可帮助组织遵守政府法规策略。
...
3. 在 Microsoft 365 合规中心 创建的数据透视连接器每天连接到一次，将透视表项目转移到 Microsoft 云中的安全 Azure 存储 位置。
