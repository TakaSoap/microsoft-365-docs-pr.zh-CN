...
- 您必须使用 **New-MailboxSearch** cmdlet Windows PowerShell软删除In-Place邮箱设置保留状态。 不能使用 SharePoint Online 中的 Exchange 管理中心 (EAC) 或电子数据展示中心。
