...
使用 Microsoft 365 合规中心中的 Globanet 连接器，将第三方数据从社交媒体、即时消息和文档协作平台导入并存档到 Microsoft 365 组织的邮箱。 Globanet 提供 [Slack](https://globanet.com/slack/) 连接器，配置为定期捕获第三方数据源 (中的项目) 然后将这些项目导入到 Microsoft 365。 Slack 从 Slack API 提取邮件和文件，并将其转换为电子邮件格式，然后将项目导入到用户邮箱。
...
2. 每 24 小时一次，Slack 电子数据展示中的聊天消息会复制到 Globanet Merge1 网站。 连接器还会将聊天消息的内容转换为电子邮件格式。
