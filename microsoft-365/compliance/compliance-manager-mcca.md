...
<span data-ttu-id="9f3d9-109">MCCA 可帮助你快速查看合规性管理程序中适用于当前 Microsoft 365 环境的改进操作。</span><span class="sxs-lookup"><span data-stu-id="9f3d9-109">MCCA can help you quickly see which improvement actions in Compliance Manger apply to your current Microsoft 365 environment.</span></span> <span data-ttu-id="9f3d9-110">MCCA 确定的每个操作都将为您提供实施建议，并直接链接到合规性管理器和适用的解决方案以开始采取纠正措施。</span><span class="sxs-lookup"><span data-stu-id="9f3d9-110">Each action identified by MCCA will give you recommendations for implementation, with direct links to Compliance Manager and the applicable solution to start taking corrective action.</span></span>
...
1. <span data-ttu-id="9f3d9-125">选择 **Windows"开始"** 按钮。</span><span class="sxs-lookup"><span data-stu-id="9f3d9-125">Select the Windows **Start** button.</span></span>
...
2. <span data-ttu-id="9f3d9-154">若要指定特定区域，您将使用下表中对应于该国家/地区的数字运行 cmdlet。</span><span class="sxs-lookup"><span data-stu-id="9f3d9-154">To specify a certain region, you’ll run a cmdlet using the numbers from the table below that correspond to the country or region.</span></span> <span data-ttu-id="9f3d9-155">输入多个号码，用逗号分隔它们。</span><span class="sxs-lookup"><span data-stu-id="9f3d9-155">Enter multiple numbers by separating them with a comma.</span></span> <span data-ttu-id="9f3d9-156">例如，以下 cmdlet 将针对 Asia-Pacific 和 Japan 运行自定义报告：</span><span class="sxs-lookup"><span data-stu-id="9f3d9-156">For example, the cmdlet below will run a customized report for Asia-Pacific and Japan:</span></span>
  ...
  | <span data-ttu-id="9f3d9-179">11 </span><span class="sxs-lookup"><span data-stu-id="9f3d9-179">11</span></span> | <span data-ttu-id="9f3d9-180">南非</span><span class="sxs-lookup"><span data-stu-id="9f3d9-180">South Africa</span></span> |
  | <span data-ttu-id="9f3d9-181">12 </span><span class="sxs-lookup"><span data-stu-id="9f3d9-181">12</span></span> | <span data-ttu-id="9f3d9-182">Switzerland（瑞士）</span><span class="sxs-lookup"><span data-stu-id="9f3d9-182">Switzerland</span></span> |
  | <span data-ttu-id="9f3d9-183">13 </span><span class="sxs-lookup"><span data-stu-id="9f3d9-183">13</span></span> | <span data-ttu-id="9f3d9-184">阿拉伯联合酋长国</span><span class="sxs-lookup"><span data-stu-id="9f3d9-184">United Arab Emirates</span></span> |
  | <span data-ttu-id="9f3d9-185">14 </span><span class="sxs-lookup"><span data-stu-id="9f3d9-185">14</span></span> | <span data-ttu-id="9f3d9-186">英国</span><span class="sxs-lookup"><span data-stu-id="9f3d9-186">United Kingdom</span></span> |


 > [!NOTE]
> <span data-ttu-id="9f3d9-187">报告将始终包括 MCCA 支持的国际敏感信息类型，如 SWIFT 代码、信用卡号等。</span><span class="sxs-lookup"><span data-stu-id="9f3d9-187">The report will always include MCCA supported international sensitive information types such as SWIFT code, credit card number, etc.</span></span>

#### <a name="role-based-reporting"></a><span data-ttu-id="9f3d9-188">基于角色的报告</span><span class="sxs-lookup"><span data-stu-id="9f3d9-188">Role-based reporting</span></span>

<span data-ttu-id="9f3d9-189">你的报告也会根据你的角色进行自定义。</span><span class="sxs-lookup"><span data-stu-id="9f3d9-189">Your report will also be customized based on your role.</span></span>

<span data-ttu-id="9f3d9-190">下表显示了哪些角色有权访问报告的哪些部分。</span><span class="sxs-lookup"><span data-stu-id="9f3d9-190">The table below shows which roles have access to which sections of the report.</span></span> <span data-ttu-id="9f3d9-191">未在下表 (组织内部的其他角色) 可能无法运行该工具，或者他们可能会运行该工具，并且对最终报告中的信息具有有限的访问权限。</span><span class="sxs-lookup"><span data-stu-id="9f3d9-191">Other roles within your organization (not listed in the table below) may not be able to run the tool, or they may run the tool and have limited access to information in the final report.</span></span>

<span data-ttu-id="9f3d9-192">![MCCA - 角色](../media/compliance-manager-mcca-roles.png "MCCA 角色")</span><span class="sxs-lookup"><span data-stu-id="9f3d9-192">![MCCA - roles](../media/compliance-manager-mcca-roles.png "MCCA roles")</span></span>

<span data-ttu-id="9f3d9-193">例外情况如下：</span><span class="sxs-lookup"><span data-stu-id="9f3d9-193">Exceptions:</span></span>
...
## <a name="resources"></a><span data-ttu-id="9f3d9-222">资源</span><span class="sxs-lookup"><span data-stu-id="9f3d9-222">Resources</span></span>
