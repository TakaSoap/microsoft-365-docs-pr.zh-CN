...
1. 在开始导出的搜索的详细信息窗格中的“将结果导出至计算机”下，单击“下载导出结果”。
    ...
    - 是否导出索引或未编制索引。 未编制索引的项目是具有可识别格式、已加密或因其他原因而未编制索引的项目。 有关详细信息，请参阅[Unindexed items in Content Search](partially-indexed-items-in-content-search.md)。
  
    - 是否将下载 SharePoint 文档的版本。
  
    - 导出准备过程的状态。 即使数据准备未完成，你也可以开始下载搜索结果。
  
2. 在“导出密钥”下，单击“复制到剪贴板”。 您可以在步骤5中使用此项下载搜索结果。
...
5. 在 " **电子数据展示导出工具** " 中，执行以下操作：

   ![电子数据展示导出工具](../media/eDiscoveryExportTool.png)

   1. 将您在步骤2中复制的导出密钥粘贴在相应的框中。
