...
4. 连接器使用[步骤 3](#step-3-map-users-and-complete-the-connector-setup)中所述的自动用户映射过程的*电子邮件*属性的值，将已转换的邮件项导入到特定用户的邮箱中。 在此过程中，将在用户邮箱中创建名为 " **.eml**" 的 "收件箱" 文件夹中的子文件夹，并将 .eml 项目导入该文件夹。 连接器通过使用 *电子邮件* 属性的值来实现此功能。 每封邮件都包含此属性，该属性由内容项目的每个参与者的电子邮件地址填充。

## <a name="before-you-begin"></a>准备工作

- 通过接受您的 .EML 连接器的条款和条件创建 Globanet Merge1 帐户。 若要执行此操作，请联系 [Globanet 客户支持](https://globanet.com/contact-us)。 当您在步骤1中创建连接器时，需要登录到此帐户。
...
2. 单击 " **连接器** " 选项卡，然后选择 " **.eml** 连接器" 以显示弹出页面，其中包含有关连接器的属性和信息。
