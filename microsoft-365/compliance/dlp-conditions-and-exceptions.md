...
|发件人域为|condition： *SenderDomainIs* <br/> 例外 *：ExceptIfSenderDomainIs*|DomainName|发件人的电子邮件地址域与指定值匹配的邮件。 如果需要查找包含指定域 (例如域) 的任何子域的发件人域，请使用与 **(** *FromAddressMatchesPatterns*) 条件相匹配的发件人地址，并使用语法"' \. domain \. com$"指定域。|
