...
需要查找用户是否查看了特定文档或清除了其邮箱中的项目？ 高级电子数据展示现在与安全 & 合规中心中现有的审核日志搜索工具集成在一起。 使用此嵌入的体验，您可以使用高级电子数据展示保管人管理工具来促进您的调查，并在您的案例中轻松访问和搜索保管人的活动。
...
审核日志搜索的结果将显示在 "保管人审核日志" 页上的 "结果" 下。 最多5000（最新）事件以150个事件为增量显示。 若要显示更多事件，可以使用 "结果" 窗格中的滚动条，也可以按 Shift + End 显示接下来的150事件。
...
## <a name="step-3-filter-the-search-results"></a>步骤3：筛选搜索结果
