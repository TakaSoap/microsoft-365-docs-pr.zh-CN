...
ms.custom:
- seo-marvel-apr2020
description: 了解适用于 Advanced eDiscovery 解决方案的情况限制、索引Microsoft 365。
ms.openlocfilehash: 04b0f98286693ef14019b30ab9c8d3a592484d92
ms.sourcegitcommit: 46456ca009c9d50622e57e24269be74986184654
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/22/2022
ms.locfileid: "63712786"
---
...
| 限制说明 | 限制 |
|:-----|:-----|
|组织的最大保留策略数。 此限制包括核心电子数据展示和事例中的保留策略Advanced eDiscovery总数。 <br/> |10，<sup>0003</sup>  <br/> |
...
本节中所述的限制与使用"搜索"选项卡上的搜索工具收集案件集数据相关。 有关详细信息，请参阅在事件[记录中收集Advanced eDiscovery](collecting-data-for-ediscovery.md)。
...
|网站和网站搜索查询的最大字符SharePoint OneDrive for Business包括 (运算符和) 。 |10,000<br>4，000（带通配符<sup>5）</sup>|
...
|预览页面上显示的用于搜索SharePoint OneDrive for Business网站的最大项目数。 显示最新项目。 |200|
|可SharePoint OneDrive for Business搜索结果的最大网站数。 如果包含与搜索查询匹配的项目的网站超过 200 个，则仅具有最多结果的前 200 个网站可供预览。|200|
...
|可以在草稿集合的示例页上查看的项目的最大大小。|10，000，000 字节 (大约 9.5 MB) |
