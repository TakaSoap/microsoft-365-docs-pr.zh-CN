...
-   **隐私事件：** 涉及个人数据的安全事件子类型。处理过程与安全事件相同。
...
在声明 CRSI 后，通知流程会在仍考虑快速行动的安全风险时尽可能快地发生。通常，起草通知的流程会在事件调查进行中发生。我们一旦声明了泄露，就会立即送达客户通知，以下情况*除外*：
