...
若要了解有关创建自定义 trainable 分类器的整体工作流的详细信息，请参阅 [创建 customer trainable 类元的过程流](classifier-learn-about.md#process-flow-for-creating-custom-classifiers)
...
```
例如：`Add-ComplianceCaseMember -Case "Financial Contract Classifier" -Member johnevans@contoso.com`
