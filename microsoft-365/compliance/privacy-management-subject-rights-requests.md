---
title: '在 Microsoft 隐私管理预览版中管理 (权限) '
f1.keywords:
- CSH
...
**若要** 更改创建主题权限请求时生成 Teams 网站的默认行为，请选择主题权限请求页面右上角的 **设置** 齿轮，然后选择"Teams协作"以修改设置。
...
Microsoft Power Automate是一种工作流服务，可跨应用程序和服务自动执行操作。 启用隐私Power Automate流时，可以自动执行事例和用户的重要任务。 若要了解有关网站Power Automate，请访问其[文档网站](/power-automate/getting-started)。

具有包含Microsoft 365管理的客户无需其他 Power Automate 许可证来使用建议的隐私管理Power Automate模板。 可以自定义这些模板以支持您的组织并涵盖核心隐私管理方案。 如果您选择在这些模板中Power Automate高级 Power Automate 功能，使用 Microsoft 365 合规性连接器创建自定义模板，或使用 Microsoft 365 中其他合规性领域的 Power Automate 模板，您可能需要更多 Power Automate 许可证。
...
使用 Unicode 编码 (创建 XML 格式的规则) 包，如以下示例代码所示。 您可以复制、修改和使用此示例。
