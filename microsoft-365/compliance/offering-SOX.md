...
当您将应用程序和数据迁移到 Microsoft 云服务中所涉及的 Microsoft 云服务时，您可以基于 Microsoft 保留的 attestations 和认证进行构建。 独立审核员报告证明 Microsoft 实施的控制措施的有效性，以帮助维护数据的安全性和隐私。 不过，你完全负责确保你的组织遵守所有适用的法律和法规。
