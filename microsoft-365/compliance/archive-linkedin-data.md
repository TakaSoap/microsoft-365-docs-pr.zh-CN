...
- LinkedIn 连接器在一天中总共可以导入 200，000 个项目。 如果一天中 LinkedIn 项目超过 200，000 个，则这些项目不会导入到 Microsoft 365。

## <a name="create-a-linkedin-connector"></a>创建 LinkedIn 连接器

1. 转到 <https://compliance.microsoft.com> "LinkedIn **Company"页**，  >  **然后单击"数据连接器"。**
...
7. 在"**选择** 存储位置"页上，在框中单击，选择将 LinkedIn 项目导入到的 Microsoft 365 邮箱的电子邮件地址，然后单击"下一 **步"。** 项目将导入到此邮箱中的收件箱文件夹。
