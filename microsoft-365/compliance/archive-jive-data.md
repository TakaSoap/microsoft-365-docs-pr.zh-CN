...
ms.locfileid: "53886920"
---
# <a name="set-up-a-connector-to-archive-jive-data"></a>设置连接器以存档 Jive 数据

使用 Microsoft 365 合规中心 中的一个 Microsoft 365 合规中心 将数据从协作平台导入并存档到组织的用户Microsoft 365邮箱。 该[连接器配置为定期](https://globanet.com/jive/)捕获第三方数据源 (中的项目，) 然后将这些项目导入Microsoft 365。 连接器将用户 Jive 帐户中的电子邮件、聊天和附件等内容转换为电子邮件格式，然后将这些项目导入 Microsoft 365 中的用户邮箱。
