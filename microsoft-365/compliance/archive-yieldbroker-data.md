...
使用 Microsoft 365 合规中心中的一个 Microsoft 365 连接器，将数据从 Yieldbroker 导入并存档到 Microsoft 365 组织的用户邮箱。 Microsoft 为您提供了一个 [Yieldbroker](https://globanet.com/yieldbroker/) 连接器，该连接器配置为捕获第三方数据源中的项目，并导入到 Microsoft 365。 连接器将 Yieldbroker 中的内容转换为电子邮件格式，然后将这些项目导入到 Microsoft 365 中的用户邮箱。
...
3. 在 Microsoft 365 合规中心内创建的 Yieldbroker 连接器每天连接到 Microsoft Merge1 网站，将邮件传输至 Microsoft 云中的安全 Azure 存储位置。
