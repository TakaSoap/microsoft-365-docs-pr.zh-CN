...
ms.locfileid: "37075632"
---
# <a name="preserve-bcc-and-expanded-distribution-group-recipients-for-ediscovery"></a>为电子数据展示保存密件抄送和展开的通讯组收件人
  
就地保留、诉讼保留和[Office 365 保留策略](http://go.microsoft.com/fwlink/?LinkID=827811)（在安全 & 合规性中心中创建）使您能够保留邮箱内容，以满足法规遵从性和电子数据展示要求。 默认情况下，所有邮件中均包含直接在邮件"收件人"和"抄送"字段中输入的收件人信息，但您的组织可能需要能够搜索和重现邮件收件人的详细信息。 具体包括： 
