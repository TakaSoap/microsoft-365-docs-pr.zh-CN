...
|展开的通讯组收件人  <br/> |发件人邮箱中的邮件属性。  <br/> |否。 将邮箱置于就地保留或诉讼保留中，或分配到 Microsoft 365 保留策略后，将存储展开的通讯组收件人信息。  <br/> |合规部主管  <br/> |
...
A. 在发送邮件时扩展组成员身份。 展开的通讯组成员列表存储在发件人邮箱中的原始邮件中。 发件人的邮箱必须处于就地保留、诉讼保留或分配给 Microsoft 365 保留策略。
