...
使用 Microsoft 365 合规中心中的一个 Microsoft 365 连接器，将数据从 Reuters FX 平台导入并存档到 Microsoft 365 组织的用户邮箱。 对于配置为定期捕获第三方数据源 (中的项目，) 然后将这些项目导入到 Microsoft 365 的 [Reuters FX](https://globanet.com/reuters-fx/) 连接器。 连接器将货币和汇率从 Reuters FX 帐户转换为电子邮件格式，然后将这些项目导入到 Microsoft 365 中的用户邮箱。
...
3. 在 Microsoft 365 合规中心创建的 Reuters FX 连接器每天连接到一个 Microsoft Merge1 网站，将内容传输至 Microsoft 云中的安全 Azure 存储位置。
