...
5. 单击 **“保存”**。
    ...
    > [!NOTE]
    > 每个模板只能分配一组策略。 如果您看到一个错误，指出此模板已分配策略，请选择左侧导航栏\>中的 "**取消** \> **分配到网站集**"。选择一个网站集以查看和管理已分配的策略集。 
...
1. 在安全&amp;合规性中心\>中，在左侧导航\>中选择 "**删除** \> **管理 SharePoint Online 和 OneDrive for business 的文档删除策略**" 中的 "**数据管理** \> **保留**"。 此时，系统会在新的浏览器标签页中打开“文档删除策略中心”。
