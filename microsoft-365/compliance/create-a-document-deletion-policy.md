...
1. 在 Office 365Security &amp; 合规性中心中，导航到 "**数据管理** \> **保留**"。 在 "**删除**" 下，单击 "**管理 SharePoint Online 和 OneDrive for business 的文档删除策略**"。 此时，系统会在新的浏览器标签页中打开“文档删除策略中心”。
    
    当您第一次从安全 &amp; 合规中心导航到文档删除策略中心时，将自动为您创建策略中心。 或者，您可以通过[创建网站集](https://go.microsoft.com/fwlink/p/?LinkID=404342)并在 "**企业**" 选项卡上选择 "**合规性策略中心**" 来手动创建策略中心。 
...
6. 输入名称，然后选择以下选项：
  ...
  - 选择允许此规则永久删除文档还是将删除的文档放入回收站。 在您将项目从站点中永久删除之前，回收站提供了第二道安全屏障。 有关回收站的详细信息，请参阅[清空回收站或还原文件](https://go.microsoft.com/fwlink/p/?LinkID=404348)。
...
请务必了解为文档删除策略指定的时间段是指自创建或修改文档以来的时间，而不是分配该策略以来的时间。 当您首次分配策略时，将对网站中的所有文件进行计算，满足删除条件的文件将被删除。 这适用于所有现有文件，而不仅仅针对分配策略后新建的文件。
  
1. 在安全 &amp; 合规性中心中，导航到 "**数据管理** \> **保留**"。 在 "**删除**" 下，单击 "**管理 SharePoint Online 和 OneDrive for business 的文档删除策略**"。 此时，系统会在新的浏览器标签页中打开“文档删除策略中心”。
...
5. 单击“**保存**”。
    ...
    > [!NOTE]
    > 每个模板只能分配一组策略。 如果您看到一个错误，指出此模板已分配策略，请选择左侧导航栏中的 "**取消** \> **分配到网站集**" \> 。选择一个网站集以查看和管理已分配的策略集。 
...
1. 在安全 &amp; 合规性中心中，导航到 "**数据管理** \> **保留**"。 在 "**删除**" 下，选择 "**管理 SharePoint Online 和 OneDrive for business 的文档删除策略**"。 此时，系统会在新的浏览器标签页中打开“文档删除策略中心”。
...
1. 在安全 &amp; 合规性中心中，在 \> 左侧导航中选择**Data management** \> **Retention** \> "**删除** \> **管理 SharePoint Online 和 OneDrive for business 的文档删除策略**" 中的 "数据管理保留"。 此时，系统会在新的浏览器标签页中打开“文档删除策略中心”。
