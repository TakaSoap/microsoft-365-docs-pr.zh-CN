...
下表标识了正在修改其严重性分类的默认警报策略。 我们正在更改这些警报策略严重性分类，以更好地适应你组织的潜在风险和影响，并帮助安全团队确定通过这些策略生成的警报的优先顺序。
...
| **来自市场活动的电子邮件已发送，随后删除** （新） | 警报将于 2021 年 4 月 30 开始触发|
| **恶意电子邮件已送达，稍后** （新） | 警报将于 2021 年 4 月 30 开始触发|
| **送达之后删除的包含钓鱼 URL 的电子邮件** （现有，将删除）| 将于 2021 年 4 月 30 日删除警报策略。 请参阅 [为这些更改做好准备，请执行哪些](#what-you-need-to-do-to-prepare-for-these-changes) 部分。|
| **送达邮件后，删除包含恶意软件的电子邮件** （现有，将删除） | 将于 2021 年 4 月 30 日删除警报策略。 请参阅 [为这些更改做好准备，请执行哪些](#what-you-need-to-do-to-prepare-for-these-changes) 部分。 |
|||

通知严重性更改将于 2021 年 4 月 30 之前推出给所有组织。

## <a name="how-this-will-affect-your-organization"></a>这将如何影响你的组织

新的警报将开始触发，并触发组织中以上所列日期的 AIR 调查。 为降低对正在删除的两个警报操作的安全组织的影响，会看到现有警报策略 *和* 在 2021 年 4 月 5 日至 2021 年 4 月 30 日之间通过新警报策略触发的警报。 这是为安全团队提供处理所需更改的时间。 为了帮助安全团队在此期间提高警报量，现有警报和新警报将关联到相同的 AIR 调查，并关联到同一事件。 更具体地说，这包括以下针对警报、AIR 调查和事件的行为：
...
- 不执行任何操作。 我们将在 2021 年 4 月 30 日禁用现有警报策略。

**如果已操作这些警报：**

- 自 2021 年 4 月 30 日起，在删除现有警报策略后，开始使用新的警报作为工作流的一部分。 如果票证系统中有自定义逻辑、用于接收警报电子邮件通知的安全邮箱或依赖于警报名称或警报策略 ID （CorrelationId） 的 SIEM 解决方案，则需要修改逻辑以适应变化。
...
- 完成修改后，可禁用现有警报策略，减少组织的警报量：
  ...
  或者，在 2021 年 4 月 30 日删除之前，你可以保留启用这些警报策略。
