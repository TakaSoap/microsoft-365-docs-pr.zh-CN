...
ms.locfileid: "60190805"
---
# <a name="investigate-insider-risk-management-activities"></a>调查内部风险管理活动

调查有风险的用户活动是最大程度地降低组织内部风险的重要第一步。 这些风险可能是从内部风险管理策略生成警报的活动，或者是从策略检测到的活动生成风险，但不立即为用户创建内部风险管理警报。 可以使用"用户活动报告"或"警报"仪表板 (**预览**) 调查这些 **类型的活动**。
