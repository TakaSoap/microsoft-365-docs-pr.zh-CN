...
随着内部风险管理警报的不断消失，对于大多数组织来说，其用于最大限度地降低风险活动的价值。 相反，活动案例 (警报、见解) 活动对组织始终有价值，不应具有自动过期日期。 这包括与活动案例关联的任何用户的所有未来处于活动状态的警报和项目。
...
| 已解决 (项目及其关联的)  | 从案例解决起 120 天，然后自动删除 |
| 最大活动案例数 | 100 |
