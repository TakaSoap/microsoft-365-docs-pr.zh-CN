...
在2016年10月21日，美国国防部（DoD）签发了其最终规则修正了防御联邦收购法规的补充（DFARS），并对其信息的防御承包商施加保护和网络事件报告义务系统处理、存储或传输涉及的防御信息（CDI）。  
  
最终的 DFARS 子句252.204 –7012（受保护的防御信息和网络事件报告）指定的安全措施包括网络事件报告要求以及云服务提供商的其他注意事项。 根据 DFARS 252.204 –7012，所有 DoD 承包商和国防工业基座都必须遵守适用的良好安全 DFARS 要求，但不晚于2017年12月31日。 "
...
是的，第三方评估组织已证明 Azure 政府和 Office 365 美国政府防护云服务产品符合 DFARS 子句252.204 –7012的适用要求（保护未分类的受控制技术信息）。

**受控制的未分类信息（CUI）与受覆盖的防御信息（CDI）之间的关系是什么？**

CUI 是需要根据法律、法规或政府范围内的策略来保护或传播控件的信息。 [CUI 注册表](https://www.archives.gov/cui/registry/category-list.html)标识已批准的 CUI 类别和子类别。

CDI 是控制的技术信息或其他信息（如 CUI 注册表中所述），它需要保护或传播控件，也可以是：
