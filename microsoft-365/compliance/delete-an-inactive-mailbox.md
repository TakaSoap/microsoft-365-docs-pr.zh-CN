...
非活动邮箱用于在之前的员工离开公司之后保留其电子邮件。 如果您不再需要保留非活动邮箱的内容，可以通过删除保留永久性地删除非活动邮箱。 此外，还可以对非活动邮箱设置多个保留。 例如，非活动邮箱上可以设置诉讼保留以及一个或多个就地保留。 此外，在 Office 365 或 Microsoft 365 中的安全性和合规性中心中创建的保留策略可能会应用于非活动邮箱。 您必须删除非活动邮箱中的所有保留策略和保留策略才能将其删除。 删除保留和保留策略后，非活动邮箱将标记为删除，并在处理之后永久删除。
...
- 如果从非活动邮箱删除保留策略，并且邮箱的软删除邮箱保留期已过期，则邮箱将被永久删除。 在此邮箱删除后，您将无法恢复。 在删除保留设置之前，请确保您不再需要此邮箱中的内容。 如果您想重新激活非活动邮箱，则可以恢复它。 有关详细信息，请参阅[恢复 Office 365 中的非活动邮箱](recover-an-inactive-mailbox.md)。
...
如前所述，诉讼保留、就地保留或保留策略可能放置在非活动邮箱上。 第一步是识别非活动邮箱上设置的保留。
...
- **如果删除非活动邮箱的保留设置，后面会怎么样？** 系统会将此邮箱与其他软删除邮箱视为一类，并在 30 天软删除邮箱保留期过期后将其标记为永久删除。 此保留期的起始日以该邮箱初次变为非活动状态的日期为准。 此日期称为软删除日期，即在删除相应用户帐户的日期或使用**删除邮箱**Cmdlet 删除 Exchange Online 邮箱时。 软删除日期不是您删除保留的日期。 
