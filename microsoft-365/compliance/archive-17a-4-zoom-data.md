...
缩放数据存储在用户邮箱中后，可以应用 Microsoft 365 合规性功能，如诉讼保留、电子数据展示、保留策略和保留标签以及通信合规性。 使用缩放连接器导入和存档数据Microsoft 365可帮助组织遵守政府法规策略。
...
第一步是访问数据连接器页，并Microsoft 365 合规中心缩放数据创建 17a-4 连接器。
