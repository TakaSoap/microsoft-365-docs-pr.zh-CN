...
接下来，在 Office 365 中配置特权访问Office 365。 特权访问管理允许在 Office 365 中对特权管理任务精细的访问控制。 它可以帮助保护组织免受可能使用现有特权管理员帐户（长期访问敏感数据或访问关键配置设置）的泄露。
...
Microsoft 建议通过设备访问控制SharePoint敏感和高度管控内容保护网站中的内容。 有关详细信息，请参阅[用于保护网站和文件SharePoint策略建议](../security/defender-365-security/sharepoint-file-access-policies.md)。
