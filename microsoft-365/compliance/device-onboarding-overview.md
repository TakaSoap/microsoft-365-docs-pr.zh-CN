...
- [终结点数据丢失防护 (DLP)](./endpoint-dlp-learn-about.md)
...
终结点 DLP 允许监视 Windows 10 或 Windows 11 设备，并检测何时使用和共享敏感项目。 这为你提供了所需的可见性和控制力，以确保正确使用和保护它们，并帮助防止可能危害它们的危险行为。 有关 Microsoft 所有 DLP 产品/服务的更多信息，请参阅[数据丢失防护概述](dlp-learn-about-dlp.md)。 若要了解有关终结点 DLP 的详细信息，请参阅 [了解终结点数据丢失防护](endpoint-dlp-learn-about.md)。
...
2. 打开合规中心设置页面，然后选择“**打开 Windows 设备监视**”。
