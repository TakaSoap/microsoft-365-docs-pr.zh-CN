...
## <a name="communication-compliance-alerts-in-microsoft-365-audit"></a>Microsoft 365 审核中的通信合规性警报
...
> [!NOTE]
> 目前，在 Microsoft 365 审核中记录策略匹配的时间与在通信合规性中调查策略匹配项的时间之间可能最多存在 24 小时延迟。
