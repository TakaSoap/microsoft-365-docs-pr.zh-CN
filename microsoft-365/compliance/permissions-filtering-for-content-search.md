...
| 参数 | 说明 |
|:-----|:-----|
| _操作_ <br/> | _Action_ 参数指定应用筛选器的搜索操作的类型。 可能的内容搜索操作包括：  <br/><br/> **导出：** 导出搜索结果时应用筛选器。  <br/> **预览：** 预览搜索结果时应用筛选器。  <br/> **清除：** 清除搜索结果时应用筛选器。  <br/> **搜索：** 运行搜索时应用筛选器。  <br/> **全部：** 筛选器将应用于所有搜索操作。  <br/> |
...
- **搜索权限筛选器是否计入搜索查询字符限制？** 能。 搜索权限筛选器根据搜索查询的字符限制计数。 有关详细信息，请参阅 Advanced eDiscovery 中的[限制](limits-ediscovery20.md)。
