...
>注意：仅全局（公共）云中的租户支持灵敏度标签。 其他云（如[国家云](https://docs.microsoft.com/azure/active-directory/develop/authentication-national-cloud)）中的租户不支持敏感度标签。
...
- [敏感度标签在 Office 应用中的工作方式](sensitivity-labels-office-apps.md)
