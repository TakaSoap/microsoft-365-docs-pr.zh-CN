...
22. 一旦发布分类器，便可用作[符合灵敏度标签的 Office autolabeling](apply-sensitivity-label-automatically.md)中的条件，并根据条件和[通信合规性](communication-compliance.md)[自动应用保留标签策略](apply-retention-labels-automatically.md#configuring-conditions-for-auto-apply-retention-labels)。
