...
本示例中，组织在其基于 Windows Server 的文件服务器上使用 FCI;具体来说，他们使用的是名为"个人身份信息"的 FCI 分类属性，可能的值为 **High**、**Moderate**、**Low**、**Public** 和 **Not PII**。 现在，他们希望在 OFFICE 365 中的 DLP 策略中使用其现有 FCI Office 365。
