...
在更严重的情况下，可能需要与组织的其他审阅者或服务共享内部风险管理案例信息。 内部风险管理与其他合规性Microsoft 365紧密集成，以帮助你进行端到端风险解决。
...
## <a name="intentional-or-unintentional-security-policy-violations-preview"></a>预览版中有意或无意 (安全策略) 
