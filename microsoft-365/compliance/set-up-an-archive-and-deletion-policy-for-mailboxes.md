...
8. 保持安全性 & 合规性中心处于打开状态。 你将在下一步中使用它。
...
## <a name="optional-step-5-run-the-managed-folder-assistant-to-apply-the-new-settings"></a>Optional步骤5：运行托管文件夹助理以应用新设置
...
## <a name="optional-step-6-make-the-new-retention-policy-the-default-for-your-organization"></a>Optional步骤6：将新的保留策略设为您的组织的默认策略
