...
ms.locfileid: "61370736"
---
# <a name="build-and-manage-assessments-in-compliance-manager"></a>在合规性管理器中生成和管理评估

**本文内容：** 了解如何通过创建和管理评估来为组织自定义合规性 **管理器**。 本文将引导你完成如何创建评估、如何将评估组织到组中、使用控件 **、接受更新** 以及导出 **评估报告**。
...
选择 **"更新的模板**"链接将下载一Excel文件，该文件包含挂起更新的模板版本的控件数据。 选择 **"当前模板** "链接将下载现有模板的文件，而不进行更改。
