...
---
# <a name="set-ignore-text-option-for-analyze-in-advanced-ediscovery-classic"></a>设置用于在高级电子数据展示 (经典) 中分析的 "忽略文本" 选项

> [!NOTE]
> 若要使用高级电子数据展示，组织必须订阅随附高级合规性加载项的 Office 365 E3，或订阅 E5。如果没有此计划，但又要试用高级电子数据展示，可以[注册 Office 365 企业版 E5 试用版](https://go.microsoft.com/fwlink/p/?LinkID=698279)。 
  
"忽略文本" 功能可应用于以下所有高级电子数据展示模块或以下任一高级电子数据展示模块：分析 (临近的重复、电子邮件线索、主题) 和相关性。 已忽略的文本不会出现在相关性中显示的文件中，并且分析/计算将丢弃忽略的文本。
...
例如，如果文本内容为： "DAVE 王俊/小红 CAROL 前夕"，以下是忽略文本项和这些项生成结果的示例：

|**忽略文本输入** <br/> |**结果** <br/> |
|:-----|:-----|
|"小红"，"BOB CAROL"  <br/> |"DAVE 前夕"  <br/> |
|"小红"，"BOB ALICE CAROL"  <br/> |"DAVE BOB CAROL 前夕"  <br/> |
...
- 若要删除在电子邮件线程结束时自动插入的免责声明和法律声明，请执行以下操作：
    ...
    **此邮件包含 ( 的机密信息。 |\s) \* 如果需要验证，请请求硬复制版本**
    
- 若要删除免责声明 (包含特殊字符) ： 
    
    例如，下面的文本 (x 的) 中所示的免责声明： 
...
- 正则表达式规则：
  ...
  - 除字母 (s) 、"_" 和 "-" 以外的任何不属于字母表的字符都必须以 "" 开头 \" 。
