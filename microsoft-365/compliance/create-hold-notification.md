...
- MET150
ms.assetid: ''
description: 在案例内使用通信Advanced eDiscovery发送、收集并跟踪合法保留通知。
...
4. 指定 **活动所需的** () 。 此字段指定向无响应保管人发送的提醒数。 例如，如果将提醒数设置为 3，则保管人最多可收到三次提醒。 保管人确认保留通知后，将不再向该用户发送提醒。
