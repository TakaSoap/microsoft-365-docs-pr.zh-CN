...
4. 指定要向保管人提供的内容或其他 (要求) 。 在步骤 2 中定义的门户内容将添加到发布通知的末尾。
...
4. 指定要向保管人提供的内容或其他 (要求) 。 步骤 2 中定义的门户内容将添加到重新发布通知的末尾。
...
6. 指定要向保管人提供的内容或其他 (要求) 。 步骤 2 中定义的门户内容将添加到提醒通知的末尾。
...
4. 指定 **升级所需的** (数) 。 此字段指定向无响应保管人发送的升级数。 例如，如果将升级次数设置为 3，则最多向保管人及其经理发送升级通知三次。 保管人确认保留通知后，将不再发送升级。

5. 指定 **通知** 主题 (要求) 。

6. 指定要向保管人提供的内容或其他 (要求) 。 步骤 2 中定义的门户内容将添加到升级通知的末尾。
