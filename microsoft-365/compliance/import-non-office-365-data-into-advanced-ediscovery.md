...
---
# <a name="import-non-office-365-content-for-advanced-ediscovery-classic-analysis"></a>导入非 Office 365 内容以实现高级电子数据展示（经典）分析
...
1. 作为电子数据展示管理器或电子数据展示管理员，打开**电子数据展示**，并打开将向其上载非 Office 365 数据的大小写。 如果您需要创建一个事例，请参阅[在 Office 365 安全&amp;合规中心中管理电子数据展示事例](ediscovery-cases.md)
