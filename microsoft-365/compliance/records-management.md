...
- **将内容标记为记录**。 创建并发布将内容标记为[记录](records.md)的保留标签，该类标签随后可由最终用户应用，或通过标识敏感信息、关键字或内容类型[自动应用](labels.md#applying-a-retention-label-automatically-based-on-conditions)。
