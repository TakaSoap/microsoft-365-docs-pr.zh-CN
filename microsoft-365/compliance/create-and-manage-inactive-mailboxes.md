...
## <a name="preparations-before-creating-an-inactive-mailbox"></a>创建非活动邮箱前的准备工作
...
- 删除了相应的用户帐户后，与已删除的 Exchange Online 邮箱相关联的许可证将可用。 然后，您可以[将这些许可证分配给其他用户](../admin/manage/assign-licenses-to-users.md)。
