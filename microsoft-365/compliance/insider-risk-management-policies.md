...
在许多组织中，用户有权在其设备上安装软件或修改设备设置以帮助他们的任务。 无论是无意还是恶意意向，用户都可以安装恶意软件或禁用有助于保护其设备或网络资源上的信息的重要安全功能。 此策略模板使用来自 Microsoft Defender for Endpoint 的安全警报开始评分这些活动，并将检测和警报集中到此风险区域。 使用此模板可在应用程序可能有可能成为内幕风险指标的安全策略违规历史记录时，提供适用于安全策略冲突的见解。

您需要在组织中配置 Microsoft Defender for Endpoint，并在 "Defender 安全中心" 中启用 "用于终结点的 Defender for 内幕风险管理集成" 以导入安全冲突警报。 有关为内部人员风险管理集成配置 Defender for Endpoint 的详细信息，请参阅 [在 Defender For endpoint 中配置高级功能](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/advanced-features#share-endpoint-alerts-with-microsoft-compliance-center)。

### <a name="security-policy-violations-by-departing-users-preview"></a>通过 (preview 中的去声用户进行安全策略违反) 

如果传出的用户不是肯定的或负的术语，则可能会对安全策略违规产生较高的风险。 为了帮助防止对传出用户的意外或恶意安全违规，此策略模板使用适用于 Endpoint 警报的 Defender 来提供与安全相关的活动的见解。 这些活动包括安装恶意软件或其他可能有害的应用程序以及在其设备上禁用安全功能的用户。 在用户将放弃或终止日期作为触发事件从 Microsoft 365 HR 连接器导入后，将激活策略指示器。
...
防止组织中用户的安全冲突可能取决于组织的位置、敏感信息的访问级别或风险历史记录。 由于优先级用户可能会对组织的关键领域产生 outsized 影响，因此此策略模板会对这些指示器启动评分，并使用 Microsoft Defender for Endpoint 警报为这些用户提供与安全相关的活动的见解。 其中可能包括安装恶意软件或其他可能有害的应用程序以及在其设备上禁用安全功能的优先用户。 优先级用户是在 "内幕风险管理设置" 区域中配置的 "优先级用户组" 中定义的。
...
你还需要在组织中配置 Microsoft Defender for Endpoint，并在 Defender Security Center 中为内部人员风险管理集成启用 Defender for Endpoint，以导入安全冲突警报。 有关为内部人员风险管理集成配置 Defender for Endpoint 的详细信息，请参阅 [在 Defender For endpoint 中配置高级功能](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/advanced-features#share-endpoint-alerts-with-microsoft-compliance-center)。
...
| 一般安全策略冲突 | Microsoft Defender for Endpoint 检测到的安全控制或不需要的软件的防御性规避 | 用于终结点订阅的活动 Microsoft Defender <br><br> Microsoft Defender for Endpoint integration 与 Microsoft 365 合规性中心配置 |
| 通过去声用户违反安全策略 | 来自 HR 连接器的辞职或终止日期指示器 | 为终止和放弃日期指示器配置的 Microsoft 365 HR 连接器 <br><br> 用于终结点订阅的活动 Microsoft Defender <br><br> Microsoft Defender for Endpoint integration 与 Microsoft 365 合规性中心配置 |
| 优先级用户违反安全策略 | Microsoft Defender for Endpoint 检测到的安全控制或不需要的软件的防御性规避 | 用于终结点订阅的活动 Microsoft Defender <br><br> Microsoft Defender for Endpoint integration 与 Microsoft 365 合规性中心配置 <br><br> 在内部人员风险设置中配置的优先级用户组 |
| 因不满用户而违反安全策略 | HR 连接器的性能改进、性能差或作业级更改指示器 | 为 disgruntlement 指标配置的 Microsoft 365 HR 连接器 <br><br> 用于终结点订阅的活动 Microsoft Defender <br><br> Microsoft Defender for Endpoint integration 与 Microsoft 365 合规性中心配置 |
