...
您可以导出Excel模板数据的所有模板文件。 你将需要导出模板才能修改它，因为这将是你在修改过程中编辑Excel[上传的文件。](compliance-manager-templates-modify.md) 如果要在构造新的自定义模板时使用模板的数据，还可以导出模板作为参考。
