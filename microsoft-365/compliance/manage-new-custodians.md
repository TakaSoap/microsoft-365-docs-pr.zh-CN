...
高级电子数据展示事例的 "**源**" 选项卡上的保管人页面包含已添加到该事例的所有保管人的列表。 向事例添加保管人后，会自动从 Azure Active Directory 中收集每个保管人的详细信息，这些信息可在高级电子数据展示中查看。
...
3. 在**保管人**页面上，从列表中选择一个管理员并单击弹出页面上的 "**编辑**"。
...
3. 在**保管人**页面上，选择其数据必须为 "编制索引" 的保管人。
