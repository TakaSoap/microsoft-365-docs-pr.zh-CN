...
- 在使用网络上载创建导入作业之后，安全 & 合规中心中的 "导入" 页上的导入作业的状态设置为 "**正在进行分析**"，这意味着 Microsoft 365 正在分析您上载的 PST 文件中的数据。 单击**Refresh**!["刷新](../media/165fb3ad-38a8-4dd9-9e76-296aefd96334.png)刷新" 以更新导入作业的状态。 
...
6. 在 "**导入 PST 文件**" 页**Refresh** ![上，](../media/165fb3ad-38a8-4dd9-9e76-296aefd96334.png)单击 "刷新刷新"。 导入作业的状态将显示在 "**状态**" 列中。 
