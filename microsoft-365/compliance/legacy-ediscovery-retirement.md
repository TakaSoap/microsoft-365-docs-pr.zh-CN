...
description: In-Place电子数据展示和 In-Place 保留 (以及) 中的相应 PowerShell cmdlet Exchange Online 将在 2020 上半年停用。 同时Search-Mailbox v1.0 Advanced eDiscovery cmdlet 和 Advanced eDiscovery cmdlet 和 cmdlet。
ms.openlocfilehash: 18509476234494633b425765de07dfc163eaabc9
ms.sourcegitcommit: d4b867e37bf741528ded7fb289e4f6847228d2c5
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/06/2021
ms.locfileid: "60152990"
---
# <a name="retirement-of-legacy-ediscovery-tools"></a>旧版电子数据展示工具的停用

> [!IMPORTANT]
> 本文中介绍的旧版电子数据展示工具的功能已从 Microsoft 365服务中删除，或者仍可用，但不再受支持。 任何仍然可用的功能都可能会删除，无需另行通知。 如果仍在使用上述任一旧工具，请考虑迁移到 Microsoft 365 合规中心 中的电子数据展示工具或本文中所述的替代方法之一。

多年来，Microsoft 提供了电子数据展示工具，让你可以搜索、预览和导出电子邮件Exchange Online。 但是，这些工具不再提供在其他 Microsoft 365 服务（如 SharePoint Online 和 Microsoft 365 组）中搜索非 Exchange 内容的有效方式。 为解决这一问题，Microsoft 提供了其他电子数据展示工具，可帮助你搜索各种Microsoft 365内容。 我们一直在努力将最新且强大的电子数据展示功能纳入[Microsoft 365 合规中心。](https://compliance.microsoft.com) 这允许组织对跨多个服务（包括 Microsoft 365 服务）的内容的法律、内部和其他文档Exchange Online。
...
- [Office 365 高级电子数据展示 v1.0，](./overview-ediscovery-20.md)这是通过 Advanced eDiscovery 中的核心电子数据展示案例访问的第一个版本的 Microsoft 365 合规中心。 停用 Advanced eDiscovery v1.0 不会影响创建和管理核心电子数据展示事例的能力。
...
由于所有这些功能 (除了将搜索结果复制到发现邮箱) 以外，现在 Microsoft 365 合规中心 (中的内容搜索、电子数据展示和[Advanced eDiscovery](./microsoft-365-compliance-center.md)工具中都提供了改进的功能、可靠性和对各种 Microsoft 365 服务) 的支持，因此建议不要请尽快开始使用这些工具。 为了帮助你转换到这些其他电子数据展示工具，下表列出了可以使用的工具，而不是In-Place电子数据展示和In-Place保留。

### <a name="scope-of-affected-organizations"></a>受影响组织的范围

- Office 365 Microsoft 365 企业版 组织
...
<td>从"可恢复的项目"文件夹中还原项目</td>
  ...
  <td>您可以还原永久删除的项目 (也称为邮箱中的软删除) 项目，只要<i></i>项目的已删除邮件保留期尚未过期。 有关详细信息，请参阅"可<a href="/Exchange/security-and-compliance/recoverable-items-folder/recoverable-items-folder">恢复的项目"文件夹Exchange Online。</a></td>
</tr>
</tbody>
</table>
...
- 2020 年 7 月 1 日：你将无法使用 **New-MailboxSearch** 创建新的 In-Place 电子数据展示搜索和 In-Place 保留，但仍可以使用 cmdlet 运行、编辑和删除现有搜索和保留，但需要自行承担风险。 Microsoft 支持将不再为这些类型的搜索和保留提供帮助。
...
3. 如果看到"切换到Advanced eDiscovery"按钮，则单击此按钮将进入 1.0 版本的 Advanced eDiscovery，即将停用。 在核心电子数据展示中创建和管理事例的能力不会受到影响。 只有在 v1.0 Advanced eDiscovery中通过 (切换到 Advanced eDiscovery) 才能在 v1.0 中添加和分析案例数据。 
...
目前，我们建议您开始将电子数据展示工作流转换为新的Advanced eDiscovery功能。 如有必要，您可以通过导出内容并脱机Advanced eDiscovery 1.0 事例进行存档。 尽管你仍然能够在 2020 年 12 月 31 日之前访问 Advanced eDiscovery v1.0，但 Microsoft 支持不会在 2020 年 10 月 1 日之后提供支持。 有关详细信息，请参阅以下日程表。
