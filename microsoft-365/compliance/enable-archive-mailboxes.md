...
6. 单击“是”启用存档邮箱。
   ...
   可能需要一些时间才会创建存档邮箱。 创建后，所选用户的详细信息窗格中将显示 **存档邮箱：已启用**。 你可能必须单击“**刷新**”“![刷新图标。](../media/O365-MDM-Policy-RefreshIcon.gif)” 以更新详细信息窗格中的信息。
...
5. 单击“是”以禁用存档邮箱。
   ...
   可能需要一些时间才会禁用存档邮箱。 禁用后，所选用户的详细信息窗格中将显示 **存档邮箱：已禁用**。 你可能必须单击“**刷新**”“![刷新图标。](../media/O365-MDM-Policy-RefreshIcon.gif)” 以更新详细信息窗格中的信息。
