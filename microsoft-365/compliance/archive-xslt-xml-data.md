...
- 为 Microsoft 连接器创建 Globanet Merge1 帐户。 若要创建此帐户，请联系 [Globanet 客户支持](https://globanet.com/contact-us/)。 当您在步骤1中创建连接器时，您将登录到此帐户。
...
2. 单击 " **连接器** " 选项卡，然后选择 " **XSLT/XML** 连接器" 以显示弹出页面。 此页面包含有关连接器的属性和信息。
