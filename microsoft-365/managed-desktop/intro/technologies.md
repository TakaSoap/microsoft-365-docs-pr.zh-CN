...
建议 IT 管理员配置以下设置。 这些设置不作为自定义设置的一部分包含或Microsoft 托管桌面。
 ...
 |
 --- | ---
Windows Hello 企业版 | 你应该实现Windows Hello 企业应用，以将密码替换为适用于Microsoft 托管桌面身份验证。 有关详细信息，请参阅[Windows Hello 企业。](/windows/security/identity-protection/hello-for-business/hello-identity-verification)
...
Windows Defender 防火墙高级安全性 | 基于主机的设备的双向网络流量筛选，Windows Defender 防火墙阻止未经授权的网络流量流入或流出本地设备。 有关详细信息，请参阅Windows Defender 防火墙[高级安全。](/windows/security/threat-protection/windows-firewall/windows-firewall-with-advanced-security)
