...
3. 访问可能有设备条目的任何目录。 从所有目录中删除每台设备的条目，包括Windows Server Active Directory服务和Azure Active Directory。 请注意，删除可能需要几个小时才能完全完成。
...
| 活动文件 | 设备已传递给用户，并且他们已在租户中注册。 这还指示他们定期使用设备。 |
