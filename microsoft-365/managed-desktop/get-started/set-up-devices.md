...
1. 查看当前推荐的设备列表，通过筛选"Microsoft 托管桌面购买[Windows 10 专业版"站点中的设备](https://www.microsoft.com/windowsforbusiness/view-all-devices)。
...
6. 到达后，执行下列操作之一：
    ...
    - 与合作伙伴合作注册设备
7. [让用户准备好使用](get-started-devices.md)Microsoft 托管桌面设备
...
4. 验证成功后，执行下列操作之一：
    ...
    - 与合作伙伴合作注册设备
5. [让用户准备好使用](get-started-devices.md)Microsoft 托管桌面设备
