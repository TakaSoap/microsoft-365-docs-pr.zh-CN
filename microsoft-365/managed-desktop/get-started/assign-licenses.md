...
作为准备在 Microsoft 托管桌面中注册的一部分，你需要确保你已获取必要的许可证。 如果尚未获取许可证，请参阅有关许可证 [的详细信息，详细了解](../get-ready/prerequisites.md#more-about-licenses) 需要哪些许可证。


如果你的许可证全部排队，现在可以将它们分配给你的用户。 若要分配许可证，我们建议你利用 Azure Active Directory 的基于组 [的许可](/azure/active-directory/fundamentals/active-directory-licensing-whatis-azure-portal) 功能。
