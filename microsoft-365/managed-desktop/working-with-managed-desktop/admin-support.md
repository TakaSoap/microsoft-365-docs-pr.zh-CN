...
**严重性 B – 中等影响**|**中等业务影响**<p>你的企业具有中等损失或服务降级，但工作可能会以受损的方式合理继续。<p>**中等应用程序兼容性影响**<p>由于设备未响应或丢失关键功能，特定业务组不再高效工作。|初始：< 4 小时<br>更新：12 小时<br>在管理支持时段（从星期一到星期五 (24 小时) 。|选择"严重性 B"时，可确认该问题对服务损失和降级的业务具有中等影响，但解决方法可实现合理的（尽管临时）业务连续性。 <p>该问题需要紧急响应。 如果在提交支持请求时选择了全天支持，则承诺每天与 Microsoft 团队持续参与，直到解决方案。 否则，Microsoft 可能会自行决定将严重性降低为 C 级。如果你在提交严重级别 B 事件时选择了管理员支持-小时支持，Microsoft 将仅在管理员支持时段联系你。<p>此外，还可确保 Microsoft 具有准确的联系信息。
**严重性 C – 最小影响**|**最小业务影响**<p> 你的业务在服务方面具有次要障碍。<p>**次要应用程序兼容性影响**<p>潜在不相关的用户遇到不会妨碍工作效率的次要兼容性问题|初始：< 8 小时<br>更新：24 小时<br>在管理支持时段（从星期一到星期五 (24 小时支持) |选择"严重性 C"时，需确认该问题对服务轻微影响业务。<p>对于严重级别 C 事件，Microsoft 将仅在管理员支持时段联系你。<p>此外，还可确保 Microsoft 具有准确的联系信息。
