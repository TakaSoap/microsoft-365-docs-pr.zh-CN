...
案例联系人的主要联系人 (该关注区域) 的任何管理员联系人 [](../get-started/add-admin-contacts.md)将在创建、分配给服务工程师进行调查和解决时收到 **电子邮件通知**。 如果随时对这种情况有疑问，与团队联系的最佳方法就是直接答复其中一封电子邮件。 如果我们对请求有疑问或需要更多详细信息，我们将通过电子邮件向支持请求中列出的主要联系人发送电子邮件。 所有相关管理员联系人都复制在电子邮件中。
