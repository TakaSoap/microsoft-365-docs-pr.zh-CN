...
[自行注册新设备](get-started/manual-registration.md) | 更新的文章
[自己注册现有设备] (get-started/manual-registration-existing-devices .md) |更新了[文章 Microsoft 托管桌面 |](get-ready/prerequisites.md)更新了[文章安全操作Microsoft 托管桌面](service-description/security-operations.md)|新文章[访问管理门户](get-started/access-admin-portal.md)|更新了文章 [Microsoft 365 企业应用版](get-started/m365-apps.md) |新文章[隐私和个人数据](service-description/privacy-personal-data.md)|新文章
...
[在 Microsoft Project 设备上Visio Microsoft Microsoft 托管桌面 Microsoft Microsoft 托管桌面安装](get-started/project-visio.md) | 更新的文章
...
[在 Microsoft 托管桌面](get-started/manual-registration.md) | 新增文章
[在合作伙伴的 Microsoft 托管桌面 中注册设备](get-started/partner-registration.md) | 新增文章
...
已重新组织内容：添加了有关Microsoft 托管桌面[说明的部分](service-description/index.md)。
