...
新增或已更改的文章 | 说明
--- | ---
[在 Intune 公司门户 设备上Microsoft 托管桌面安装程序](get-started/company-portal.md) | 新增文章
[在 Microsoft Project 设备上Visio Microsoft Microsoft 托管桌面和 Microsoft Microsoft 托管桌面](get-started/project-visio.md) | 新增文章 
...
[管理适用于Microsoft 托管桌面](working-with-managed-desktop/manage-apps.md) | 使用更新或回滚到以前版本的业务线应用的信息进行了更新。 
