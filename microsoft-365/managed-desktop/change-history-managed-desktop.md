...
description: 本文列出了适用于 Microsoft 托管桌面的新增和更新的文章。
keywords: 修订记录
ms.prod: m365-md
ms.sitesec: library
author: jaimeo
...
新增或已更改的文章 | 说明
--- | ---
[获取用户帮助](working-with-managed-desktop/end-user-support.md) | 更新的文章
...
[获取用户帮助](working-with-managed-desktop/end-user-support.md) | 新增文章
...
[将应用程序部署到 Microsoft 托管桌面设备](get-started/deploy-apps.md) | 更新的文章
...
[跟踪和部署可配置的设置](working-with-managed-desktop/config-setting-deploy.md) | 新增文章
...
新增或已更改的文章 | 说明
--- | ---
[Microsoft 托管桌面支持](service-description/support.md)<br />[Microsoft 托管桌面的用户支持](working-with-managed-desktop/end-user-support.md) | 进行了更新以包括澳大利亚。
