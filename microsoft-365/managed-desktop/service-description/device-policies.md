...
## <a name="security-addendum"></a>安全附录
 ...
 - **安全监视** ： microsoft 将使用 [Microsoft Defender for Endpoint](https://docs.microsoft.com/windows/security/threat-protection/windows-defender-atp/windows-defender-advanced-threat-protection)监视设备。 如果检测到威胁，Microsoft 将通知客户，隔离设备，并远程纠正问题。 
