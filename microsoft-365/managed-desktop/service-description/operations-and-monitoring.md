...
**更改示例** | - 功能更新：IT 管理门户简化了支持票证提交和审阅<br>- 新功能或应用程序：Semi-Annual更新Windows 10版本 | 基于客户报告的 bug 的修补程序 |
...
Microsoft 托管桌面操作团队可以执行恢复服务中注册的设备出厂重置（如果需要）。 如果需要将设备授予其他员工，或者员工离开公司，重置会很有帮助。
