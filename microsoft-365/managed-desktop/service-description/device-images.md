...
### <a name="hp"></a>HP 
当你从 HP 订购新设备时，请务必使用购买[Windows 10 专业版](https://www.microsoft.com/windowsforbusiness/view-all-devices#view-all-filter)业务设备站点 (中每个型号的"其他要求"部分中列出的特定 SKU 来筛选视图以显示 Microsoft 托管桌面 设备) 。
...
7. 在命令提示符中，运行 ，其中 sys_disk 是刚确定的主存储磁盘的磁盘编号，recovery_wim是 的 `deploy.cmd <sys_disk> <recovery_wim>` 文件名。  你之前复制的 WIM 文件。
