...
允许列表中需要包含来自多个 Microsoft 产品的 URL，以便Microsoft 托管桌面这些 Microsoft 服务进行通信。 使用链接查看每个产品的完整列表。 

Microsoft 服务 | 文档
--- | ---
Windows 10 企业版包括 Windows Update for Business | [管理版本 1803 Windows 10连接终结点](/windows/privacy/manage-windows-1803-endpoints)<br><br>[管理连接终结点Windows 10 版本 1809](/windows/privacy/manage-windows-1809-endpoints)<br><br>[管理 Windows 10 版本 1903 的连接终结点](/windows/privacy/manage-windows-1903-endpoints)<br><br>[管理 2004 Windows 10版本的连接终结点](/windows/privacy/manage-windows-2004-endpoints)
