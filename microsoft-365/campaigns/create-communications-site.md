...
若要交流优先级、共享策略文档和突出显示即将发生的事件, 请使用 SharePoint 中的通信网站。 通信网站用于在整个市场活动中广泛共享内容-它是您的内部市场活动网站。
