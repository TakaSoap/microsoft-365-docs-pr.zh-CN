...
会议Microsoft Teams包括音频、视频和共享。 由于他们联机，因此，即使员工分布在不同地理位置或远程工作， (会议室或投影仪！) ，也始终可以有会议室。 Microsoft Teams会议是组织内外员工一起开会的一种很好的方法。 你无需是组织的成员，甚至不必拥有帐户来加入会议。 可以使用会议安排和运行联机Microsoft Teams。 会议期间，可以共享屏幕、共享文件、分配任务等。 政治宣传活动可以在会议中包括组织外部的员工、志愿者和来宾。 小型企业或做法可以与员工会面，或与客户或合作伙伴Microsoft Teams。
