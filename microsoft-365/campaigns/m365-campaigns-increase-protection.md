...
您的Office 365环境Microsoft 365恶意软件防护，但您可以通过阻止包含通常用于恶意软件的文件类型的附件来增强此保护。 在电子邮件中加强恶意软件保护：
...
1. 转到Office 365<a href="https://go.microsoft.com/fwlink/p/?linkid=2077143" target="_blank">安全&中心。</a>
...
如果尚未看到租户中带卡的"安装"页面，请参阅安全与合规中心&这些步骤。 请参阅[在安全保险箱](#set-up-safe-attachments-in-the-security--compliance-center)合规&设置附件和在安全与保险箱中心中设置&[链接](#set-up-safe-links-in-the-security--compliance-center)。
...
4. 在打开的窗格中，选中电子邮件中的链接和附件、扫描 **SharePoint、OneDrive** 和 Teams 中的文件，以及扫描 Office 桌面和 **Office Online** 应用中的链接下扫描恶意内容旁边的复选框。 
...
4. 在"保险箱附件"页上，通过选中"为 SharePoint、OneDrive 和 Microsoft Teams 启用 **ATP"复选框来** 广泛应用此保护。
...
黑客有时会在电子邮件或其他文件中的链接中隐藏恶意网站。 保险箱链接是 Microsoft Defender for Office 365 的一部分，可提供电子邮件和文档内 Web 地址 (URL) 点击Office保护组织。 保护通过链接保险箱定义。
...
2. 在 **设置** 适用于电子邮件以外的内容"下，选择 **"Microsoft 365 企业应用版、Office for iOS 和 Android"。**
...
1. 若要打开"审核日志"，请转到 管理中心 ，然后选择左侧导航中"管理中心" <https://admin.microsoft.com> 下的"安全"。  
...
可以使用活动警报跟踪管理员和用户活动，并检测组织中恶意软件和数据丢失防护事件。 你的订阅包括一组默认策略，但你也可以创建自定义策略。 有关详细信息，请参阅警报 [策略](../compliance/alert-policies.md)。 例如，如果您将一个重要文件存储在SharePoint您不希望任何人在外部共享，您可以创建一个通知，提醒您是否有人共享它。
...
1. 转到管理中心 ，然后选择 <https://admin.microsoft.com> "设置 \> **组织设置**  >  <a href="https://go.microsoft.com/fwlink/p/?linkid=2053743" target="_blank">**服务"。**</a>

1. 选择 **"** 日历"，然后选择组织中人员是否可以与拥有日历Office 365外部人员或Exchange共享日历。
