...
---
# <a name="increase-threat-protection-for-microsoft-365-subscription"></a>提高 Microsoft 365 订阅的威胁防护
...
若要在适用于 Office 365 的 Defender 中创建反网络钓鱼策略，请观看 [此简短的培训视频](https://support.office.com/article/86c425e1-1686-430a-9151-f7176cce4f2c)，或完成以下步骤：
...
5. 按照下表中的建议，指定策略的名称、说明和设置。 有关详细信息，请参阅 [在 Microsoft Defender For Office 365 选项中了解反网络钓鱼策略](https://docs.microsoft.com/microsoft-365/security/office-365-security/set-up-anti-phishing-policies)。
...
有关详细信息，请参阅 [在 Defender For Office 365 中设置反网络钓鱼策略](https://docs.microsoft.com/microsoft-365/security/office-365-security/set-up-anti-phishing-policies)。

## <a name="protect-against-malicious-attachments-files-and-links-with-defender-for-office-365"></a>防止使用适用于 Office 的 Defender 的恶意附件、文件和链接365
...
如果你的租户中未显示包含卡的 **安装程序** 页，请参阅 how To complete Security & 合规中心中的 "如何完成这些步骤"。 请参阅 [在安全 & 合规性中心中设置安全附件](#set-up-safe-attachments-in-the-security--compliance-center) ，并 [在安全 & 合规性中心中设置安全链接](#set-up-safe-links-in-the-security--compliance-center)。
...
### <a name="set-up-safe-attachments-in-the-security--compliance-center"></a>在安全 & 合规中心中设置安全附件
...
若要创建安全附件策略，请观看 [此简短视频](https://support.office.com/article/e7e68934-23dc-4b9c-b714-e82e27a8f8a5)，或完成以下步骤：
...
### <a name="set-up-safe-links-in-the-security--compliance-center"></a>在安全 & 合规中心中设置安全链接
...
若要设置安全链接，请观看 [此简短的培训视频](https://support.office.com/article/61492713-53c2-47da-a6e7-fa97479e97fa)，或完成以下步骤：
...
有关详细信息，请参阅 [适用于 Office 365 的 Defender 中的安全链接](https://docs.microsoft.com/microsoft-365/security/office-365-security/atp-safe-links)。
