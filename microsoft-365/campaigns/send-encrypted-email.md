...
您可以在[Office 365 中](https://docs.microsoft.com/en-us/office365/securitycompliance/email-encryption)了解有关设置电子邮件加密的电子邮件加密的所有信息。
...
您还可以应用您的市场活动品牌来自定义电子邮件中的外观和文本。 有关详细信息, 请参阅[将组织的品牌添加到加密邮件](https://docs.microsoft.com/en-us/office365/securitycompliance/email-encryption)。
