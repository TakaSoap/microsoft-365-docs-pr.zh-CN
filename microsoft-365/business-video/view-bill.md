...
在Microsoft 365 商业版中，你可以查看每月订阅帐单，并下载并保存或打印它。

## <a name="try-it"></a>试一试！

1. In the Microsoft 365 admin center， select **Billing** in the left navigation pane， and then select **Billing & Payments**.
