...
## <a name="try-it"></a>试一试！
在设置Microsoft 365 商业高级版 (以前称为"Microsoft 365 商业版) "后，你和员工需要完成几个步骤，以充分利用其安全性和管理功能。 下面&#39;如何进行说明。
...
根据你的公司如何设置Microsoft 365 商业版，你可能会看到加密电脑的通知。 若要加密你的电脑：

1. 选择"  **需要加密"**  邮件。
2. 选择 **"&#39;未安装** 任何其他磁盘加密软件，加密我的所有磁盘，然后选择"是 **"。** 你将看到 **一个具有** BitLocker栏的"开始"窗口。
...
你的电脑现在受安全保护和管理Microsoft 365 商业版。