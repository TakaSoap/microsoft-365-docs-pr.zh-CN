...
## <a name="try-it"></a>试一试！
设置 Microsoft 365 商业高级版 (以前称为 Microsoft 365 商业版) 后，你和员工需要完成几个步骤，以充分利用其安全和管理功能。 下面&#39;如何进行说明。

首先，验证你已安装 Windows 10 专业版：

1. 选择  **"开始** "，搜索  **"控制面板** "，然后选择它。
2. 选择 **"系统和安全**   >   **系统**"，并确认你的 Windows 版本。
...
4. 输入 Microsoft 365 帐户的电子邮件地址，然后选择"下一步 **"。**
5. 输入您的密码，选择  **"登录"，** 然后验证您是否正在加入正确的组织。
6. 选择 **"加入**"，然后选择"完成 **"。**

根据你的公司如何设置 Microsoft 365 商业版，你可能会看到加密电脑的通知。 若要加密你的电脑：
