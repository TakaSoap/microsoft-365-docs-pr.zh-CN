...
Microsoft 365 商业高级版包括 Office 365 高级威胁防护 (ATP) ，这是一种基于云的电子邮件筛选服务，可保护你免受恶意软件、勒索软件、恶意链接等的攻击。 ATP 安全链接可保护你免受电子邮件或 Office 文档中的恶意 URL 的攻击。 ATP 安全附件可保护你免受附加到邮件或文档的恶意软件和病毒的攻击。

多重身份验证 (MFA) 或双重验证，要求您提供第二种形式的身份验证（如验证码）以确认您的身份，然后才能访问资源。  
