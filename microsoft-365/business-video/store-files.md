...
### <a name="store-or-share-files-with-onedrive"></a>使用 OneDrive 存储或共享文件

1. 在计算机上使用文件资源管理器打开 OneDrive。 或者，从 [Office 365](https://www.office.com/)中，从应用启动器打开 **OneDrive。**
2. 通过单击"共享"，然后邀请其他人查看文档或向它们发送链接，查看和上载个人文件，或共享文档或文件夹。 [了解详细信息](https://support.microsoft.com/office/9fcc2f7d-de0c-4cec-93b0-a82024800c07#os_type=onedrive_-_business)。
