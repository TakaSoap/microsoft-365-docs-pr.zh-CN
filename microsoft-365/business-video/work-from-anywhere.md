...
ms.locfileid: "51164557"
---
# <a name="work-from-anywhere---overview"></a>随时随地工作 - 概述

远离你的桌面？ 不再使用笔记本电脑电池？ 没问题！ 在手机或平板电脑上随处使用 Office 处理工作。

**专业提示：** 在个人设备上关闭工作应用通知，保持工作与生活平衡。
...
您可以通过手机上的 Outlook 随时了解电子邮件和约会。 下载应用，然后启动、登录并设置帐户。

获取有关如何在手机上 [安装 Outlook 的更多详细信息](https://support.microsoft.com/office/647909af-560f-4977-ae45-3b45ad9e8236)。
...
可以将个人文件存储在 OneDrive 中，然后从手机进行同步。
...
需要一些帮助？ 获取有关 [文件存储位置、](https://support.microsoft.com/office/c7c20284-bc94-47f4-9728-d28e9daf0790)如何使用 [OneDrive](https://support.microsoft.com/office/448d4051-3a43-4d2e-b1d8-de0aa03c069e) 移动应用以及如何 [同步文件和文件夹的建议](https://support.microsoft.com/office/d9262485-9bf8-4ceb-bac2-e83f68cb6a97)。
...
详细了解如何安装 Office 应用[：Android](https://support.microsoft.com/office/647909af-560f-4977-ae45-3b45ad9e8236)  |  [iOS](https://support.microsoft.com/office/d1ad9f23-0fa3-4cf1-bf26-ff35336fd343)。

不确定在手机或平板电脑上可以做什么？ 阅读有关使用 Office 应用的信息：

| 在 iPad 或 iPhone 上工作| 在 Android 手机或平板电脑上工作| 
| :------------------- | :------------------- |
| [适用于 iOS 的 Office 应用](https://support.microsoft.com/office/microsoft-office-app-for-ios-c8880c05-883a-46b6-ad32-9bffa31228d0)  | [Android 版 Office 应用](https://support.microsoft.com/en-us/office/microsoft-office-app-for-android-0383d031-a1c6-46c9-b734-53cd1d22765b)| 
...
您还可以直接在浏览器中创建和编辑文档。 在 Word、Excel 和 PowerPoint 中打开文件、编辑文本、调整格式、添加图片和创建图形。 当您与同事或客户共享文件时，甚至可以同时处理文档。 [](https://support.microsoft.com/office/6725104a-6df7-4778-99c4-c06217dffecc)
