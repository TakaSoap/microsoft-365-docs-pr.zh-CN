...
注册全局管理员Microsoft 365 商业版将自动成为全局管理员。为了帮助管理业务，还可以让其他人成为管理员。 

## <a name="try-it"></a>试一试！

### <a name="add-an-existing-employee-as-an-admin"></a>将现有员工添加为管理员

1. 注册全局管理员Microsoft 365 商业版将自动成为全局管理员。为了帮助管理业务，还可以让其他人成为管理员。 
1. 在管理Microsoft 365，选择"**用户**"，然后选择"活动 **用户"。**
...
1. 在管理Microsoft 365，选择"**用户****"、"活动** 用户"，然后选择"**添加用户"。**
