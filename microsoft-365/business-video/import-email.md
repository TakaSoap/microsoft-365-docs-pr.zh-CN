...
ms.locfileid: "51578887"
---
# <a name="import-email-to-microsoft-365-for-business"></a>将电子邮件导入到 Microsoft 365 商业版 

> [!VIDEO https://www.microsoft.com/videoplayer/embed/40f7df36-9e24-44e5-8791-e9ed0dd8fd21?autoplay=false]

注册 Microsoft 365 后，你仍然可能会将电子邮件发送到旧帐户;例如，如果你使用 Gmail 或 Outlook 帐户工作。 可以继续使用新帐户和旧帐户，也可以将数据从旧帐户导入新帐户。

## <a name="try-it"></a>试一试！

### <a name="step-1-export-your-old-email"></a>步骤 1：导出旧电子邮件。

1. 在 Outlook 中，**选择"文件****"、"打开和导出"，** 然后选择"**导入/导出"。**
...
1. 在 Outlook 中，**选择"文件****"，"打开****"，"导出**"，然后选择"**导入/导出"。**
