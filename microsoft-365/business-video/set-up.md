...
1. 登录到 Microsoft 365 管理中心，然后选择转到  **设置**。 安装向导将启动。
...
7.  在"**激活记录"** 页上，单击"继续 **"。**
8.  在  **"添加 DNS**  记录"页上，建议让电子邮件、Teams 和移动设备安全性的服务保持打开状态。 选择  **"配置** "，然后选择"  **连接** "以确认域注册机构所做的更改。
...
11. 在"**帮助用户使用 Microsoft Teams"页上**，选择是否要向贵组织的用户发送有关 Teams 的电子邮件，然后选择"继续 **"。**
