...
可以按列（如显示名称或许可证） **对** 活动用户 **进行排序**。 若要添加更多列，请选择 **"选择列**"，选择要添加的列，然后选择"保存 **"。**

选择用户以查看更多选项，例如管理其产品许可证。

若要启用订阅中的更多功能，请选择"设置 **"。** 你可以在此处打开登录安全性、移动应用保护、DLP 以及订阅中包含的其他功能。

如果随时需要支持，请选择"**需要帮助"。** 输入问题，然后查看显示的链接。 如果在此处未获得答案，请选择"联系 **支持人员** "以打开服务请求。 
