...
ms.locfileid: "60170543"
---
# <a name="getbytitle"></a>GetByTitle

使用模型标题获取或更新有关 SharePoint Syntex 文档理解模型的信息（请参阅[示例](rest-getbytitle-method.md#examples)）。
...
### <a name="get-information-about-the-contoso-contract-model"></a>获取有关 Contoso 合同模型的信息

此示例中，Syntex 文档理解模型的名称为 `Contoso Contract`。
...
### <a name="get-and-delete-the-contoso-contract-model-by-name"></a>按名称获取和删除 Contoso 合同模型

此示例中，Contoso 合同文档理解模型的名称为 `Contoso Contract`。
