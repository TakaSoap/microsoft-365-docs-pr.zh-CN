...
ms.locfileid: "53288787"
---
# <a name="getbyuniqueid"></a><span data-ttu-id="2ed64-103">GetByUniqueId</span><span class="sxs-lookup"><span data-stu-id="2ed64-103">GetByUniqueId</span></span>

<span data-ttu-id="2ed64-104">获取或更新有关 SharePoint Syntex 文档理解模型的信息（请参阅[示例](rest-getbyuniqueid-method.md#examples)）。</span><span class="sxs-lookup"><span data-stu-id="2ed64-104">Gets or updates information about a SharePoint Syntex document understanding model (see [example](rest-getbyuniqueid-method.md#examples)).</span></span>

## <a name="http-request"></a><span data-ttu-id="2ed64-105">HTTP 请求</span><span class="sxs-lookup"><span data-stu-id="2ed64-105">HTTP request</span></span>

```HTTP
GET /_api/machinelearning/models/getbyuniqueid('{modelUniqueId}') HTTP/1.1
```

<span data-ttu-id="2ed64-106">此方法也可用于删除模型。</span><span class="sxs-lookup"><span data-stu-id="2ed64-106">This same method can be used for deleting a model, too.</span></span> 

```HTTP
DELETE /_api/machinelearning/models/getbyuniqueid('{modelUniqueId}') HTTP/1.1
```
## <a name="uri-parameters"></a><span data-ttu-id="2ed64-107">URI 参数</span><span class="sxs-lookup"><span data-stu-id="2ed64-107">URI parameters</span></span>

|<span data-ttu-id="2ed64-108">名称</span><span class="sxs-lookup"><span data-stu-id="2ed64-108">Name</span></span> |<span data-ttu-id="2ed64-109">位置</span><span class="sxs-lookup"><span data-stu-id="2ed64-109">In</span></span> |<span data-ttu-id="2ed64-110">必需</span><span class="sxs-lookup"><span data-stu-id="2ed64-110">Required</span></span>|<span data-ttu-id="2ed64-111">类型</span><span class="sxs-lookup"><span data-stu-id="2ed64-111">Type</span></span>|<span data-ttu-id="2ed64-112">说明</span><span class="sxs-lookup"><span data-stu-id="2ed64-112">Description</span></span>|
|-----|---|--------|----|-----------|
|<span data-ttu-id="2ed64-113">modelUniqueId</span><span class="sxs-lookup"><span data-stu-id="2ed64-113">modelUniqueId</span></span>|<span data-ttu-id="2ed64-114">查询</span><span class="sxs-lookup"><span data-stu-id="2ed64-114">query</span></span>|<span data-ttu-id="2ed64-115">True</span><span class="sxs-lookup"><span data-stu-id="2ed64-115">True</span></span>|<span data-ttu-id="2ed64-116">string</span><span class="sxs-lookup"><span data-stu-id="2ed64-116">string</span></span>|<span data-ttu-id="2ed64-117">Syntex 模型文件的 ID。</span><span class="sxs-lookup"><span data-stu-id="2ed64-117">ID of the Syntex model file.</span></span>|

## <a name="request-headers"></a><span data-ttu-id="2ed64-118">请求标头</span><span class="sxs-lookup"><span data-stu-id="2ed64-118">Request headers</span></span>

| <span data-ttu-id="2ed64-119">标头</span><span class="sxs-lookup"><span data-stu-id="2ed64-119">Header</span></span> | <span data-ttu-id="2ed64-120">值</span><span class="sxs-lookup"><span data-stu-id="2ed64-120">Value</span></span> |
|--------|-------|
|<span data-ttu-id="2ed64-121">Accept</span><span class="sxs-lookup"><span data-stu-id="2ed64-121">Accept</span></span>|<span data-ttu-id="2ed64-122">application/json;odata=verbose</span><span class="sxs-lookup"><span data-stu-id="2ed64-122">application/json;odata=verbose</span></span>|

## <a name="request-body"></a><span data-ttu-id="2ed64-123">请求正文</span><span class="sxs-lookup"><span data-stu-id="2ed64-123">Request body</span></span>

<span data-ttu-id="2ed64-124">对于 GET，无需请求正文。</span><span class="sxs-lookup"><span data-stu-id="2ed64-124">For GET, no request body is needed.</span></span>

## <a name="responses"></a><span data-ttu-id="2ed64-125">响应</span><span class="sxs-lookup"><span data-stu-id="2ed64-125">Responses</span></span>

| <span data-ttu-id="2ed64-126">名称</span><span class="sxs-lookup"><span data-stu-id="2ed64-126">Name</span></span>   | <span data-ttu-id="2ed64-127">类型</span><span class="sxs-lookup"><span data-stu-id="2ed64-127">Type</span></span>  | <span data-ttu-id="2ed64-128">说明</span><span class="sxs-lookup"><span data-stu-id="2ed64-128">Description</span></span>|
|--------|-------|------------|
|<span data-ttu-id="2ed64-129">200 OK</span><span class="sxs-lookup"><span data-stu-id="2ed64-129">200 OK</span></span>| |<span data-ttu-id="2ed64-130">成功</span><span class="sxs-lookup"><span data-stu-id="2ed64-130">Success</span></span>|

## <a name="examples"></a><span data-ttu-id="2ed64-131">示例</span><span class="sxs-lookup"><span data-stu-id="2ed64-131">Examples</span></span>

### <a name="get-the-contoso-contract-model-by-id"></a><span data-ttu-id="2ed64-132">按 ID 获取 Contoso 合同模型</span><span class="sxs-lookup"><span data-stu-id="2ed64-132">Get the Contoso Contract model by ID</span></span>

<span data-ttu-id="2ed64-133">此示例中，Contoso 合同文档理解模型的 ID 为 `7645e69d-21fb-4a24-a17a-9bdfa7cb63dc`。</span><span class="sxs-lookup"><span data-stu-id="2ed64-133">In this sample, the ID of the Contoso Contract document understanding model is `7645e69d-21fb-4a24-a17a-9bdfa7cb63dc`.</span></span>

#### <a name="sample-request"></a><span data-ttu-id="2ed64-134">示例请求</span><span class="sxs-lookup"><span data-stu-id="2ed64-134">Sample request</span></span>

```HTTP
GET /_api/machinelearning/models/getbyuniqueid('7645e69d-21fb-4a24-a17a-9bdfa7cb63dc') HTTP/1.1
```

#### <a name="sample-response"></a><span data-ttu-id="2ed64-135">示例响应</span><span class="sxs-lookup"><span data-stu-id="2ed64-135">Sample response</span></span>

<span data-ttu-id="2ed64-136">**状态代码：** 200</span><span class="sxs-lookup"><span data-stu-id="2ed64-136">**Status code:** 200</span></span>
...
### <a name="get-and-delete-the-contoso-contract-model-by-id"></a><span data-ttu-id="2ed64-137">按 ID 获取和删除 Contoso 合同模型</span><span class="sxs-lookup"><span data-stu-id="2ed64-137">Get and delete the Contoso Contract model by ID</span></span>

<span data-ttu-id="2ed64-138">此示例中，Contoso 合同文档理解模型的 ID 为 `7645e69d-21fb-4a24-a17a-9bdfa7cb63dc`。</span><span class="sxs-lookup"><span data-stu-id="2ed64-138">In this sample, the ID of the Contoso Contract document understanding model is `7645e69d-21fb-4a24-a17a-9bdfa7cb63dc`.</span></span>

#### <a name="sample-request"></a><span data-ttu-id="2ed64-139">示例请求</span><span class="sxs-lookup"><span data-stu-id="2ed64-139">Sample request</span></span>

```HTTP
DELETE /_api/machinelearning/models/getbyuniqueid('7645e69d-21fb-4a24-a17a-9bdfa7cb63dc') HTTP/1.1
```

## <a name="see-also"></a><span data-ttu-id="2ed64-140">另请参阅</span><span class="sxs-lookup"><span data-stu-id="2ed64-140">See also</span></span>

[<span data-ttu-id="2ed64-141">Syntex 文档理解模型 REST API</span><span class="sxs-lookup"><span data-stu-id="2ed64-141">Syntex document understanding model REST API</span></span>](syntex-model-rest-api.md)
