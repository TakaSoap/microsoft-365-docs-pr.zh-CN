...
- 优化对托管在 SharePoint 网站上承载的特定资产的访问权限Office 365 CDN。
...
如果实现这些原则，则获得针对企业网络进行优化Microsoft 365。
...
- 如何为基于客户端的 PAC 文件和网络设备和服务实现自动化受信任终结点列表，包括最适合企业网络 (持续更新) 。
- 如何支持远程工作者访问本地资源。
- 如何使用网络Insights
- 如何部署Office 365 CDN。
