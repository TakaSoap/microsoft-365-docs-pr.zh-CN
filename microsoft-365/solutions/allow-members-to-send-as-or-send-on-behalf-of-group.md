...
已被授予"代理发送"或"代表发送"权限的 Microsoft  365 组的成员可以组或代表组发送电子邮件。   (组内来宾无法授予这些权限。) 

本文介绍了全局管理员或 Exchange 管理员如何设置这些权限。
  
例如，如果 Megan Bowen 是 **Training** Microsoft 365 组的一部分，并且对该组具有"发送为"权限，那么如果她以该组发送一封电子邮件，则看起来就像 **培训** 组已发送电子邮件一样。 
...
> [!TIP]
> 请参阅 [从 Microsoft 365](https://support.microsoft.com/office/0f4964af-aec6-484b-a65c-0434df8cdb6b) 组或代表 Microsoft 365 组发送电子邮件，了解如何使用 Outlook 和 Web 上的 Outlook 从组发送电子邮件。
...
1. 在 <a href="https://go.microsoft.com/fwlink/p/?linkid=2059104" target="_blank">Exchange 管理中心中</a>，转到"**收件人""** \> **组"。**
...
本节介绍如何允许用户代表 Exchange 管理中心中的组发送电子邮件， (EAC) Exchange Online 中。
