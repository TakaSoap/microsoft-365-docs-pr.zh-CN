...
请尝试 [此测试实验室指南](team-security-isolation-dev-test.md) 设置安全隔离团队。

有关 Microsoft 365 功能和配置的其他指南，请参阅 [Microsoft 365 企业版测试实验室指南](../enterprise/m365-enterprise-test-lab-guides.md)。