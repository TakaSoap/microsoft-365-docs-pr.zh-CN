...
Microsoft Defender for Identity 支持安全操作 (SecOps) 分析师和安全专业人员在混合环境中检测高级攻击，以：
...
Microsoft 365 Defender跨工作负载 (（Microsoft Defender for Identity、Microsoft Defender for Office 365、Microsoft Defender for Endpoint 和 Microsoft Cloud App Security) ）将警报、事件、自动调查和响应以及高级搜寻统一为单一的"体验"窗格。 新功能不断添加到Microsoft 365 Defender;考虑选择接收预览功能。
...
2. [打开Microsoft 365 Defender。](../security/defender/m365d-enable.md)
...
借助 Microsoft Defender for Office 365，整个组织的人可以更安全地进行通信和协作，并针对他们的电子邮件内容和文档Office防护。
...
2. [查看和使用 Microsoft Defender for Office 365报告](../security/office-365-security/view-reports-for-mdo.md)。
...
- [Microsoft Defender for Office 365概述](../security/office-365-security/defender-for-office-365.md)
...
[Microsoft Cloud App Security](/cloud-app-security)云访问安全代理，支持日志收集、API 连接器和反向代理。 Microsoft Cloud App Security提供丰富的可见性、控制数据传输和复杂的分析，以识别和防御所有云服务中的网络威胁。 借助 Microsoft Cloud App Security，安全操作可以保护组织的敏感信息，防止网络威胁和异常，发现和监视访问组织数据的应用，并帮助确保组织的云应用满足合规性要求。
...
安全Microsoft 365中心供安全管理员和安全运营团队使用。 在Microsoft 365安全中心，你可以：
