...
在实施任何相关改进操作（包括那些可以通过 Microsoft 365功能和服务实现的改进措施）之前，评估组织要承担的数据隐私法规和风险是一个关键的第一步。
...
在美国，其中包括加州消费者保护法案 ([CCPA](/compliance/regulatory/ccpa-faq)) 、HIPAA-HITECH (美国医疗保健隐私法案) 和 GlBA () 。 其他特定于州的规定也就地或正在开发中。
...
|---|---|---|---|
|GDPR|第 5 (1)  (f) |个人数据的处理方式应保证个人数据的适当安全性，包括防止未经授权的或非法处理，以及防止意外丢失、销毁或损坏，使用适当的技术或组织措施 (完整性和保密性"。| (所有)  <br> 标识 <br> 设备 <br> 威胁防护 <br> 保护信息 <br> 管理信息 <br> 发现和响应|
||文章 (32)  (1)  () |考虑到技术状态、实现成本以及处理的性质、范围、上下文和目的，以及自然人的权利和自由存在各种可能性和严重性的风险，控制者和处理者应实施适当的技术和组织措施，以确保适当的安全级别，包括适当内部攻击： (a) 个人数据的假名化和加密。|保护信息|
||文章 (13)  (2)  () |"...控制者应在获取个人数据时，向数据主体提供确保公平、透明的处理所需的以下详细信息： () 存储个人数据的时间段，或者（如果不可能）用于确定该时间段的条件。|管理信息|
||第 (15)  (1)  () |数据主体有权从控制者确认是否正在处理其个人数据，以及是否正在访问个人数据和以下信息： (e) 是否存在从控制者纠正或清除个人数据或限制处理与数据主体相关的个人数据或对象处理此类数据的权利|发现和响应|
...
||45 CFR 164.316 (b)  (1)  (i) |如果此子部分要求记录行动、活动或评估，请维护书面 (该记录可能是) 、活动或评估的电子记录|管理信息|
||45 CFR 164.316 (b)  (1)  (ii) |将本节第 (b)  () 段所需的文档自创建日期或最后生效日期起保留 6 年，以较高者为准。|管理信息|
...
|CCPA|1798.105 (c) |如果企业收到来自消费者的可验证请求，要求删除消费者的个人信息 () 则本节的) 应删除其记录中的消费者个人信息，并指示任何服务提供商从记录中删除消费者的个人信息|发现和响应|
...
- 执行日常业务功能所需的员工数据
- 组织具有的业务客户、合作伙伴和业务到企业 B2B 商业应用场景中的其他 (数据) 关系
- 组织具有的与消费者有关的数据，这些客户向组织在企业到客户服务中的联机服务 (B2C) 信息
...
|节|说明|
|:-------|:-----|
|治理|<ol><li>隐私策略是否明确声明正在处理哪些数据信息？ </li><li>你是否定期在 PIA 中 (隐私) ？ </li><li> 您是否使用工具来管理 PI (的个人信息) ？ </li><li> 你是否具有对任意给定个人使用 PI 数据开展业务的法律授权？ 你是否跟踪数据许可？ </li><li> 你是否跟踪、实施和管理审核控制？ 是否监视数据泄露？ </li></ol>|
...
确定环境中出现敏感项目的重要工具是合规性管理中心内Microsoft 365内容资源管理器。 [](../compliance/data-classification-content-explorer.md) 这是一个自动工具，用于对整个 Microsoft 365 订阅进行初始和持续扫描，以发现敏感信息类型出现并显示结果。
