...
GDPR 是数据隐私条例中最已知和被引用的法规，它规定收集、存储、处理和共享与欧盟 (EU) 居民的已确定身份或可识别的自然人相关的任何个人数据。
...
在美国，其中包括加州消费者保护法案 ([CCPA](/compliance/regulatory/ccpa-faq)) 、HIPAA-HITECH (美国医疗保健隐私法案) 以及 GlBA (《格雷姆雷法案》 (《 GLBA) 。 其他特定于州的规定也就地或正在开发中。
...
||文章 (32)  (1)  () |考虑到技术状态、实现成本以及处理的性质、范围、上下文和目的，以及自然人的权利和自由出现不同可能性和严重性的风险，控制者和处理者应实施适当的技术和组织措施，以确保安全级别适合风险， 包括适当时包括 (：) 个人数据的假名化和加密。|保护信息|
||文章 (13)  (2)  () |"...控制者应在获取个人数据时向数据主体提供确保公平、透明的处理所需的以下详细信息： () 存储个人数据的时间段，或者如果不可能，则提供用于确定该时间段的条件。|管理信息|
||第 (15)  (1)  () |数据主体有权从控制者确认是否正在处理有关其个人数据以及是否正在处理个人数据以及访问个人数据和以下信息的权利： (e) 是否存在从控制者纠正或清除个人数据或限制处理与数据主体或对象相关的个人数据的权利到此类处理|发现和响应|
...
|CCPA|1798.105 (c) |如果企业收到来自消费者的可验证请求，要求删除消费者的个人信息 () 本节的) 应删除其记录中的消费者个人信息，并指示任何服务提供商从记录中删除消费者的个人信息|发现和响应|
...
- 执行日常业务功能所需的员工数据
- 组织具有的业务客户、合作伙伴和业务到企业 B2B (方案的其他) 数据
- 组织具有的消费者相关信息，这些客户向组织在企业到客户或 B2C) 方案中管理的联机服务 (相关信息
...
与 Web 应用程序和 CRM 系统相比，Microsoft 365中数据隐私的曝光可能会更加有限，此解决方案无法解决这些风险。
...
如果你的 Microsoft 365 环境中没有来自消费者的个人数据，或者它仅限于环境的某些部分，并且需要技术控制取决于存在消费者类型的数据泄露，则技术控制可能只需要在环境的高风险部分使用，而不是在任何地方使用。
...
除了本文中重点介绍的其他步骤外，这还提供了一个起点，用于确定要通过计划的项目配置和监视来保护的敏感项目Microsoft 365风险、准备情况和位置。
...
监视器和回复文章中提供了有关个人数据调查Microsoft 365修正技术的其他[见解](information-protection-deploy-monitor-respond.md)。
