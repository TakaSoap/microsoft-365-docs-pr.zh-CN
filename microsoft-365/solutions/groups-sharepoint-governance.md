---
title: 设置组Microsoft 365组SharePoint
ms.reviewer: mmclean
ms.author: mikeplum
...
description: 了解组和用户Microsoft 365之间的设置SharePoint
ms.openlocfilehash: eb2f4ff9745eb73f23c48630582aa455ee2bb561
ms.sourcegitcommit: c2d752718aedf958db6b403cc12b972ed1215c00
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/26/2021
ms.locfileid: "58567972"
---
# <a name="settings-interactions-between-microsoft-365-groups-and-sharepoint"></a>设置组Microsoft 365组SharePoint
...
|域允许/阻止|允许或阻止与指定域共享内容。|组无法识别SharePoint列表或阻止列表。 域中不允许的用户SharePoint组SharePoint访问权限。|管理 Azure AD 的域允许/阻止列表SharePoint一起。 创建组织范围的管理流程以允许和阻止域。<br><br>请参阅[SharePoint域设置和](/sharepoint/restricted-domains-sharing)Azure [AD 域设置](/azure/active-directory/b2b/allow-deny-list)|
...
|让用户从网站起始页SharePoint网站OneDrive|指定用户能否在网站SharePoint网站。|如果关闭此设置，用户仍可通过创建组来创建与组连接的团队网站。||

## <a name="the-effects-of-microsoft-365-groups-setting-on-sharepoint"></a>组设置Microsoft 365组SharePoint
...
|组过期策略|指定一个时间段，在此时间段之后，将自动删除未主动使用的组。|删除组时，也会SharePoint关联的网站。 保留受保留策略保护的内容。|使用过期策略以避免出现未使用的组和网站。|
