...
2. 在“**解决方案**”下，单击“**信息保护**”。
3. 单击“**创建标签**”。
4. 键入与团队名称类似的标签名称。 例如，**高度敏感 - Project Saturn**。
5. 添加工具提示，然后单击“**下一步**”。
6. 在“**加密**”页面上的“**加密**”下拉列表中，选择“**应用**”。
7. 添加团队权限：<br>
  a. 单击“**分配权限**”。<br>
  b. 单击“**添加用户或组**”，选择创建的团队，然后单击“**添加**”<br>
  c. 单击“**选择权限**”。<br>
  d. 从下拉列表中选择“**合著者**”，然后单击“**保存**”。<br>
8. 如果包括对带有标签的文件有只读权限的用户或组：<br>
  a. 单击“**分配权限**”。<br>
...
13. 如果想要允许来宾访问，请选择“**允许 Office 365 组所有者将组织外部的人员添加到组**”复选框。 
14. 在“**未托管的设备**”下，选择“**阻止访问**”。
15. 单击“**下一步**”。
16. 在“**Office 应用程序自动标记**”页面上，单击“**下一步**”。
17. 单击“**提交**”，然后单击“**完成**”。
