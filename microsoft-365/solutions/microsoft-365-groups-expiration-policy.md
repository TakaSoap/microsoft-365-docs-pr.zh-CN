...
- Outlook - 加入组、从组读取或写入组邮件， (Outlook 网页版) 。
- Teams - 访问团队频道。
...
> [!NOTE]
> 配置和使用 Microsoft 365 组的过期策略需要你拥有（但不一定）为应用过期策略的所有组的成员分配 Azure AD Premium 许可证。 有关详细信息，请参阅[入门Azure Active Directory Premium。](/azure/active-directory/active-directory-get-started-premium)
