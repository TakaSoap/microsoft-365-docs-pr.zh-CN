...
8. 确保未选中" **不跟踪用户** 单击安全链接时"选项，同时选择其余选项。 有关详细信息 [，请参阅安全](../office-365-security/recommended-settings-for-eop-and-office365-atp.md) 链接设置。 单击“**保存**”。 
...
有关更全面的指南，请参阅打开[Microsoft 365 Defender。](mtp-enable.md) 
