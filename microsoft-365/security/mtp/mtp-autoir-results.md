...
改进[的操作中心](mtp-action-center.md) () 跨设备、电子邮件和协作内容和标识& [https://security.microsoft.com/action-center](https://security.microsoft.com/action-center) 修正操作[](mtp-remediation-actions.md)。 列出的操作包括自动或手动采取的修正操作。 在操作中心中，可以查看等待审批的操作以及已获得批准或已完成的操作。 还可以导航到更多详细信息，如调查页面。

> [!TIP]
> 您必须具有 [某些权限才能](mtp-action-center.md#required-permissions-for-action-center-tasks) 批准、拒绝或撤消操作。
...
| **设备** | 列出包含在调查中的设备及其修正级别。  (修正级别对应于设备[组 .) ](mtp-configure-auto-investigation-response.md#review-or-change-the-automation-level-for-device-groups) |
| **邮箱** |列出受检测到的威胁影响的邮箱。  |
| **用户**  | 列出受检测到的威胁影响的用户帐户。 |
...
- [在自动调查后批准或拒绝修正操作](mtp-autoir-actions.md)
- [详细了解修正操作](mtp-remediation-actions.md)
