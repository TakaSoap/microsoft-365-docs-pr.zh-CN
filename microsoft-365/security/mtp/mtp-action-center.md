...
5. 在列表中选择一个项目以查看有关调查的更多详细信息。 此时将打开调查详细信息视图。<br/>![调查详细信息](../../media/mtp-air-investdetails.png)
    ...
    - 如果调查与电子邮件内容（例如，实体为邮箱）相关，则会在安全 & 合规中心（）中打开调查详细信息 [https://protection.office.com/threatinvestigation](https://protection.office.com/threatinvestigation) 。 
