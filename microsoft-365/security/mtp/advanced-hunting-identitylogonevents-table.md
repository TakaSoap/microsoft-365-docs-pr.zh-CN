...
>[!NOTE]
>此表涵盖由 Cloud App Security 跟踪的 Azure Active Directory (AD) 登录活动，尤其是使用 ActiveSync 和其他旧协议进行交互式登录和身份验证活动。 此表中不可用的非交互式登出可在 Azure AD 审核日志。 [了解有关将 Cloud App Security 连接到 Microsoft 365](https://docs.microsoft.com/cloud-app-security/connect-office-365-to-microsoft-cloud-app-security)
