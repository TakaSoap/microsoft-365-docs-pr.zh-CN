...
|![第3阶段： Configure & 板载](../../media/config-onboard.png) <br>[第3阶段： Configure & 板载](config-mtpeval.md) | 为 Microsoft 365 Defender 试用版实验室或试点环境配置每个 Microsoft 365 Defender 支柱，并将终结点集成在一起。
|:-------|:-----|
