...
高级搜寻架构中的表包含与 `AlertEvidence` 来自 Microsoft Defender for Endpoint、Microsoft Defender for Office 365、Microsoft Cloud App Security 和 Microsoft Defender for Identity 的警报相关联的各种实体（文件、IP 地址[](advanced-hunting-overview.md)、URL、用户或设备）的信息。 使用此参考来构建从此表返回信息的查询。
...
| `ThreatFamily` | string | 被分类为可疑或恶意文件或进程的恶意软件系列 |
