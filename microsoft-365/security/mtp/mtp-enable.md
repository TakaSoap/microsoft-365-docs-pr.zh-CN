...
若要获取有关打开 Microsoft 365 Defender 的最常见问题的答案， [请阅读常见问题](mtp-enable-faq.md)解答。
...
- [Microsoft Defender for Endpoint 数据存储](/windows/security/threat-protection/microsoft-defender-atp/data-storage-privacy)