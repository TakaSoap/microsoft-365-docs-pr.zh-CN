...
* **启动实时响应会话** - 在设备上加载远程 Shell 进行 [深入安全调查](/windows/security/threat-protection/microsoft-defender-atp/live-response)。
...
* [使用实时响应调查设备上的实体](/windows/security/threat-protection/microsoft-defender-atp/live-response)
