...
1. 验证租户是否[已启用 Microsoft 365 Defender。](./mtp-enable.md#starting-the-service)
...
1. 验证租户是否已启用[Microsoft 365 Defender。](./mtp-enable.md#starting-the-service)
2. 确定用于接收电子邮件的目标邮箱。
...
|![结束和摘要阶段](../../media/mtp/close.png) <br>[结束和摘要阶段](mtp-pilot-close.md)|分析你的 Microsoft 365 Defender 试点结果，将其展示给利益干系人，然后执行下一步。
|:-----|:-----|