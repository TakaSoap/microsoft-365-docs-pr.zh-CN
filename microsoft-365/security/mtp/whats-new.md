...
---
# <a name="whats-new-in-microsoft-threat-protection"></a>Microsoft 威胁防护中的新增功能
...
- [高级搜寻增强功能](advanced-hunting-query-emails-devices.md) <br> 主动查找整个 Windows 设备和 Office 365 电子邮件中的威胁。 

## <a name="march-2019"></a>2019 年 3 月

- [高级搜寻](hunting.md) <br> 主动发现组织中影响电子邮件和数据、设备和标识的威胁。
