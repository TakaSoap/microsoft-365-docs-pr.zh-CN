...
|建议  |E3  |E5  |
|---------|---------|---------|
|**配置 Office 365 高级威胁防护（ATP）**：<br>* ATP 安全附件<br>* ATP 安全链接<br>* 适用于 SharePoint、OneDrive 和 Microsoft 团队的 ATP<br>* ATP 反网络钓鱼防护|         |![绿色复选标记](../media/green-check-mark.png) |
