...
该功能旨在为用户提供反馈，但不更改系统中邮件裁定。 为了帮助 Microsoft 更新和改进其筛选器，你需要使用管理员提交 提交[邮件进行分析。](admin-submission.md)
...
1. 在Microsoft 365 Defender门户中，直接转到 **提交页面**：[ https://security.microsoft.com/reportsubmission}(https://security.microsoft.com/reportsubmission) 。
...
3. 如果要自定义任何模板，请单击页面底部的"自定义电子邮件通知"。  在打开的飞出中，只能自定义以下内容：
