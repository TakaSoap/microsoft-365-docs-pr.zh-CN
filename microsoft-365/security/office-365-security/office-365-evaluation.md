...
[Microsoft Defender for Office 365](office-365-atp.md)评估体验旨在消除设备和环境配置的复杂性，以便你可以专注于评估 Microsoft Defender for Office 365 的功能。 使用评估模式，可以评估发送到 Exchange Online 邮箱的所有邮件，而无需将 MX 记录指向 Microsoft。 此功能仅适用于电子邮件保护，而仅适用于 Word、SharePoint 或 Teams 等 Office 客户端。
