...
---
# <a name="threat-explorer-and-real-time-detections-basics"></a>威胁资源管理器和实时检测基础知识
...
如果你的组织拥有适用于 Office 365 的 Microsoft [Defender，](defender-for-office-365.md)并且你拥有 [](#required-licenses-and-permissions)权限，可以使用称为资源管理器 **(** 的威胁资源管理器 **)** 或实时检测来检测和修正威胁。
...
- 但资源管理器仅包含在计划 2 Office 365 Defender 中。
