...
|**管理通知**|查看和编辑警报的设置和报告。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> 安全管理员 <br/><br/> Security 运算符|
...
|**仅查看审核日志**|查看和导出审核报告。 由于这些报告可能包含敏感信息，因此只应将此角色分配给具有查看此信息的明确需要的人。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> 安全管理员 <br/><br/> Security 运算符|
|**仅查看设备管理**|查看设备管理功能的配置和报告。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> 安全管理员 <br/><br/> Security 运算符 <br/><br/> 安全读者|
|**仅查看 DLP 合规性管理**|查看数据丢失防护（DLP）策略的设置和报告。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> 安全管理员 <br/><br/> Security 运算符 <br/><br/> 安全读者|
|**仅查看 IB 合规性管理**|查看信息屏障功能的配置和报告。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> 安全管理员 <br/><br/> Security 运算符 <br/><br/> 安全读者|
|**仅查看管理通知**|查看管理警报功能的配置和报告。|安全管理员 <br/><br/> Security 运算符 <br/><br/> 安全读者 <br/><br/> 合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理|
