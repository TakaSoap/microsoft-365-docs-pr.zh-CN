...
|**数据调查人员**|成员可以对邮箱、SharePoint 网站和 OneDrive 帐户执行搜索。|通 <br/><br/> 合规性搜索 <br/><br/> Custodian <br/><br/> 数据调查管理 <br/><br/> 导出<br/><br/> 预览 <br/><br/> RMS 解密 <br/><br/> 审阅<br/><br/> 搜索和清除|
...
|**Reviewer**|成员只能查看 Security & 合规性中心中 "电子数据展示事例" 页上的事例列表。 他们无法创建、打开或管理电子数据展示事例。 此角色组的主要用途是允许成员在高级电子数据展示中查看和访问事例数据。 <br/><br/> 此角色组中与电子数据展示相关的权限最具限制性。|审阅|
|**安全管理员**|此角色组的成员可能包括跨服务管理员以及外部合作伙伴组和 Microsoft 支持。 默认情况下，可能不会向该组分配任何角色。 但是，它将是 Azure Active Directory 中的安全管理员角色的成员，并将继承该角色的功能。 若要集中管理权限，请在 Azure Active Directory 管理中心中对此角色进行更改-有关详细信息，请参阅[Azure Active directory 中的管理员角色权限](https://docs.microsoft.com/en-us/azure/active-directory/users-groups-roles/directory-assign-admin-roles)。 <br/><br/> 如果在安全 & 合规中心中编辑此角色组，这些更改仅适用于安全 & 合规性中心，而不是其他任何服务，而在 Azure Active Directory 管理中心中所做的更改会影响所有服务。 <br/><br/> 安全读者角色的所有只读权限，以及对相同服务的许多其他管理权限： Azure 信息保护、标识保护中心、特权身份管理、监视 Office 365 服务运行状况和 Office 365 安全 & 合规性中心。|审核日志 <br/><br/> DLP 合规性管理 <br/><br/> 设备管理 <br/><br/> IB 合规性管理 <br/><br/> 管理通知 <br/><br/> Security Administrator <br/><br/> 敏感度标签管理员 <br/><br/> 仅查看审核日志 <br/><br/> 仅查看 DLP 合规性管理 <br/><br/> 仅查看设备管理 <br/><br/> 仅查看 IB 合规性管理 <br/><br/> 仅查看管理通知|
|**Security 运算符**|成员可以管理安全警报，还可以查看安全功能的报告和设置。|合规性搜索 <br/><br/> 管理通知 <br/><br/> 安全读者 <br/><br/> 仅查看审核日志 <br/><br/> 仅查看 DLP 合规性管理 <br/><br/> 仅查看设备管理 <br/><br/> 仅查看 IB 合规性管理 <br/><br/> 仅查看管理通知|
|**安全读者**|成员具有对身份保护中心的许多安全功能的只读访问权限、特权身份管理、监视 Office 365 服务运行状况和 Office 365 安全性 & 合规性中心。 <br/><br/> 此角色组中的成员身份将跨服务同步并集中管理。 此角色组的成员可能包括跨服务管理员以及外部合作伙伴组和 Microsoft 支持。 默认情况下，可能不会向该组分配任何角色。 但是，它将是 Azure Active Directory 中的安全读取器角色的成员，并将继承该角色的功能。 若要集中管理权限，请在 Azure Active Directory 管理中心中对此角色进行更改-有关详细信息，请参阅[Azure Active directory 中的管理员角色权限](https://docs.microsoft.com/en-us/azure/active-directory/users-groups-roles/directory-assign-admin-roles)。 如果在安全 & 合规中心中编辑此角色组，这些更改仅适用于安全 & 合规性中心，而不是其他任何服务，而在 Azure Active Directory 管理中心中所做的更改会影响所有服务|安全读者 <br/><br/> 仅查看 DLP 合规性管理 <br/><br/> 仅查看设备管理 <br/><br/> 仅查看 IB 合规性管理 <br/><br/> 仅查看管理通知|
|**服务保证用户**|成员可以访问 Office 365 安全 & 合规性中心中的服务保证部分。 服务保证提供了报告和文档，这些报告和文档描述了 Microsoft 在 Office 365 中存储的客户数据的安全实践。 此外，它还提供了有关 Office 365 的独立第三方审核报告。 有关详细信息，请参阅[Office 365 Security & 合规中心中的服务保证](http://go.microsoft.com/fwlink/p/?LinkID=717765)。|服务保证视图|
|**监管审核**|成员可以创建和管理用于定义哪类通讯在组织中易受到审查的策略。 有关详细信息，请参阅为[您的组织配置监管审核策略](../../compliance/configure-supervision-policies.md)。|监管审核管理员|
...
|**数据调查人员**|对邮箱、SharePoint Online 网站和 OneDrive for business 位置执行搜索。|导出 <br/><br/> RMS 解密 <br/><br/> Custodian <br/><br/> 通 <br/><br/> 审阅 <br/><br/> 预览 <br/><br/> 合规性搜索 <br/><br/> 数据调查管理|
|**通**|管理在高级电子数据展示事例中标识的保管人的所有通信。  创建保留通知、保留提醒和升级到管理。 跟踪保留通知的保管人确认并管理对由每个保管人使用的保管人门户使用的访问权限，以便在标识为管理员的情况下跟踪通信。|电子数据展示管理员|
|**合规性管理员**|查看和编辑合规性功能的设置和报告。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理|
|**合规性搜索**|跨邮箱执行搜索并获取结果估计。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 电子数据展示管理员 <br/><br/> 组织管理 <br/><br/> Security 运算符|
...
|**设备管理**|查看和编辑设备管理功能的设置和报告。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> Security Administrator|
|**处置管理**|控制在安全 & 合规中心中访问手动处置的权限。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理|
|**DLP 合规性管理**|查看和编辑数据丢失防护（DLP）策略的设置和报告。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> Security Administrator|
|**Export**|导出从搜索返回的邮箱和网站内容。|电子数据展示管理员|
|**同时**|将邮箱、网站和公用文件夹中的内容置于保留状态。 保留时，内容副本存储在安全位置。 内容所有者仍能修改或删除原始内容。|合规性管理员 <br/><br/> 电子数据展示管理员 <br/><br/> 组织管理|
|**IB 合规性管理**|查看、创建、删除、修改和测试信息屏障策略。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> Security Administrator|
|**管理通知**|查看和编辑警报的设置和报告。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> Security Administrator <br/><br/> Security 运算符|
...
|审阅|使用 Office 365 高级电子数据展示跟踪、标记、分析和测试分配给它们的文档。|电子数据展示管理员 <br/><br/> Reviewer|
|**RMS 解密**|导出搜索结果时对受 RMS 保护的内容进行解密。|电子数据展示管理员|
|**角色管理**|管理角色组成员身份并创建或删除自定义角色组。|组织管理|
|**搜索和清除**|允许人员批量删除与内容搜索条件相匹配的数据。|组织管理|
|**安全管理员**|查看和编辑安全功能的配置和报告。|组织管理 <br/><br/> Security Administrator|
|**安全读者**|查看安全功能的配置和报告。|组织管理 <br/><br/> Security 运算符 <br/><br/> 安全读者|
|**敏感度标签管理员**|查看、创建、修改和删除敏感度标签。|合规性数据管理员 <br/><br/> 组织管理 <br/><br/> Security Administrator|
|**服务保证视图**|从 "服务保证" 部分下载可用文档。 内容包括独立的审核、合规性文档以及与信任相关的用于使用 Office 365 功能管理法规遵从性和安全风险的指南。|服务保证用户 <br/><br/> 组织管理|
|**监管审核管理员**|管理监管审核策略，包括要查看哪些通信以及应执行检查的参与者。|监管审核|
|**仅查看审核日志**|查看和导出审核报告。 由于这些报告可能包含敏感信息，因此只应将此角色分配给具有查看此信息的明确需要的人。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> Security Administrator <br/><br/> Security 运算符|
|**仅查看设备管理**|查看设备管理功能的配置和报告。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> Security Administrator <br/><br/> Security 运算符 <br/><br/> 安全读者|
|**仅查看 DLP 合规性管理**|查看数据丢失防护（DLP）策略的设置和报告。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> Security Administrator <br/><br/> Security 运算符 <br/><br/> 安全读者|
|**仅查看 IB 合规性管理**|查看信息屏障功能的配置和报告。|合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理 <br/><br/> Security Administrator <br/><br/> Security 运算符 <br/><br/> 安全读者|
|**仅查看管理通知**|查看管理警报功能的配置和报告。|Security Administrator <br/><br/> Security 运算符 <br/><br/> 安全读者 <br/><br/> 合规性管理员 <br/><br/> 合规性数据管理员 <br/><br/> 组织管理|
