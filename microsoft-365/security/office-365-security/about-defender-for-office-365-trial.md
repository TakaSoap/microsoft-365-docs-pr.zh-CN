...
Microsoft Defender for Office 365 可保护你的组织免受电子邮件、链接和 (URL) 和协作工具造成的恶意威胁。 Defender for Office 365 包括：

- **威胁防护策略**：定义威胁防护策略，为组织设置适当级别的保护。
- **报告**：查看实时报告，以监视组织中 Office 365 性能的 Defender。
- **威胁调查和响应功能**：使用前沿工具调查、理解、模拟和阻止威胁。
- **自动化调查和响应功能**：节省时间和精力来调查和缓解威胁。

Microsoft Defender for Office 365 试用版是试用适用于 Office 365 的 Defender 功能的最简单方法，设置它只需单击几下。 在试用设置完成后，所有 Defender for Office 365 计划 1 和计划 2 功能在组织中最多 90 天可用。

> [!NOTE]
> 本文中所述的自动配置目前处于公共预览版中，可能在你的位置不可用。

## <a name="terms-and-conditions"></a>条款和条件

Defender for Office 365 试用版的试用期为 90 天，可针对所有用户启动。 有关详细信息，请参阅 [Microsoft Defender for Office 365 试用版的使用条款](terms-of-use-defender-for-office-365-trial.md)。

## <a name="set-up-a-defender-for-office-365-trial"></a>设置适用于 Office 365 的 Defender 试用版

试用允许组织轻松设置和配置适用于 Office 365 的 Defender 功能。 在设置过程中，专用于 Office 365 (Defender 的策略、反垃圾邮件[](atp-safe-attachments.md)策略) [](atp-safe-links.md)中的安全附件[](set-up-anti-phishing-policies.md#impersonation-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365)、安全链接和模拟保护均使用预设安全策略的标准模板[应用](preset-security-policies.md)。

默认情况下，这些策略的范围为组织中所有用户，但管理员可以在设置期间或之后自定义策略，以便它们仅适用于特定用户。

在设置过程中，MDO (MDO P2 或等效) 也为整个组织设置。 不需要策略范围。
...
注册试用版后，更改和更新最多可能需要 2 小时才能可用。 管理员必须注销并重新登录才能看到更改。

管理员可以随时通过访问该 <> 试用版。

## <a name="availability"></a>供应情况

Defender for Office 365 试用版将逐步向满足特定条件的现有客户推出 (包括地理位置) 以及其订阅中或作为加载项) 中不包含现有 Defender for Office 365 计划 1 或计划 2 许可证 (的客户。

## <a name="learn-more-about-defender-for-office-365"></a>了解有关 Defender for Office 365 有关详细信息

Defender for Office 365 通过提供一系列全面的功能来帮助组织保护企业的安全。
...
### <a name="prevention"></a>防护

可靠的筛选堆栈可阻止各种基于卷和目标的攻击，包括商业电子邮件泄露、凭据钓鱼、勒索软件以及高级恶意软件。

- [防钓鱼策略：Defender for Office 365 中的独占设置](set-up-anti-phishing-policies.md#exclusive-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365)
- [安全附件](atp-safe-attachments.md)
- [安全链接](atp-safe-links.md)
...
借助高级搜寻功能，强大的体验可帮助识别、确定威胁优先级并调查威胁，以跟踪 Office 365 中的攻击。
...
建议的模板和配置见解帮助客户获取和保持安全。

- [EOP 和 Microsoft Defender for Office 365 中的预设安全策略](preset-security-policies.md)
