...
Office 365 中的[威胁调查和响应](office-365-ti.md)功能包含在 Office 365 E5 订阅中（作为[Office 365 高级威胁防护](office-365-atp.md)计划2的一部分）。 这些功能已帮助 Microsoft IT 缩短了80% 的社交工程事件的平均解决时间，并显著提高了机箱吞吐量。 最近添加了新功能，以帮助改进对威胁进行检测和恢复的方式。 阅读本文，了解威胁调查和响应功能如何帮助安全操作团队更高效、更有效。
...
Office 365 威胁调查和响应功能使用[Microsoft 智能安全图形](https://cloud-platform-assets.azurewebsites.net/intelligent-security-graph/)中的数据提供支持。 Graph 从 1000000000 Windows 设备、450000000000每月 Azure 登录和 400000000000 Office 365 中的每月电子邮件获取最新的威胁信号。 这一无与伦比的威胁信号提供了安全操作团队对影响组织的威胁的更完整视图的广泛可见性。
