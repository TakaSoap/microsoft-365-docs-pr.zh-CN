...
无效的邮件流规则 (也称为传输规则) 会导致组织的邮件流延迟。 此见解报告对组织的邮件流有影响的邮件流规则。 这些类型的规则的示例包括：
...
有关邮件流规则中的条件和例外项详细信息，请参阅 Exchange [Online](https://docs.microsoft.com/Exchange/security-and-compliance/mail-flow-rules/conditions-and-exceptions)中的邮件流规则 (例外) 例外。
