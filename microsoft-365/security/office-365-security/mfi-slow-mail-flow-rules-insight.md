...
无效的邮件流规则 (传输规则) 传输规则可能导致组织的邮件流延迟。 此见解报告对组织的邮件流有影响的邮件流规则。 这些类型的规则的示例包括：
...
有关邮件流规则中的条件和例外，请参阅邮件流规则条件和例外 ([中的) Exchange Online。](/Exchange/security-and-compliance/mail-flow-rules/conditions-and-exceptions)
