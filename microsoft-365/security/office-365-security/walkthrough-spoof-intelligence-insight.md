...
在具有高级威胁防护 (ATP) 的 Microsoft 365 组织中，您可以使用欺骗性智能洞察力快速确定哪些发件人合法地向您发送未经身份验证的电子邮件。 通过允许他们发送欺骗邮件，可以降低任何误报给用户带来的风险。 您还可以使用欺骗智能洞察力来监视和管理允许的域对，以提供额外的安全措施，并防止不安全的邮件到达您的组织中。
