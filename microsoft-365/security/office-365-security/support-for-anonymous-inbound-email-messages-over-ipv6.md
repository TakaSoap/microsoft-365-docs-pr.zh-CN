...
Microsoft 365具有 Exchange Online 邮箱和独立 EOP Exchange Online Protection (组织) 没有 Exchange Online 邮箱的组织支持通过 IPv6 发送的匿名入站电子邮件。 源 IPv6 电子邮件服务器必须满足以下两个要求：
