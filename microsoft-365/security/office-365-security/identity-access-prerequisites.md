...
|平台|客户端|版本/说明|
|---|---|---|
|**Windows**|Outlook|2019、2016、2013 <p> [启用新式验证](https://docs.microsoft.com/microsoft-365/admin/security-and-compliance/enable-modern-authentication) <p> [所需更新](https://support.office.com/article/Outlook-Updates-472c2322-23a4-4014-8f02-bbc09ad62213)|
...
- [Microsoft 365 客户端应用程序支持-新式验证](../../enterprise/microsoft-365-client-support-modern-authentication.md)
