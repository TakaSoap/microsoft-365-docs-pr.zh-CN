...
- 如果您的内部部署环境中有邮箱，则需要修改防火墙设置，以允许从 TCP 端口 25 上的 Microsoft 365 IP 地址连接到内部部署电子邮件服务器。 有关 IP 地址Microsoft 365，请参阅Microsoft 365 [URL 和 IP 地址范围](../../enterprise/urls-and-ip-address-ranges.md)。
...
- 您的本地电子邮件服务器无法正常运行 (例如服务挂起、崩溃或系统资源不足) ，从而导致服务器退出并关闭与 Microsoft 365 的连接。
