...
4. 在出现的 **"** 设置"页上，配置以下设置：
   ...
   - **不允许用户单击到原始 URL：** 选择此设置可阻止用户单击到警告页面中 [的原始](atp-safe-links.md#warning-pages-from-safe-links)URL。
   ...
   有关这些设置的详细信息，请参阅 [电子邮件的安全链接设置](atp-safe-links.md#safe-links-settings-for-email-messages) 和 Microsoft Teams [的安全链接设置](atp-safe-links.md#safe-links-settings-for-microsoft-teams)。
...
> [!NOTE]
> 
> - 有关要用于 _DoNotRewriteUrls_ 参数的条目语法的详细信息，请参阅"不要重写以下 [URL"](atp-safe-links.md#entry-syntax-for-the-do-not-rewrite-the-following-urls-list)列表的条目语法。
> 
...
若要验证安全链接是否正在扫描邮件，请检查可用的 Microsoft Defender for Office 365 报告。 有关详细信息，请参阅[查看适用于 Office 365 的 Defender](view-reports-for-atp.md)报告和使用安全与合规中心&[资源管理器。](threat-explorer.md)
