...
> [!NOTE]
> 本文中的信息要求您对电子邮件地址的常规格式有一个基本的了解。 有关详细信息，请参阅[rfc 5322](https://tools.ietf.org/html/rfc5322) （尤其是3.2.3、3.4 和3.4.1）、 [Rfc 5321](https://tools.ietf.org/html/rfc5321)以及[rfc 3696](https://tools.ietf.org/html/rfc3696)。 本文介绍了5322.from 地址的策略实施。 本文不介绍5321的5321.Mailfrom 地址。
