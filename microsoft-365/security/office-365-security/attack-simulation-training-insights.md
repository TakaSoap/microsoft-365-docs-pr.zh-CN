...
在攻击模拟培训中，Microsoft 根据员工经过的模拟和培训的结果提供见解。 这些见解将有助于你随时了解员工的威胁准备进度，并推荐下一步，让员工和环境更好地做好应对攻击的准备。

我们正在不断扩展可供你获取的见解。 行为影响和推荐操作目前可用。 若要开始，请前往攻击[门户 中的攻击Microsoft 365 Defender培训](https://security.microsoft.com/attacksimulator?viewid=overview)。
...
- **预测的泄露率**，反映了使用攻击模拟培训的其他 Microsoft 365 租户中使用相同有效负载的模拟的平均入侵率。
