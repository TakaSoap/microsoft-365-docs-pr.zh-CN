...
|安全功能名称|默认值|标准|Strict|评论|
|---|:---:|:---:|:---:|---|
|**保险箱附件未知恶意软件响应** <p> _启用__和操作_|**关闭** <p> `-Enable $false`|**阻止** <p> `-Enable $true` 和 `-Action Block`|**阻止** <p> `-Enable $true` 和 `-Action Block`|当 _Enable_ 参数$false时 _，Action_ 参数的值无关紧要。|
