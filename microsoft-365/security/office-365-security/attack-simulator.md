...
> [!TIP]
> 攻击模拟培训适用于 Microsoft 365 安全中心中的公共预览版。 查看 Microsoft [Defender for Office 365 模拟](attack-simulation-training.md) 网络钓鱼攻击以了解更多信息。
...
以上任一操作都将你访问名为"攻击详细信息 **"的页面**。 以下各节介绍了此页上提供的每种市场活动类型的信息。
