...
安全 [&](https://protection.office.com)**与合规** 中心的"邮件流"[](mail-flow-insights-v2.md)仪表板中的"出站和入站邮件流"见解将"连接器"报表和以前的 [](view-mail-flow-reports.md#connector-report) **TLS** 概述报告中的信息合并在一处。
