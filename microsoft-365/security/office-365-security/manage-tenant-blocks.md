...
此示例为 contoso.com 和所有子域添加阻止 URL (例如，contoso.com、www.contoso.com 和 xyz.abc.contoso.com) 。 由于我们没有使用 ExpirationDate 或 NoExpiration 参数，因此条目将在 30 天后过期。
