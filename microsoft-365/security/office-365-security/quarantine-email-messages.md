...
---
# <a name="quarantine-email-messages"></a>隔离电子邮件

如果您是在 Exchange Online 中有邮箱或独立 Exchange Online Protection （EOP）客户但没有 Exchange Online 邮箱的 Microsoft 365 客户，则可以使用隔离来保存可能有害的邮件。
