...
|需执行的操作|了解详细信息的资源|
|---|---|
|查看报告的威胁防护功能是如何为你的组织工作的|[安全仪表板](security-dashboard.md)<br/>[电子邮件安全报告](view-email-security-reports.md)<br/>[Microsoft Defender for Office 365 的报告](view-reports-for-atp.md)<br/>[威胁资源管理器](threat-explorer.md)|
