...
description: 了解如何为用户、单个用户或整个组织Outlook Outlook 网页版报告邮件或报告网络钓鱼外接程序。
ms.technology: mdo
...
> [!NOTE]
> 如果你是拥有多个邮箱Microsoft 365组织的管理员Exchange Online，我们建议你使用 Microsoft 365 Defender 页面。  有关详细信息，请参阅使用[管理员提交将可疑的垃圾邮件、网络钓鱼、URL 和文件提交到 Microsoft。](admin-submission.md)

Outlook 和 Outlook 网页版 (的"报告邮件"和"报告钓鱼"外接程序（以前称为 Outlook Web App) ）可轻松向 Microsoft 及其关联公司报告误报 (标记为错误) 或漏报 (错误电子邮件允许) 至 Microsoft 及其关联公司进行分析。
...
- 这两个外接程序均不适用于共享邮箱或内部部署组织Exchange邮箱。
...
1. 在Microsoft 365 管理中心 [中](https://admin.microsoft.com/AdminPortal/Home?#/homepage)，转到 **"设置** \> **集成应用"。** 单击 **获取应用**。

    > [!div class="mx-imgBorder"]
    > ![Microsoft 365 管理中心集成应用](../../media/microsoft-365-admin-center-integrated-apps.png)

2. In the **Microsoft 365 应用版** page that appears， click in the **Search** box， enter **Report Message**， and then click **Search** ![ Search icon. ](../../media/search-icon.png) . 在结果列表中，查找并选择"报告 **邮件"。** 
...
1. 在Microsoft 365 管理中心中，**转到设置** \> **集成应用** \. 然后查找并选择 **"报告邮件** "外接程序。
...
1. In the [Microsoft 365 管理中心，](https://admin.microsoft.com/AdminPortal/Home?#/homepage)go to **设置** \> **Integrated apps**. 单击 **获取应用**。

    > [!div class="mx-imgBorder"]
    > ![Microsoft 365 管理中心集成应用](../../media/microsoft-365-admin-center-integrated-apps.png)

2. 在出现的 **Microsoft 365 应用版** 页中，单击"搜索"**框中，输入**"报告网络钓鱼 **"，** 然后单击"搜索 **搜索"** ![ 图标 ](../../media/search-icon.png) 。 在结果列表中，查找并选择"报告 **网络钓鱼"。** 
...
1. In the Microsoft 365 管理中心， go to **设置** \> **Integrated apps** \. 然后查找并选择 **"报告网络钓鱼** 外接程序"。
