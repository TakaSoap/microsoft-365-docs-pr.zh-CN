...
ATP 安全附件 (以及[Atp 安全链接](atp-safe-links.md)) 是[Office 365 高级威胁防护](office-365-atp.md) (ATP) 的一部分。 ATP 安全附件功能将检查电子邮件附件是否是恶意的，然后采取措施保护您的组织。 ATP 安全附件功能可根据由全局管理员或安全管理员设置的[ATP 安全附件策略](set-up-atp-safe-attachments-policies.md)来保护您的组织。
...
接下来，请确保定义了 ATP 安全附件策略。  (参阅[设置 Office 365 Atp 安全附件策略](set-up-atp-safe-attachments-policies.md)) ATP 安全附件功能在以下情况中是活动的：
...
在您[定义 (或查看) ATP 安全附件策略](set-up-atp-safe-attachments-policies.md)后，查看服务的工作方式的一个良好方式是[查看高级威胁防护的报告](view-reports-for-atp.md)。
