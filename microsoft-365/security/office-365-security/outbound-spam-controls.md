...
description: 管理员可以了解 Microsoft 365 和 Exchange Online Protection （EOP）如何保护客户不受出站垃圾邮件的保护，以及在需要发送大量邮件时应采取的操作。
ms.openlocfilehash: 71fe5d5ba1ffbecc77b646a06c3da4d9681ee3ea
ms.sourcegitcommit: 2614f8b81b332f8dab461f4f64f3adaa6703e0d6
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/21/2020
ms.locfileid: "43634492"
---
# <a name="outbound-spam-protection"></a>配置垃圾邮件保护

我们会认真管理出站垃圾邮件，因为 Microsoft 365 （Exchange Online 或独立 Exchange Online Protection （EOP），而不是 Exchange Online 邮箱）是多个客户使用共享资源池的一种在线服务。 一位 Microsoft 365 客户有意或无意地向其组织发送垃圾邮件，可能会降低整个服务的声誉，并可能影响其他客户的电子邮件传递。
...
- **查看来自第三方电子邮件提供商的垃圾邮件投诉**：许多电子邮件服务（如 Outlook.com、YAHOO 和 AOL）在其服务中的任何用户将来自 Microsoft 365 的电子邮件标记为垃圾邮件时，将该邮件打包并发回我们进行审阅。 若要了解有关 Outlook.com 的发件人支持的<https://sendersupport.olc.protection.outlook.com/pm/services.aspx>详细信息，请转到。
