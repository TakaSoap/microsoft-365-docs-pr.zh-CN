...
- **监视源 IP 地址信誉**：Microsoft 365查询各种第三方 IP 阻止列表。 如果我们用于出站电子邮件的任何 IP 地址显示在这些列表中，将生成警报。 此监视允许我们在垃圾邮件导致信誉下降时快速做出响应。 生成警报时，我们具有内部文档，概述了如何从阻止列表中 (除名) IP 地址。
