...
在 Microsoft 365 Defender 门户中或在 PowerShell (Exchange Online PowerShell 中为在 Exchange Online 中拥有邮箱的 Microsoft 365 组织查看和管理隔离邮件;适用于没有邮箱的组织的独立 EOP PowerShellExchange Online邮箱) 。
