...
1. 在 Microsoft 365 Defender门户中 <https://security.microsoft.com/> ，转到"电子邮件&**协作** \> **攻击模拟培训** \> **模拟自动化"** 选项卡。
...
在" **选择社交工程** 技术"页上，选择一个或多个可用社交工程技术，这些技术由 [MITRE ATT&CK®设计](https://attack.mitre.org/techniques/enterprise/)。 不同的有效负载可用于不同的技术。 可以使用以下社交工程技术：
