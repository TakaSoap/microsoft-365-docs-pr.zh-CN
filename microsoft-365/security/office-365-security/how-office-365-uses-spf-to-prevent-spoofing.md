...
- _domain name_ 是您想要添加为合法发件人的域。有关 Office 365 应包含的域名列表，请参阅 [SPF 所需的外部 DNS 记录](https://docs.microsoft.com/office365/enterprise/external-domain-name-system-records)。
