...
|领域|任务|
|---|---|
|安全管理|<ul><li>通过使用安全分数和密码继续规划 <https://securescore.office.com> () 。</li><li>继续定期查看 Microsoft 365 Defender 门户、云应用安全和 SIEM 工具中的仪表板和报告。</li><li>继续查找和实施软件更新。</li><li>将电子数据展示集成到法律和威胁响应流程中。</li></ul>|
