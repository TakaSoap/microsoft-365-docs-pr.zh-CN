...
Microsoft 365 Defender 门户中提供了各种报告，可帮助你查看电子邮件安全功能（如 Microsoft 365 中的反垃圾邮件、反恶意软件和加密功能 <https://security.microsoft.com> ）如何保护你的组织。 如果您具有 [必要的权限](#what-permissions-are-needed-to-view-these-reports)，可以在 Microsoft 365 Defender 门户中查看这些报告，& \> **报告** 电子邮件& \> **协作报告**。 若要直接转到"电子邮件& **协作报告"** 页，请打开 <https://security.microsoft.com/emailandcollabreport> 。

![电子邮件&门户中的"电子邮件Microsoft 365 Defender报告"页](../../media/email-collaboration-reports.png)

> [!NOTE]
>
> 电子邮件和协作报告页面上 **的一些&需要使用** Microsoft Defender 进行Office 365。 有关这些报告的信息，请参阅查看 Office 365[门户中的Microsoft 365 Defender报告](view-reports-for-mdo.md)。
>
...
!["泄露用户"报告中的报告视图](../../media/compromised-users-report-activity-view.png)

## <a name="exchange-transport-rule-report"></a>Exchange传输规则报告

**"Exchange传输** 规则"报告显示邮件流规则对 (传入和传出) 传输规则的影响。
...
![Exchange"电子邮件和协作报告"页上的"&规则"小组件](../../media/transport-rule-report-widget.png)
...
!["电子邮件和协作报告"页面上电子邮件小部件&恶意软件检测](../../media/malware-detections-widget.png)
...
威胁 **防护状态报告** 在 EOP 和 Defender for Office 365;但是，报告包含不同的数据。 例如，EOP 客户可以查看有关电子邮件中检测到的恶意软件的信息，但无法查看有关 保险箱 Attachments 针对 SharePoint、OneDrive 和 Microsoft Teams 检测到的[恶意Microsoft Teams。](mdo-for-spo-odb-and-teams.md)
...
![威胁防护状态报告中网络钓鱼电子邮件和恶意软件电子邮件的传递状态视图](../../media/threat-protection-status-report-phishing-delivery-status-view.png)
...
- **反恶意软件引擎**：sharepoint、OneDrive 和 Microsoft Teams 中内置的 [病毒检测检测到的恶意](virus-detection-in-spo.md)Microsoft 365。
...
![威胁防护状态报告中的邮件替代和图表细分（按传递位置视图）](../../media/threat-protection-status-report-system-override-view-breakdown-by-delivery-location.png)
