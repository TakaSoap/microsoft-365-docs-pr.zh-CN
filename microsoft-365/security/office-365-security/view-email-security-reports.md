...
> [!IMPORTANT]
> 为了使用户报告的消息报告正常工作，必须为用户报告的环境启用Office 365日志记录。 通常是由在 Exchange Online 中分配为审核日志的角色执行。 有关详细信息，请参阅打开[Microsoft 365 审核日志或关闭搜索](../../compliance/turn-audit-log-search-on-or-off.md)。
