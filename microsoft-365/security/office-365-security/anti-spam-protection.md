...
- **验证您的组织设置**：查看允许邮件跳过垃圾邮件筛选的设置 (例如，如果您将自己的域添加到反垃圾邮件策略中的 "允许的域" 列表中) 。 有关我们推荐的设置，请参阅 [EOP And Office 365 ATP security 的推荐设置](recommended-settings-for-eop-and-office365-atp.md) 和 [创建安全发件人列表](create-safe-sender-lists-in-office-365.md)。
