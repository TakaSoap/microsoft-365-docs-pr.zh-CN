...
如果已部署"报告邮件"[](enable-the-report-message-add-in.md)加载项，或者用户使用[Outlook](report-junk-email-and-phishing-scams-in-outlook-on-the-web-eop.md)网页中的内置报告，可以在"用户提交"选项卡上查看报告的用户。 
