...
> [!IMPORTANT]
> 本文适用于拥有 [Microsoft Defender for Office 365](whats-new-in-defender-for-office-365.md)的企业客户。 如果你是一位家庭用户，正在查找有关 Outlook 中的附件扫描的信息，请参阅高级 Outlook.com [安全](https://support.microsoft.com/office/882d2243-eab9-4545-a58a-b36fee4a46e2)。

安全附件是 Microsoft [Defender for Office 365](whats-new-in-defender-for-office-365.md) 中的一项功能，该功能使用虚拟环境在 Exchange Online Protection [ (EOP) ](anti-malware-protection.md)中经过反恶意软件保护扫描之后，在发送给收件人之前，使用虚拟环境检查入站电子邮件中的附件。 有关详细信息，请参阅 [Microsoft Defender for Office 365](safe-attachments.md)中的安全附件。
...
> [!NOTE]
> 在安全附件设置的全局设置区域中，配置不依赖于安全附件策略的功能。 有关说明，请参阅在[Microsoft 365 E5](safe-docs.md)中打开[SharePoint、OneDrive](turn-on-mdo-for-spo-odb-and-teams.md)和 Microsoft Teams 的安全附件和安全文档。
...
- 有关安全附件策略的建议设置，请参阅 [安全附件设置](recommended-settings-for-eop-and-office365.md#safe-attachments-settings)。
...
4. 在出现的 **"** 设置"页上，配置以下设置：
   ...
   - **安全附件未知恶意软件响应**：选择下列值之一：
     ...
     这些值在安全附件 [策略设置中进行了介绍](safe-attachments.md#safe-attachments-policy-settings)。
...
若要验证安全附件是否正在扫描邮件，请检查可用的 Defender for Office 365 报告。 有关详细信息，请参阅[查看适用于 Office 365 的 Defender](view-reports-for-mdo.md)报告和使用安全与合规中心&[资源管理器。](threat-explorer.md)
