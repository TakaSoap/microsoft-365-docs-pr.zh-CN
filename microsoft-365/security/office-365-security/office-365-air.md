...
[Microsoft Defender for Office 365](defender-for-office-365.md)包括强大的自动调查和响应 (AIR) 功能，可节省安全运营团队的时间和精力。 触发警报时，由安全运营团队来审阅、确定警报优先级并响应这些警报。 保持传入警报的量可能会很不知所措。 自动执行其中一些任务可能会有所帮助。
...
|通知|Severity|警报的生成方式|
|---|---|---|
|检测到潜在恶意 URL 单击|**High**|发生以下任一情况时，将生成此警报： <ul><li>受组织[链接保险箱单击](safe-links.md)恶意链接的用户</li><li>URL 裁定更改由 Microsoft Defender for Office 365</li><li>用户保险箱组织的链接 (策略覆盖链接警告保险箱[页面](set-up-safe-links-policies.md)。</li></ul> <p> 有关触发此警报的事件详细信息，请参阅设置链接保险箱[策略](set-up-safe-links-policies.md)。|
...
|包含恶意软件的电子邮件在传递后被删除|**信息**|当包含恶意软件的任何电子邮件传递到您组织的邮箱时，将生成此警报。 如果发生此事件，Microsoft 会使用 ZAP Exchange Online零时差自动清除功能从 ([受感染) 。 ](zero-hour-auto-purge.md)|
...
|用户被限制发送电子邮件|**High**|当组织中有人被限制发送出站邮件时，将生成此警报。 此警报通常在电子邮件帐户 [受到威胁时产生](responding-to-a-compromised-email-account.md)。 <p> 有关受限用户详细信息，请参阅从"受限用户"门户中删除阻止[Microsoft 365。](removing-user-from-restricted-users-portal-after-spam.md)|
|
...
新的和改进的 Microsoft 365 Defender 门户将 Microsoft Defender for Office 365 和 Microsoft Defender for Endpoint 中的 AIR 功能 <https://security.microsoft.com> [汇集在一起](../defender-endpoint/automated-investigations.md)。 [](defender-for-office-365.md) 通过这些更新和改进，安全操作团队将能够在一处查看电子邮件、协作内容、用户帐户和设备中的自动调查和修正操作的详细信息。

> [!TIP]
> 新Microsoft 365 Defender门户取代了以下管理中心：
>
...
|**操作中心**|更新的操作 **中心** () 跨电子邮件、设备和标识将挂起和已完成 <https://security.microsoft.com/action-center> 的操作汇集在一起。 若要了解更多信息，请参阅操作中心。  (若要了解更多信息，请参阅操作 [中心](../defender/m365d-action-center.md).) |
