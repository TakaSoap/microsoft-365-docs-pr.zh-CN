...
作为 Exchange Online 或 Exchange Online Protection (EOP) 管理员，你可以帮助确保通过服务传递的电子邮件不会被标记为垃圾邮件。 若[要避免在 Office 365 中将电子邮件标记为垃圾邮件](prevent-email-from-being-marked-as-spam.md)，请参阅提示和过程的更新版本。
