...
> [!TIP]
> 强烈建议你启用多重身份验证 (MFA) 以防止入侵，尤其是对于具有管理权限的帐户。  你可以在[此处](https://support.office.com/article/Set-up-multi-factor-authentication-for-Office-365-users-8f0454b2-f51a-4d9c-bcde-2c48e41621c6)了解更多信息。
