...
最近，来自 Microsoft Defender for Office [365](office-365-atp.md#microsoft-defender-for-office-365-plan-1-and-plan-2) 计划 2 中的自动调查和响应功能的事件已添加到 Office 365 管理活动 API。 除了包含有关核心调查详细信息（如 ID、名称和状态）的数据之外，API 还包含有关调查操作和实体的高级别信息。
