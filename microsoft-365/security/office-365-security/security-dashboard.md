...
通过"威胁管理摘要"小组件，你可以一目了然地了解在过去七年 7 天内，组织如何 (威胁) 天。
...
详细信息取决于你的 Microsoft 365 订阅是否[Exchange Online Protection (](exchange-online-protection-overview.md) EOP) 或没有[Microsoft Defender for Office 365。](defender-for-office-365.md)
...
|在传递后删除|使用 [ZAP 的零时 ](zero-hour-auto-purge.md) 差自动清除 (删除) 数乘以收件人数|
|
...
若要了解更多信息，请参阅在 OFFICE 365 中开始使用[AIR (AIR) 自动调查和Office 365。](office-365-air.md)
