...
[安全&amp;合规性中心](../../compliance/go-to-the-securitycompliance-center.md)使您的组织能够管理数据保护和合规性。 如果您具有必要的权限，安全仪表板将使您能够查看威胁保护状态，并查看安全警报并对其采取措施。 
...
若要查看安全仪表板，请在 " [Office &amp; 365 安全合规中心](../../compliance/go-to-the-securitycompliance-center.md)" 中，转到 "**威胁管理** \> **仪表板**"。
