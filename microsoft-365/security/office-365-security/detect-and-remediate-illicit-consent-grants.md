...
>  
   ...
   - 审核记录在审核日志中保留和搜索的时间长度取决于您的 Office 365 订阅，以及分配给特定用户的许可证类型。 有关详细信息，请参阅[审核日志](../../compliance/search-the-audit-log-in-security-and-compliance.md)。
