...
完成上一步以将勒索软件有效负载从你的环境 (这将阻止勒索软件加密或删除你的文件) 后，可以使用 Windows 11、Windows 10、Windows 8.1 中的文件历史记录，并使用 Windows [](https://support.microsoft.com/help/17128) 7 中的系统保护尝试恢复你的本地文件和文件夹。
...
- [2021 Microsoft Digital Defense Report](https://www.microsoft.com/security/business/microsoft-digital-defense-report) (第 10-19 页) 
