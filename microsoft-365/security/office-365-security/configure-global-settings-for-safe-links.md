...
保险箱链接是 Microsoft [Defender for Office 365](defender-for-office-365.md)中的一项功能，可提供对邮件流中入站电子邮件的 URL 扫描，以及电子邮件和其他位置中 URL 和链接的单击验证时间。 有关详细信息，请参阅 microsoft [Defender for 保险箱 中的链接Office 365。](safe-links.md)
...
- " **阻止以下 URL"** 列表。 此设置适用于任何活动"链接"策略中包含的保险箱用户。 有关详细信息，请参阅"阻止[以下 URL"列表了解保险箱链接](safe-links.md#block-the-following-urls-list-for-safe-links)
- 保险箱链接应用Office 365保护。 这些设置适用于组织中获得 Defender for Office 365 许可的所有用户，无论这些用户是否包含在活动的 保险箱 链接策略中。 有关详细信息，请参阅保险箱[应用的链接Office 365设置](safe-links.md#safe-links-settings-for-office-365-apps)。

您可以在 保险箱 Microsoft 365 Defender 门户中或在 PowerShell (Exchange Online PowerShell 中为在 Exchange Online 中拥有邮箱的符合条件的 Microsoft 365 组织配置全局 Exchange Online 链接设置;独立 EOP PowerShell，适用于Exchange Online邮箱，但具有 Microsoft Defender for Office 365 加载项订阅的组织) 。

## <a name="what-do-you-need-to-know-before-you-begin"></a>开始前，需要知道什么？

- 由于没有内置或默认保险箱链接策略，因此您需要创建至少一个 保险箱 链接策略，以便"阻止以下 **URL"** 列表处于活动状态。 有关说明，请参阅在[Microsoft Defender 保险箱设置链接策略Office 365。](set-up-safe-links-policies.md)
...
- 在 Exchange Online 网站中 **分配** 权限，才能执行本文中的步骤：
  - 若要配置链接保险箱全局设置，您必须是组织管理或 **安全管理员角色组** 的成员。 
...
1. 在 Microsoft 365 Defender 门户中，转到"策略"&中的"电子邮件&协作策略"保险箱"链接 \>  \>  \> **"。**
...
## <a name="configure-safe-links-protection-for-office-365-apps-in-the-microsoft-365-defender-portal"></a>在 保险箱 门户中为 Office 365 应用配置Microsoft 365 Defender保护
...
2. 在 **"保险箱"** 页上，单击"**全局设置"。** 在 **保险箱"** 组织的链接策略"飞出部分，配置 设置 中适用于受支持应用部分中Office 365 **设置**：
   ...
   - **不允许用户** 单击到 Office 365 应用中的原始 URL：验证切换是否位于右侧，以防止用户单击到受支持的 Office 365 应用中的原始阻止的 URL： ![ 切换为打开 ](../../media/scc-toggle-on.png) 。

   完成时，请单击“保存”。

### <a name="configure-safe-links-protection-for-office-365-apps-in-powershell"></a>在 PowerShell 保险箱为 Office 365 应用配置链接保护

如果你希望使用 PowerShell 为 保险箱 应用配置 保险箱 Office 365 链接保护，请使用 Exchange Online PowerShell 或 Exchange Online Protection PowerShell 中的以下语法：
...
- 在 Microsoft 365 Defender 门户中，转到"策略"部分中的"电子邮件&协作策略"&"规则威胁策略保险箱链接"，单击"全局设置 \>  \>  \> **"，** 然后验证出现的飞出屏幕中的 \> 设置。 
