...
您可以在安全保险箱 &合规中心或 PowerShell (Exchange Online PowerShell 中为在 Exchange Online 中拥有邮箱的符合条件的 Microsoft 365 组织配置全局链接Exchange Online;独立 EOP PowerShell，适用于Exchange Online邮箱，但使用 Microsoft Defender for Office 365 加载项订阅的组织) 。
...
1. 在安全与&中心，转到"威胁管理策略 \>  \> **ATP** 保险箱链接"，然后单击"全局 **设置"。**

2. In the **保险箱 Links policy for your organization** fly out that appears， go to the Block the following **URLs** box.
...
## <a name="configure-safe-links-protection-for-office-365-apps-in-the-security--compliance-center"></a>在保险箱安全与合规中心Office 365应用配置 & 链接保护
...
2. 在 **保险箱"** 组织的链接策略"飞出屏幕中，配置设置电子邮件除外 **内容部分中的** 以下设置：

   - **Office 365应用程序**：验证切换是否位于右侧以启用支持的应用保险箱链接：Office 365 ![ 打开 ](../../media/scc-toggle-on.png) 。

   - **Do not track when users click 保险箱 Links**： Move the toggle to the left to track user clicks related to blocked URLs in supported Office 365 apps： Toggle off ![ ](../../media/scc-toggle-off.png) .
...
- 在安全&合规中心，转到"威胁管理策略 \>  \> **ATP** 保险箱链接"，单击"全局设置"，然后验证显示在飞出中的设置。
