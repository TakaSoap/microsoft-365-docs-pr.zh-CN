...
默认情况下，在反垃圾邮件策略中禁用最终用户垃圾邮件通知。 当管理员[启用最终用户垃圾邮件通知](configure-your-spam-filter-policies.md#configure-end-user-spam-notifications)时，收件人将收到有关被隔离为垃圾邮件的邮件、批量电子邮件或（截止到2020年4月）的网络钓鱼的定期通知。
