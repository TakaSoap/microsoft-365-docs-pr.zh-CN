...
|**数据丢失防护** <br/> 数据丢失防护策略匹配、误报和覆盖以及用于创建或编辑策略的链接|在安全 & 合规性中心中，转到 **数据丢失防护** \> **策略**|[查看数据丢失防护报告](../../compliance/view-the-dlp-reports.md)|
|**数据治理** <br/> 有关如何应用标签、分类为记录的标签、标签趋势等方面的信息|在安全 & 合规性中心中，转到 " **信息管理**" \> **仪表板**|[查看数据管理报告](../../compliance/view-the-data-governance-reports.md)|
|**威胁管理仪表板** (这也称为 "安全" 仪表板)   <br/> 威胁检测、恶意软件趋势、主要目标用户、有关发送和接收的电子邮件的详细信息等|在安全 & 合规性中心中，转到 " **威胁管理**" \> **仪表板**|[查看 Office 365 高级威胁防护报告](view-reports-for-atp.md)|
...
|**高级威胁防护和电子邮件安全报告** <br/> 电子邮件安全和威胁防护报告 (包括恶意软件、垃圾邮件、网络钓鱼和欺骗报告) |在安全 & 合规性中心中，转到 " **报告**" \> **仪表板**|[查看 Office 365 高级威胁防护报告](view-reports-for-atp.md) <br/><br/> [查看安全与合规中心内的电子邮件安全报告](view-email-security-reports.md)|
