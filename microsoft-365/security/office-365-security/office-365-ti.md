...
Microsoft 365 Defender门户中的威胁调查和响应功能是一组工具和响应工作流， <https://security.microsoft.com> 其中包括：
...
若要查看和使用此报告在 Microsoft 365 Defender门户中 <https://security.microsoft.com> ，请转到电子邮件 **&协作** \> **资源管理器**。 或者，若要直接转到资源管理器 **页面** ，请使用 <https://security.microsoft.com/threatexplorer> 。
...
To view and use this feature in the Microsoft 365 Defender portal at <https://security.microsoft.com> ， go to Email & **collaboration** Attack  >  **simulation training**. 或者，若要直接转到 **攻击模拟培训** 页面，请使用 <https://security.microsoft.com/attacksimulator?viewid=overview> 。
...
Microsoft Defender for Office 365使用基于角色的访问控制。 权限通过网站门户、Azure Active Directory门户Microsoft 365 管理中心或Microsoft 365 Defender角色分配。
...
|在事件中触发电子邮件操作 <p> 查找并删除可疑电子邮件|以下各项之一： <ul><li>**全局管理员**</li><li>**安全管理员** 以及 **搜索和清除** 角色</li></ul> <p> 全局 **管理员****和安全管理员** 角色可以分配给全局管理员Azure Active Directory () <https://portal.azure.com> 或 <https://admin.microsoft.com> Microsoft 365 管理中心 () 。 <p> 搜索 **和清除** 角色必须在 Microsoft 36  Defender 门户 & 电子邮件和协作角色中 <https://security.microsoft.com> () 。|
