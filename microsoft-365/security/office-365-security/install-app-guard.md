...
还可以配置适用于 Office 365 的 Microsoft Defender 以使用 Defender for Endpoint。 有关详细信息，请参阅将适用于 [Office 365](integrate-office-365-ti-with-wdatp.md)的 Defender 与 Microsoft Defender for Endpoint 集成。
