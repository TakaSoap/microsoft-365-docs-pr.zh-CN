...
ms.custom:
- seo-marvel-apr2020
description: 管理员可以了解如何使用安全与合规中心内"邮件流"仪表板中的"修复可能的邮件循环见解&识别和修复其组织的邮件循环。
ms.technology: mdo
...
ms.locfileid: "58563738"
---
# <a name="fix-possible-mail-loop-insight-in-the-security--compliance-center"></a>修复安全与合规中心&邮件循环见解
...
- 它们会浪费系统资源。
- 它们使用您组织的邮件卷配额。
- 它们向原始邮件发件人 (混淆的未送达报告或退回) 报告。

安全 **与** 合规中心内"邮件流"仪表板的"建议你 [](mail-flow-insights-v2.md)"[区域中的](https://protection.office.com)"修复可能的邮件循环见解"&在组织中检测到邮件循环时通知您。
