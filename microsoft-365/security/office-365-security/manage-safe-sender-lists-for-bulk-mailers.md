...
例如，假设航空公司 Blue Yonder Airlines 已经将 Margie's Travel 外包出去，从而发送电子邮件广告。 然后，您会在收件箱中收到一封来自发件人 blueyonder@news.blueyonderairlines.com 的邮件。 在这种情况下，5321地址为 blueyonder.airlines@margiestravel.com，blueyonder@news.blueyonderairlines.com 是5322.from。发件人地址是在 Outlook 中看到的。 由于服务考虑到 RFC 5322.from，以防止筛选出此邮件，因此可以在 Outlook 中将 RFC 5322.from （作为用户）添加到安全发件人，或者，如果您是管理员设置邮件流规则，如[反垃圾邮件中所示。"保护](anti-spam-protection.md)" 部分。
