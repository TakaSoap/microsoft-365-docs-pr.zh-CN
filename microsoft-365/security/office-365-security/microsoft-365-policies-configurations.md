...
- 与 Microsoft [安全分数](../mtp/microsoft-secure-score.md) 以及 Azure [AD](/azure/active-directory/fundamentals/identity-secure-score)中的标识分数一致，将增加组织的这些分数。
