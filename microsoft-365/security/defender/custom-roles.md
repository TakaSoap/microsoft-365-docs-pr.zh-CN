...
## <a name="manage-permissions-and-roles-in-the-microsoft-365-defender-portal"></a>在管理门户中管理Microsoft 365 Defender角色
还可以在管理门户中管理权限Microsoft 365 Defender角色：
...
| **需要以下角色之一才能Microsoft 365 Defender**  | **Defender for Endpoint 需要以下角色之一**  | **Defender for Office 365** | **需要以下角色之一才能云应用安全** | 
|---------|---------|---------|---------|
