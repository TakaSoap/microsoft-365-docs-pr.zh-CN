...
| Microsoft 云应用安全 | 识别并防御 Microsoft 和第三方云服务中的网络威胁 |
...
| Microsoft 云应用安全 | - 检测卷影 IT (未) <br />- 向云应用公开数据<br />- 与云应用关联的威胁活动 | 云应用 |
...
| Microsoft 云应用安全 | *无* | [快速入门：Microsoft Cloud App Security 入门](/cloud-app-security/getting-started-with-cloud-app-security) |

部署受支持的服务后，打开[Microsoft 365 Defender。](m365d-enable.md)
