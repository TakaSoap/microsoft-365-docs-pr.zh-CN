---
title: 部署支持的服务Microsoft 365 Defender
...
您部署的每个受支持的服务都提供一组极其丰富的原始信号和相关信息。 尽管有限的部署不会导致Microsoft 365 Defender功能关闭，但跨终结点、应用、数据和标识提供全面可见性的能力会受到影响。 同时，任何修正功能仅适用于可通过已部署的服务管理的实体。
