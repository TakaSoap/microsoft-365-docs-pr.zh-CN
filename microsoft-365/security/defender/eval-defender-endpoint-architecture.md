...
:::image type="content" source="../../media/defender/m365-defender-endpoint-architecture.png" alt-text="将 Microsoft Defender for Office添加到 Defender 评估环境的步骤" lightbox="../../media/defender/m365-defender-endpoint-architecture.png":::
...
概念 | 说明 | 更多信息
:---|:---|:---|
管理门户 | Microsoft 365 Defender门户，用于监视和协助响应潜在高级永久性威胁活动或数据泄露的警报。 | [Microsoft Defender for Endpoint 门户概述](/microsoft-365/security/defender-endpoint/portal-overview)
...
有关 Microsoft Defender for Endpoint 中包含的功能的更多详细信息，请参阅 [什么是 Microsoft Defender for Endpoint](/microsoft-365/security/defender-endpoint/microsoft-defender-endpoint)。
