...
如果[启用，Microsoft 365 Defender](m365d-enable.md)[自动调查和解决](m365d-autoir.md)通过自动化和人工智能的警报。 还可以执行其他修正步骤来解决攻击。 
...
1. 对于每个事件，开始 [攻击和警报调查和分析](investigate-incidents.md)：
   ...
   1. 使用"Microsoft 365 Defender"选项卡查看用户 [是如何](m365d-autoir.md)自动解决 **某些** 警报的。
...
使用 Microsoft Learn 中的此学习模块可了解如何使用 Microsoft 365 Defender管理事件和警报。
