---
title: 事件响应Microsoft 365 Defender
...
ms.locfileid: "62073732"
---
# <a name="incident-response-with-microsoft-365-defender"></a>事件响应Microsoft 365 Defender
...
您可以在快速启动 & 门户>**事件** 或事件管理事件Microsoft 365 Defender <a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">事件</a>。 下面是一个示例。
...
下面是一个使用 Microsoft 365 Defender 门户响应 Microsoft 365 中事件的示例工作流。
...
使用此 Microsoft Learn 的学习模块可了解如何使用Microsoft 365 Defender事件和警报。
