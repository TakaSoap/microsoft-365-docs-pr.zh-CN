...
在 &快速启动 Microsoft 365 Defender (**>** security.microsoft.com security.microsoft.com) ) 时，你可以管理事件 [security.microsoft.com) 。](https://security.microsoft.com) 下面是一个示例。
...
1. 对于每个事件，开始 [攻击和警报调查和分析](investigate-incidents.md)：
   ...
   1. 查看事件摘要，了解事件的范围和严重性以及受"摘要和事件预览"选项卡Graph (影响) 实体。  
