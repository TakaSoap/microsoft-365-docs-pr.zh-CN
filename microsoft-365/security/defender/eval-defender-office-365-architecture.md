...
description: Microsoft Defender for Office 365 for Microsoft 365 Defender 的技术图表将帮助你在构建试用实验室或Microsoft 365环境之前了解 microsoft Defender 中的标识。
...
|7      | Microsoft Defender for Office 365与 Microsoft 365 Defender 共享信号，以在 XDR (进行) 。|
...
|防欺骗保护     |   EOP 包括可帮助保护你的组织免受欺骗 (伪造) 攻击的功能。      |   [EOP 中的防欺骗防护](../office-365-security/anti-spoofing-protection.md)      |
