...
|报表|[Report](https://security.microsoft.com/emailandcollabreport)|||
...
[Microsoft 365 Defender](./overview-security-center.md)中提供了现有 Microsoft 安全门户（包括安全与合规中心）& <https://security.microsoft.com> 功能。 此改进的中心有助于安全团队更高效地保护组织免遭威胁侵害。

如果您熟悉安全与合规&中心 (protection.office.com) ，本文将介绍 Microsoft 365 Defender 中的一些更改和改进。

详细了解优势[：概述Microsoft 365 Defender](overview-security-center.md)
...
你可以从 Microsoft 365 Defender 左上角导航栏访问威胁分析，也可以从显示组织的主要威胁的专用仪表板卡片访问威胁分析。
...
此外，还包括指向安全与& **中心的链接** 进行比较。 最后一个链接是 **更新的"新增功能** 页面。
