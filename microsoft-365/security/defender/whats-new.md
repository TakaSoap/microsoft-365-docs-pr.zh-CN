...
-  (预览版) 现在可以使用事件功能链接将高级搜寻[](advanced-hunting-link-to-incident.md)查询结果中的事件或记录直接包含到正在调查的新事件或现有事件中。
...
- Microsoft 365 Defender
  ...
  改进的[Microsoft 365 Defender](https://security.microsoft.com)门户现已可用。 这一新体验将 Defender for Endpoint、defender for Office 365、Defender for Identity 等集成到单个门户中。 这是用于管理安全控制的新主页。 [了解新增功能](./microsoft-365-defender.md#the-microsoft-365-defender-portal)。
...
- [CloudAppEvents 表](advanced-hunting-cloudappevents-table.md)
  ...
  查找有关云应用和服务中事件的信息，Microsoft Cloud App Security。 此表还包括以前在表中可用的 `AppFileEvents` 信息。
