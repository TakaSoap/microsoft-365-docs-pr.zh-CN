...
- [CloudAppEvents 表](advanced-hunting-cloudappevents-table.md) <br>查找有关活动涵盖的各种云应用和服务中Microsoft Cloud App Security。 此表还包括之前在 中提供的信息 `AppFileEvents` 。
