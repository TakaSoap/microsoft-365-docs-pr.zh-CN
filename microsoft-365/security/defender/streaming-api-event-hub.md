---
title: 将Microsoft 365 Defender事件流式传输至 Azure 事件中心
...
1. 以 * <a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">Microsoft 365 Defender</a> **_** 或 _*_安全_ 管理员 ** 登录门户。
...
7. 若要将事件数据导出到单个事件中心，请输入事件中心 **名称和****事件中心资源 ID。**
   ...
   若要获取事件 **中心资源 ID，** 请转到 Azure 属性选项卡上的 Azure [](https://ms.portal.azure.com/)事件中心命名空间页面>复制资源  >  ID **下的文本**：
