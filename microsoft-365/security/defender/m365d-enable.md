...
Microsoft 365 Defender聚合已部署的各种受支持服务的数据。 它将集中处理和存储数据，以确定新的见解，并可能实现集中响应工作流。 它这样做不会影响与集成服务关联的现有部署、设置或数据。
...
![包含Microsoft 365 Defender事件管理Microsoft 365 Defender功能Microsoft 365 Defender门户的门户 ](../../media/overview-incident.png)
 *导航窗格的图像*

### <a name="getting-microsoft-defender-for-identity-data"></a>获取 Microsoft Defender for Identity 数据 
若要启用与 Microsoft Cloud App Security 集成，你至少需要登录Microsoft Cloud App Security一次。
