...
description: 检查设备Windows和其他设置上的审核设置，以确保在高级搜寻中获得最全面的数据
...
[高级搜寻](advanced-hunting-overview.md)依赖于来自各种源的数据，包括你的设备、Office 365工作区、Azure AD 和 Microsoft Defender for Identity。 若要尽可能获取最全面的数据，请确保在相应的数据源中具有正确的设置。
