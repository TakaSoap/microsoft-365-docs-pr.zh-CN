...
| 活动  | 说明 | Cadence | 已分配团队 |
|:-------|:-----|:-------|:-------|
| 服务管理与 SOC Teams   | 管理外围服务，如资产跟踪 (CMDB) 、应用程序许可 (新 SaaS 许可证) 、设备购买 (升级或续订设备部署) ，以及其他可能影响 Microsoft 365 Defender 产品的部署的 Microsoft 365 (租户范围的更改 (、Microsoft 365 和其他) 。 | 每周和根据需要   | 工程 & SecOps | 
