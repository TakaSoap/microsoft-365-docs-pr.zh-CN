...
了解有关预配和使用 [Microsoft 365 Defender](microsoft-365-defender.md)的许可和其他要求。
...
你必须是 **Azure** Active Directory 中的全局管理员或安全管理员才能启用 Microsoft 365 Defender。  有关使用 Microsoft 365 Defender 所需的角色列表以及如何控制对数据的访问权限的信息，请阅读有关管理对 [Microsoft 365 Defender 的访问权限](m365d-permissions.md)的信息。
