...
:::image type="content" source="../../media/mdo-eval/5_mdo-eval-pilot-policies.png" alt-text="在导航&电子邮件协作&quot;下，单击&quot;策略&规则&quot;。":::
...
8. 根据需要添加条件以将基线 ***MDO** _ 保护应用于特定试点用户或用户组。 单击_Next*继续。
    - 例如，如果收件人是定义的 Office 365 Standard Protection 组 Defender 的成员，然后只需通过组添加/删除帐户 *进行管理，* 则可能会应用适用于试点评估的 Defender for Office 365 条件。
...
应 *了解这些* 保护策略在应用和强制执行时所基于的优先级，这一点非常重要，如电子邮件保护的顺序和优先级- [Office 365说明。](../office-365-security/how-policies-and-protections-are-combined.md)
