...
| 监视团队 | 数据源正确馈送监控仪表板 | 第 1、2 层 SOC 分析员–监视&警报 | 用于报告安全与&安全分数的工作流 | [安全与合规&中的警报](/microsoft-365/security/office-365-security/alerts)  <br><br> 安全分数监视  | SOC 分析师没有报告成功的新网络钓鱼变体检测以提高安全分数的机制 <br><br> [安全与合规&中的报告](/microsoft-365/security/office-365-security/reports-and-insights-in-security-and-compliance)| 向报告工作流添加跟踪安全分数改进的流程 | 网络 | 
...
针对所有缺陷修正用例测试后，可以将所总结的经验和收集的指标纳入 SOC 团队的生产运行手册 (操作流程) 以及 (事件响应和上报过程) 中。 
