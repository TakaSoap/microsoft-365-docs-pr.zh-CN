...
在Windows 10版本 1703 及更高版本中，Windows Defender应用是 Windows 安全中心。
...
以下各节介绍如何在查看或与应用内威胁防护Microsoft Defender 防病毒交互时执行一些最常见的Windows 安全中心任务。
...
1. 打开"Windows 安全中心"应用，在"开始"菜单中搜索"安全"，然后选择 **"Windows 安全中心"。**
...
4. 将 **"实时保护"开关切换** 为 **"开"。**
    ...
    > 如果安装另一个防病毒产品，Microsoft Defender 防病毒自动禁用自身，并会在应用Windows 安全中心指示。 将显示一个设置，允许你启用 [有限定期扫描](limited-periodic-scanning-microsoft-defender-antivirus.md)。
