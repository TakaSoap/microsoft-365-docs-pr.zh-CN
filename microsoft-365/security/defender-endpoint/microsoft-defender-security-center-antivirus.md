...
有关[Windows 安全中心监视](/windows/threat-protection/windows-defender-security-center/windows-defender-security-center)的其他安全Windows，请参阅本文。
...
|**进程**|可执行文件路径 <br>例如：`c:\test\process.exe`|特定进程和由该进程打开的任何文件将被用户跳过Microsoft Defender 防病毒。|
|
...
## <a name="review-threat-detection-history-in-the-windows-defender-for-cloud-app"></a>查看云应用Windows Defender中的威胁检测历史记录
