...
在某些情况下，Microsoft Defender 防病毒称为 *"Endpoint Protection";* 但是，保护引擎是相同的。 尽管这些功能、配置和管理在 Microsoft Defender 防病毒 上Windows 10基本相同，[](microsoft-defender-antivirus-in-windows-10.md)但 Windows Server 上存在一些关键差异：
...
2. 当您进入向导的 **"功能**"步骤时，选择"Microsoft Defender 防病毒选项。 另外，选择 **"管理Windows Defender** GUI。
...
为了帮助确保安全性和性能，某些排除项将基于在 Microsoft Defender 防病毒 或 2019 上使用 Windows Server 2016 安装的角色和功能自动添加。
