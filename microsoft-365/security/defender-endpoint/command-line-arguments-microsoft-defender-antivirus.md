...
|`-Restore  [-ListAll \|[[-Name <name>] [-All] \|[-FilePath <filePath>]] [-Path <path>]]`|还原或列出已隔离项目 () |
...
|错误消息|可能的原因|
|---|---|
|**ValidateMapsConnection (800106BA** 或) **失败0x800106BA**|禁用Microsoft Defender 防病毒服务。 启用该服务，然后重试。 如果你需要有关重新启用Microsoft Defender 防病毒的帮助，请参阅[在终结点Microsoft Defender 防病毒/启用应用](switch-to-microsoft-defender-setup.md#reinstallenable-microsoft-defender-antivirus-on-your-endpoints)。<p> **提示**：在 Windows 10 1909 或更旧版本Windows Server 2019 或更旧版本中，该服务以前称为 *Windows Defender 防病毒。*|
...
|**MpCmdRun 无法识别为内部或外部命令、可操作程序或批处理文件。**|该工具必须从任一或 (`%ProgramFiles%\Windows Defender` 运行，其中可能有所不同，因为除 3 月之外，平台更新 `C:\ProgramData\Microsoft\Windows Defender\Platform\4.18.2012.4-0` `2012.4-0` 是每月) |
