...
|**配置Microsoft Defender 防火墙** 阻止未经授权的网络流量流入或流出组织设备 |[Microsoft Defender 防火墙高级安全管理Windows PowerShell](/windows/security/threat-protection/windows-firewall/windows-firewall-with-advanced-security-administration-with-windows-powershell) |
|**配置加密BitLocker，** 以保护组织中运行加密Windows |[BitLockerPowerShell 参考指南](/powershell/module/bitlocker/?view=win10-ps&preserve-view=true) |
