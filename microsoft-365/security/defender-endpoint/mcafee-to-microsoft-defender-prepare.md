...
**欢迎使用从 McAfee Endpoint Security ([McAfee) 迁移到 Defender for Endpoint 的"准备"阶段](mcafee-to-microsoft-defender-migration.md#the-migration-process)**。 
...
最佳做法是使组织的设备和终结点保持最新。 请确保您的 McAfee Endpoint Security (McAfee) 解决方案是最新的，并且组织的操作系统和应用也具有最新的更新。 现在执行此操作有助于防止以后迁移到 Defender for Endpoint 时出现问题。
...
**恭喜！** 你已完成从 McAfee 迁移到 Defender for Endpoint 的"准备["阶段](mcafee-to-microsoft-defender-migration.md#the-migration-process)！ 

- [继续为终结点设置 Defender。](mcafee-to-microsoft-defender-setup.md)
