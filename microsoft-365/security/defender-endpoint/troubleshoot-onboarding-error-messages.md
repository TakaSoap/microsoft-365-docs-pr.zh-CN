...
- 许可证已购买，但没有预配到此 Azure AD 实例。
    - 这可能是许可证预配问题。
    - 可能是您无意中将许可证预配到与用于Microsoft Azure AD身份验证不同的证书。
...
如果在访问Microsoft 365 Defender收到订阅 **已过期** 消息，联机服务订阅已过期。 与任何其他联机服务订阅一样，Microsoft Defender for Endpoint 订阅具有到期日期。 
