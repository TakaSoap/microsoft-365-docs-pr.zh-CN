...
- **[集中配置和管理与](#centralized-management)** Microsoft 365 Defender 门户，并Microsoft Endpoint Manager
...
通过Microsoft 365 Defender门户 () 可轻松访问有关检测到 [https://security.microsoft.com](https://security.microsoft.com) 的威胁和操作的信息，以应对这些威胁。 
