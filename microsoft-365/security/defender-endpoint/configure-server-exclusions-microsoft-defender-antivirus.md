...
本节列出了 Windows Server 2016 Server 2019 Windows Server 2022 中Windows角色的默认排除项。
...
- FRS 文件复制服务 (文件) 工作文件夹。 FRS 工作文件夹在注册表项中指定 `HKEY_LOCAL_MACHINE\System\CurrentControlSet\Services\NtFrs\Parameters\Working Directory`
