---
title: 使用基于角色的访问控制授予对门户的Microsoft 365 Defender访问权限
...
- **控制哪些人可以看到有关特定设备组的信息**
  - [按特定条件](machine-groups.md)（如名称、标记、域和其他条件）创建设备组，然后使用 Azure AD Azure Active Directory (用户组) 角色访问权限。
...
第一次登录 Microsoft 365 Defender门户时，将被授予完全访问权限或只读访问权限。 完全访问权限授予在 Azure AD 中具有安全管理员或全局管理员角色的用户。 只读访问权限授予在 Azure AD 中具有安全读者角色的用户。 
