...
- 确保自定义 **网络指示器在终结点Microsoft 365 Defender > 设置 >** 高级>**启用**。 有关详细信息，请参阅高级 [功能](advanced-features.md)。
...
> - 加密的 URL (完整路径) 只有在第一方浏览器或边缘 (Internet Explorer上) 
> - 加密的 URL (FQDN) 可以在第一方浏览器或边缘 (Internet Explorer外部阻止) 
> - 可以在域级别应用完整 URL 路径块，并应用所有未加密的 URL
>
> 延迟时间可能最多为 2 小时 (通常) 操作的时间与阻止的 URL 和 IP 之间的延迟更少。
