...
### [从非 Microsoft 端点安全解决方案切换到 Microsoft Defender for Endpoint]()
...
##### [DeviceIpmSoftwareInventoryVulnerabilities](advanced-hunting-devicetvmsoftwareinventoryvulnerabilities-table.md)
##### [DevicePvmSoftwareVulnerabilitiesKB](advanced-hunting-devicetvmsoftwarevulnerabilitieskb-table.md)
##### [DeviceIpmSecureConfigurationAssesment](advanced-hunting-devicetvmsecureconfigurationassessment-table.md)
##### [DeviceIpmSecureConfigurationAssessmentKB](advanced-hunting-devicetvmsecureconfigurationassessmentkb-table.md)
#### [自定义检测]()
