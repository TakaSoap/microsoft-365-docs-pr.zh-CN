...
|**Semi - 需要批准任何修正** <br/> (也称为半自动化 *)*| 对于这种半自动化级别，任何 *修正操作都需要* 获得批准。 此类待定操作可在操作中心中查看和批准 [，位于](auto-investigation-action-center.md)"挂起 **"选项卡** 上。<br/><br/>*默认情况下，对于在 2020 年 8 月 16 日之前使用 Microsoft Defender ATP 创建的租户（未定义设备组）选择此级别的半自动化。*|
