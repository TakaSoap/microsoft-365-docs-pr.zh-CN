...
ms.topic: conceptual
ms.technology: mde
ms.openlocfilehash: beaa793420aa839aacf645fd690165d77e2c5fc9
ms.sourcegitcommit: bef7bd019531317d083c1125f7d339750c450b2f
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/26/2021
ms.locfileid: "53588145"
---
...
1. 说明：列出你想要在组中覆盖的设备属性。 有关每个设备属性的详细信息， **请参阅上面的设备** 属性部分。
2. 选项：
    - PrimaryId
...
- 0：无
- 4：对此条目 **禁用 AuditAllowed** **和 AuditDenied。** 即使 **发生阻止** 且已配置 **AuditDenied** 设置，系统也不会显示通知。
...
此功能 (在 Microsoft Endpoint Manager 管理中心 () 设备配置文件 创建配置文件平台 <https://endpoint.microsoft.com/> \> \> \> \> ：Windows 10 及更高版本 & 配置文件：设备控制) 尚不可用。
