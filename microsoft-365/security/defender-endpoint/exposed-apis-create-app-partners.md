...
- 获取 (许可) 客户管理员同意你的应用程序访问所需的 Defender for Endpoint 资源。
- 使用此应用程序获取访问令牌。
...
2. 导航到 **Azure Active Directory** \> **应用注册""** \> **新注册"**。
   ...
   :::image type="content" source="images/atp-azure-new-app2.png" alt-text="导航到应用程序注册窗格" lightbox="images/atp-azure-new-app2.png":::
...
3. 在注册表单中：
   ...
   - 重定向 URI - 类型：Web、URI： https://portal.azure.com
     ...
     :::image type="content" source="images/atp-api-new-app-partner.png" alt-text="&quot;Microsoft Azure合作伙伴应用程序注册&quot;页" lightbox="images/atp-api-new-app-partner.png":::
...
4. 允许应用程序访问 Microsoft Defender for Endpoint，并为其分配完成集成所需的最低权限集。
   ...
   - **注意**： *WindowsDefenderATP* 不会显示在原始列表中。 开始在文本框中写入其名称，以查看其显示。
     ...
     :::image type="content" source="images/add-permission.png" alt-text="&quot;添加权限&quot;选项" lightbox="images/add-permission.png":::
...
1. 选择 **应用程序权限** \> **Alert.Read.All** >添加 **权限上选择**
   ...
   :::image type="content" source="images/application-permissions.png" alt-text="允许添加权限的选项" lightbox="images/application-permissions.png":::

2. 选择 **"授予同意"**

   - **注意**：每次添加权限时，都必须选择"授予 **新** 权限的许可"才能生效。

   :::image type="content" source="images/grant-consent.png" alt-text="允许授予同意的选项" lightbox="images/grant-consent.png":::
...
3. 向应用程序添加密码。
    ...
    **重要** 提示：单击"添加" **后，复制生成的机密值**。 离开后将无法检索！
     ...
     :::image type="content" source="images/webapp-create-key2.png" alt-text="创建应用密钥" lightbox="images/webapp-create-key2.png":::

4. 记下应用程序 ID：

   - 在应用程序页上，转到" **概述"** 并复制以下信息：

     :::image type="content" source="images/app-id.png" alt-text="创建应用程序的 ID" lightbox="images/app-id.png":::
...
5. 将应用程序添加到客户的租户。
   ...
   :::image type="content" source="images/app-consent-partner.png" alt-text="&quot;接受&quot;按钮" lightbox="images/app-consent-partner.png":::
...
- 复制/粘贴应用程序中的以下 (请不要忘记更新三个变量：`tenantId``appId`、和 `appSecret`) 
...
:::image type="content" source="images/webapp-decoded-token.png" alt-text="令牌验证页" lightbox="images/webapp-decoded-token.png":::
