...
对于 macOS 和 Linux 设备，你可以选择通过 Microsoft Defender for Endpoint 进行载出。 In the navigation pane， select **设置** \> **Offboard** \> **Select Operating System to start the offboarding Process**.
