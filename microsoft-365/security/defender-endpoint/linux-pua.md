...
---
# <a name="detect-and-block-potentially-unwanted-applications-with-microsoft-defender-for-endpoint-for-linux"></a>使用 Microsoft Defender for Endpoint for Linux 检测并阻止可能不需要的应用程序
