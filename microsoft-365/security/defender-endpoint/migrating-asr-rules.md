...
description: 介绍如何从第三方主机入侵防护系统迁移， (HIPS) 迁移到 ASR 规则。
...
- **其他推荐功能**- 若要阻止用户启动特定进程或程序，建议Windows Defender应用程序控制。 Microsoft Defender for Endpoint File and Cert indicators， can be used in an Incident Response scenario (an application control mechanism) .
