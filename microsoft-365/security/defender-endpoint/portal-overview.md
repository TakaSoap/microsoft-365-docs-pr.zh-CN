...
Enterprise安全团队可以使用Microsoft Defender 安全中心监视和协助响应潜在高级永久性威胁活动或数据泄露的警报。
...
**(2) 搜索、Community中心、本地化、帮助和支持、反馈** | **搜索** - 按设备、文件、用户、URL、IP、漏洞、软件和建议进行搜索。 </br></br> **Community中心**- 访问Community中心，了解、协作和共享产品体验。 </br></br>  **本地化** - 设置时区。 </br></br>  **帮助和支持** - 访问适用于终结点的 Defender 指南、Microsoft 和 Microsoft Premier 支持、许可证信息、模拟 & 教程、适用于终结点的 Defender 评估实验室，请咨询威胁专家。</br></br> **反馈** - 提供有关您喜欢或我们可以更好地执行哪些工作的评论。
...
![应用程序防护事件图标](images/atp-Application-Guard-events-icon.png)| Windows Defender 应用程序防护事件
![Device Guard 事件图标](images/atp-Device-Guard-events-icon.png)| Windows Defender Device Guard事件
![攻击防护事件图标](images/atp-Exploit-Guard-events-icon.png)| Windows Defender攻击防护事件
![SmartScreen 事件图标](images/atp-Smart-Screen-events-icon.png)| Windows DefenderSmartScreen 事件
