...
ms.locfileid: "64476656"
---
# <a name="remediate-vulnerabilities-with-threat-and-vulnerability-management"></a>使用安全代码修正危险和漏洞管理
...
Microsoft Defender for Endpoint 中的 危险和漏洞管理 功能通过修正请求工作流填补了安全和 IT 管理员之间的空白。 安全管理员（如你可以请求 IT 管理员将漏洞从安全建议页面修正到 Intune）

### <a name="enable-microsoft-intune-connection"></a>启用Microsoft Intune连接

若要使用此功能，请启用Microsoft Intune连接。 在 Microsoft 365 Defender 门户中，导航到设置 \> **高级功能** \> **"**。 向下滚动并查找Microsoft Intune **连接**。 默认情况下，切换处于关闭状态。 打开连接 **Microsoft Intune****打开。**
...
如果你想要检查票证在 Intune 中的显示方式，请参阅使用 [Intune 修正由 Microsoft Defender for Endpoint](/intune/atp-manage-vulnerabilities) 标识的漏洞，了解详细信息。
...
:::image type="content" source="../../media/remediation-flyouteolswnew.png" alt-text="&quot;修正&quot;页，包含所选的修正活动，以及列出说明、IT 服务和设备管理工具以及设备修正的活动的飞出页" lightbox="../../media/remediation-flyouteolswnew.png":::
...
:::image type="content" source="images/tvm-completed-by.png" alt-text="由具有两行的列创建和完成" lightbox="images/tvm-completed-by.png":::

### <a name="top-remediation-activities-in-the-dashboard"></a>仪表板中的热门修正活动

查看 **威胁和** 漏洞 [管理仪表板 **中的热门修正** 活动](tvm-dashboard-insights.md)。 选择任意条目以转到"修正 **"** 页。 可以在 IT 管理员团队修正任务后将修正活动标记为已完成。

:::image type="content" source="images/tvm-remediation-activities-card.png" alt-text="Top 修正活动卡片" lightbox="images/tvm-remediation-activities-card.png":::
