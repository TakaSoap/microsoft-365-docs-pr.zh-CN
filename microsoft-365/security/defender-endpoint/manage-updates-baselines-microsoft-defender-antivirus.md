...
Microsoft Defender 防病毒 [使用云](cloud-protection-microsoft-defender-antivirus.md) 提供的保护 (也称为 Microsoft 高级保护服务或 MAPS) 并定期下载安全智能更新以提供保护。
...
云提供的保护始终打开，并且需要与 Internet 的活动连接以正常运行。 安全智能更新按计划节奏进行， (策略策略配置) 。 有关详细信息，请参阅在 Microsoft Defender 防病毒中使用 Microsoft 云 [提供的保护](cloud-protection-microsoft-defender-antivirus.md)。 

有关最近安全智能更新的列表，请参阅 Microsoft Defender 防病毒和其他 Microsoft 反 [恶意软件的安全智能更新](https://www.microsoft.com/en-us/wdsi/defenderupdates)。

引擎更新包含在安全智能更新中，并按月发布。

## <a name="product-updates"></a>产品更新

Microsoft Defender 防病毒需要每月更新 [ (KB4052623](https://support.microsoft.com/help/4052623/update-for-windows-defender-antimalware-platform))  (称为平台更新 *) ，* 并且将接收 Windows 10 版本旁边的主要功能更新。
...
- 用于将 Microsoft 和 Windows 更新部署到网络中终结点的常用方法。

有关详细信息，请参阅管理 [Microsoft Defender 防病毒保护更新的源](/mem/configmgr/protect/deploy-use/endpoint-definitions-wsus#to-synchronize-endpoint-protection-definition-updates-in-standalone-wsus)。
...
<br/>
<details>
<summary> 2021 年 4 月 (平台：4.19.2104.9|引擎：1.1.18100.5) </summary>
...
<details>
<summary> 2021 年 3 月 (平台：4.19.2103.7 |引擎：1.1.18000.5) </summary>
...
<summary> 2021 年 2 月 (平台：4.19.2102.3 |引擎：1.1.17900.7) </summary>
...
- Shellcode 攻击检测改进
- 提高了凭据窃取尝试的可见性
- Microsoft Defender 防病毒服务中的反威胁功能的改进
- 改进了对 x64 ARM的支持
...
&ensp;安全智能更新版本 **：1.325.10.0**  
&ensp;发布时间 **：2020 年 10 月 1 日**  
&ensp;平台 **：4.18.2009.7**  
&ensp;引擎 **：1.1.17500.4**  
&ensp;支持阶段 **：仅支持 (升级)**
...
&ensp;安全智能更新版本 **：1.323.9.0**  
&ensp;发布时间 **：2020 年 8 月 27 日**  
&ensp;平台 **：4.18.2008.9**  
&ensp;引擎 **：1.1.17400.5**  
&ensp;支持阶段 **：仅支持 (升级)**
...
- [DisableAntiSpyware](/windows-hardware/customize/desktop/unattend/security-malware-windows-defender-disableantispyware) 将被忽略。 Microsoft Defender 防病毒在检测到其他防病毒程序时自动关闭自身。
...
&ensp;安全智能更新版本 **：1.321.30.0**  
&ensp;发布时间 **：2020 年 7 月 28 日**  
&ensp;平台 **：4.18.2007.8**  
&ensp;引擎 **：1.1.17300.4**  
&ensp;支持阶段 **：仅支持 (升级)**
...
&ensp;安全智能更新版本 **：1.319.20.0**  
&ensp;发布时间 **：2020 年 6 月 22 日**  
&ensp;平台 **：4.18.2006.10**  
&ensp;引擎 **：1.1.17200.2**  
&ensp;支持阶段 **：仅支持 (升级)**
...
&ensp;安全智能更新版本 **：1.317.20.0**  
&ensp;发布时间 **：2020 年 5 月 26 日**  
&ensp;平台 **：4.18.2005.4**  
&ensp;引擎 **：1.1.17100.2**  
&ensp;支持阶段 **：仅支持 (升级)**
...
&ensp;安全智能更新版本 **：1.315.12.0**  
&ensp;发布时间 **：2020 年 4 月 30 日**  
&ensp;平台 **：4.18.2004.6**  
&ensp;引擎 **：1.1.17000.2**  
&ensp;支持阶段 **：仅支持 (升级)**
...
&ensp;安全智能更新版本 **：1.313.8.0**  
&ensp;已发布 **：2020 年 3 月 24 日**  
&ensp;平台 **：4.18.2003.8**  
&ensp;引擎 **：1.1.16900.4**  
&ensp;支持阶段 **：仅支持 (升级)**
...
### <a name="known-issues"></a>已知问题
[**Fixed**]Microsoft Defender 防病毒在运行扫描时跳过文件。
...
&ensp;安全智能更新版本 **：1.311.4.0**   
&ensp;发布时间 **：2020 年 2 月 25 日**  
&ensp;平台/客户端： **-**  
&ensp;引擎 **：1.1.16800.2**  
&ensp;支持阶段 **：仅支持 (升级)**
...
[**修复**] 使用现代待机模式 [的设备](/windows-hardware/design/device-experiences/modern-standby) 可能会遇到与Windows Defender筛选器驱动程序的挂起，导致保护间隙。  受影响的计算机向客户显示尚未更新到最新的反恶意软件平台。  
<br/>
> [!IMPORTANT]
> 此更新为：
...
> - 因重启要求而分类为更新;和
> - 仅与 Windows 更新 [一起提供](https://support.microsoft.com/help/4027667/windows-10-update)。
<br/>
</details>
...
### <a name="known-issues"></a>已知问题
安装此更新后，设备需要跳转程序包 4.10.2001.10 才能更新到最新的平台版本。
<br/>
</details>
...
### <a name="platform-version-included-with-windows-10-releases"></a>Windows 10 版本中包含的平台版本
下表提供了最新 Windows 10 版本附带的 Microsoft Defender 防病毒平台和引擎版本：    
...
&ensp;程序包版本 **：1.1.2105.01**    
&ensp;平台版本 **：4.18.2103.7**   
&ensp;引擎版本 **：1.1.18100.6**  
&ensp;签名版本 **：1.339.42.0**    
...
&ensp;程序包版本 **：1.1.2104.01**    
&ensp;平台版本 **：4.18.2102.4**   
&ensp;引擎版本 **：1.1.18000.5**  
&ensp;签名版本 **：1.335.232.0**    
...
&ensp;程序包版本 **：1.1.2103.01**    
&ensp;平台版本 **：4.18.2101.9**   
&ensp;引擎版本 **：1.1.17800.5**  
&ensp;签名版本 **：1.331.2302.0**    
...
&ensp;程序包版本 **：1.1.2102.03**    
&ensp;平台版本 **：4.18.2011.6**   
&ensp;引擎版本 **：1.1.17800.5**  
&ensp;签名版本 **：1.331.174.0**    
...
&ensp;程序包版本 **：1.1.2101.02**    
&ensp;平台版本 **：4.18.2011.6**   
&ensp;引擎版本 **：1.1.17700.4**  
&ensp;签名版本 **：1.329.1796.0**    
...
&ensp;程序包版本 **：1.1.2012.01**    
&ensp;平台版本 **：4.18.2010.7**   
&ensp;引擎版本 **：1.1.17600.5**  
&ensp;签名版本 **：1.327.1991.0**    
...
&ensp;程序包版本 **：1.1.2011.02**    
&ensp;平台版本 **：4.18.2010.7**   
&ensp;引擎版本 **：1.1.17600.5**  
&ensp;签名版本 **：1.327.658.0**    
...
&ensp;程序包版本 **：1.1.2011.01**    
&ensp;平台版本 **：4.18.2009.7**  
&ensp;引擎版本 **：1.1.17600.5**  
&ensp;签名版本 **：1.327.344.0**    
...
&ensp;程序包版本 **：1.1.2011.01**    
&ensp;平台版本 **：4.18.2008.9**   
&ensp;引擎版本 **：1.1.17400.5**  
&ensp;签名版本 **：1.327.2216.0**    
