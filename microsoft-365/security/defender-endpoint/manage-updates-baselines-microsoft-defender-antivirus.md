...
- Microsoft Defender 防病毒已针对加载恶意 DLL 进行了强化
...
### <a name="whats-new"></a>最近更新
- 为可移植设备Windows控制支持
- 默认情况下， (PUA) 保护功能中可能不需要的应用程序为使用者打开 (看到默认情况下，可能不需要的应用[](https://support.microsoft.com/windows/potentially-unwanted-apps-will-be-blocked-by-default-b9f53cb9-7f1e-40bb-8c6b-a17e0ab6289e)将被阻止) 
