...
description: 使用组策略在 Windows 10设备上部署配置包，以便它们可以载入到服务。
...
1. 打开 GP 配置包.zip文件 *(WindowsDefenderATPOnboardingPackage.zip)* 从服务载入向导下载的内容。 还可以从门户获取[Microsoft 365 Defender包](https://security.microsoft.com/)：
