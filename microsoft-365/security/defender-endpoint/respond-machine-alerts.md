...
选择"运行 **防病毒** 扫描"之一，选择要快速或完整 (的扫描类型) 在确认扫描之前添加注释。
...
在Windows 10版本 1709 或更高版本上，你将对网络隔离级别进行其他控制。 还可以选择启用Outlook、Microsoft Teams和Skype for Business连接 (，例如&quot;选择性隔离") 。
