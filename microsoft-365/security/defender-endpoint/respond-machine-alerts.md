...
|WindowsSMB 会话 (服务器) 块|列出对文件、打印机和串行端口的共享访问以及网络上节点之间的其他通信。 这可以帮助识别数据外排或横向移动。 <p> 包含 SMBInboundSessions 和 SMBOutboundSession 的文件。 <p> <div class="alert"><b>注意：</b> 如果入站或出站 (会话) ，将获取一个文本文件，告知您未找到 SMB 会话。</div>|
...
> [!IMPORTANT]
>
> - 完全隔离适用于 Windows 10 版本 1703、Windows Server 2019 和 Windows Server 2022 上的设备。
> - 选择性隔离适用于 Windows 10 版本 1709 或更高版本、Windows Server 2019 和 Windows Server 2022 上的设备。
