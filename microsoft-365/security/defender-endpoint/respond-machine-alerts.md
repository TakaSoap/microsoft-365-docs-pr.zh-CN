...
> - 对于非Windows平台， (设备隔离) 等响应功能依赖于第三方功能。
...
>[!IMPORTANT]
>- 此操作适用于 Windows 10 版本 1709 或更高版本、Windows Server 2019、Windows Server 2016 和 Windows Server 2012 R2 的设备。
...
>[!IMPORTANT]
> - 此操作适用于 Windows 10 版本 1709 或更高版本以及 Windows Server 2016。 
...
在Windows 10版本 1709 或更高版本上，您将可以更加控制网络隔离级别。 还可以选择启用 Outlook、Microsoft Teams 和 Skype for Business 连接 (&quot;选择性隔离") 。
