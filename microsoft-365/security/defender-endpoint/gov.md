...
ms.topic: conceptual
ms.technology: mde
ms.openlocfilehash: 45837853935f9870b2a2cbe3e37e87b40b3f6f8c
...
Windows 10，版本 1709 | ![不支持](images/svg/check-no.svg)<br />注意：将不受支持 | ![是 ](images/svg/check-yes.svg) ，包含 [KB4499147](https://support.microsoft.com/help/4499147)<br />注意： [已弃用，](/lifecycle/announcements/revised-end-of-service-windows-10-1709)请升级 | ![不支持](images/svg/check-no.svg)<br />注意：将不受支持
Windows 10版本 1703 及更早版本 | ![不支持](images/svg/check-no.svg)<br />注意：将不受支持 | ![不支持](images/svg/check-no.svg)<br />注意：将不受支持 | ![不支持](images/svg/check-no.svg)<br />注意：将不受支持
...
Android | ![不支持](images/svg/check-no.svg) 开发中 | ![不支持](images/svg/check-no.svg) 开发中 | ![不支持](images/svg/check-no.svg) 开发中
iOS | ![不支持](images/svg/check-no.svg) 开发中 | ![不支持](images/svg/check-no.svg) 开发中 | ![不支持](images/svg/check-no.svg) 开发中
...
功能名称 | GCC | GCC 高 | DoD
:---|:---|:---|:---
网络发现 | ![不支持](images/svg/check-no.svg) 开发中 | ![不支持](images/svg/check-no.svg) 开发中 | ![不支持](images/svg/check-no.svg) 开发中
Web 内容筛选 | ![不支持](images/svg/check-no.svg) 开发中 | ![不支持](images/svg/check-no.svg) 开发中 | ![不支持](images/svg/check-no.svg) 开发中
集成：Azure Sentinel | ![是](images/svg/check-yes.svg) | ![是](images/svg/check-yes.svg) 警报 <br /> ![不支持](images/svg/check-no.svg) 原始数据&事件：开发中 | ![是](images/svg/check-yes.svg) 警报 <br /> ![不支持](images/svg/check-no.svg) 原始数据&事件：开发中
集成：Microsoft Cloud App Security | ![是](images/svg/check-yes.svg) | ![否](images/svg/check-no.svg) 开发中 | ![不支持](images/svg/check-no.svg) 开发中
集成：Microsoft 合规性管理器 | ![是](images/svg/check-yes.svg) | ![是](images/svg/check-yes.svg) | ![是](images/svg/check-yes.svg)
集成：Microsoft Defender for Identity | ![不支持](images/svg/check-no.svg) 即将推出 | ![不支持](images/svg/check-no.svg) 即将推出 | ![不支持](images/svg/check-no.svg) 即将推出
集成：Microsoft Endpoint DLP | ![不支持](images/svg/check-no.svg) 开发中 | ![不支持](images/svg/check-no.svg) 开发中 | ![不支持](images/svg/check-no.svg) 开发中
集成：Microsoft Power Automate & Azure 逻辑应用 | ![是](images/svg/check-yes.svg) | ![是](images/svg/check-yes.svg) | ![是](images/svg/check-yes.svg) Azure 逻辑应用 <br /> ![不支持](images/svg/check-no.svg) Power Automate：开发中
Microsoft 威胁专家 | ![不支持](images/svg/check-no.svg) 工程积压工作 | ![不支持](images/svg/check-no.svg) 工程积压工作 | ![不支持](images/svg/check-no.svg) 工程积压工作
