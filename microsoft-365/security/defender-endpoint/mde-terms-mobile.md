...
1. **INSTALLATION AND USE RIGHTS.**
    ...
    c) **第三方组件。** 本软件可能包含第三方组件，并附带单独的法律声明或受其他协议约束，如 ThirdPartyNotices 文件 (软件) 所述。
    ...
    e) **竞争基准。** 如果你是直接下属，并且你访问或使用该软件进行竞争基准、分析或智能收集，则你可以针对 Microsoft、其子公司及其附属公司 (包括潜在) 在管理软件使用条款范围内管理软件的条款中的任何竞争使用、访问和基准测试限制， 或声称比 Microsoft 条款更加严格。 如果你不放弃在管理软件的条款中任何此类声称的限制，则不允许你访问或使用本软件，并且不会这样做。
...
1. **法律合规性。** 你表示 (保证) 你所在的国家/地区不受美国政府犯罪限制，或已被美国政府指定为"支持者"的国家/地区;和 (b) 未列在任何美国政府禁止方或受限方列表中。
