...
1. **SUPPORT SERVICES.** 根据本协议，Microsoft 不要求为该软件提供任何支持服务。 Any support provided is “as is”, “with all faults”, and without warranty of any kind. 你确认 Apple 没有任何义务提供有关该软件的任何维护和支持服务。
