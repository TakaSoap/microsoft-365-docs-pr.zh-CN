...
![Azure Power Automate &徽标的图像](images/ms-flow-logo.png)|[Power Automate & Azure 函数](https://go.microsoft.com/fwlink/?linkid=2114300)|使用 Defender for Endpoint 连接器进行Azure 逻辑应用 & Power Automate自动化安全过程
...
## <a name="security-orchestration-and-automation-response-soar-integration"></a>SOAR 集成的安全业务流程 (自动化) 响应
...
你可以从提供程序和聚合器使用威胁情报来维护和使用 ICS (泄露) 。
