...
![Azure Functions Microsoft Flow &图像。](images/ms-flow-logo.png)|[Microsoft Flow & Azure 函数](https://go.microsoft.com/fwlink/?linkid=2114300)|使用 Defender for Endpoint 连接器实现Azure 逻辑应用 & Microsoft Flow自动化安全过程
...
![Vectra Network Detection and Response (NDR) 图像。](images/vectra-logo.png)|[Vectra 网络检测和响应 (NDR) ](https://go.microsoft.com/fwlink/?linkid=866934)|Vectra 将 AI &安全研究，以实时检测和响应网络攻击
...
![Zimperium 徽标的图像。](images/zimperium-logo.png)|[Zimperium](https://go.microsoft.com/fwlink/?linkid=2118044)|使用基于移动威胁防护的基于 机器学习将 Defender for Endpoint 扩展到 iOS 和 Android
