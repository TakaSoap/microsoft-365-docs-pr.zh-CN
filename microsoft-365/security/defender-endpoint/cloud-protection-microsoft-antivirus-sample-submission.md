...
Microsoft Defender 防病毒和云保护通过以下方法自动阻止大多数在首次看到时从未看到过的新威胁：
...
:::image type="content" source="images/cloud-protection-metadata-sample.png" alt-text="图 2.发送到 Microsoft Defender 云保护的元数据示例":::
