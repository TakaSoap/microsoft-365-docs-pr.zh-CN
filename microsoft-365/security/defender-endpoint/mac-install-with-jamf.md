---
title: 使用 Jamf 方法在 macOS 上部署 Microsoft Defender for Endpoint Pro
description: 使用 Jamf 方法在 macOS 上部署 Microsoft Defender for Endpoint Pro
...
ms.locfileid: "59196028"
---
# <a name="deploying-microsoft-defender-for-endpoint-on-macos-with-jamf-pro"></a>使用 Jamf 方法在 macOS 上部署 Microsoft Defender for Endpoint Pro
...
> [!NOTE]
> 如果你使用的是 macOS Catalina (10.15.4) 或较新版本的 macOS，请参阅 [macOS Catalina](/microsoft-365/security/defender-endpoint/mac-sysext-policies)和较新版本的 macOS 的新配置文件。
