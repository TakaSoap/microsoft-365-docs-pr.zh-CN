...
ms.locfileid: "64469220"
---
# <a name="prevent-users-from-seeing-or-interacting-with-the-microsoft-defender-antivirus-user-interface"></a>阻止用户查看用户界面或Microsoft Defender 防病毒交互
...
:::image type="content" source="../../media/wdav-headless-mode-off-1703.png" alt-text="没有Windows 安全中心图标以及病毒和威胁防护部分的内容" lightbox="../../media/wdav-headless-mode-off-1703.png":::

将设置设置为"已 **禁用"** 或未配置：

:::image type="content" source="../../media/wdav-headless-mode-1703.png" alt-text="具有Windows 安全中心图标和威胁防护部分的内容" lightbox="../../media/wdav-headless-mode-1703.png":::
...
:::image type="content" source="../../media/wdav-headless-mode-1607.png" alt-text="在早于 1703 Windows 10启用无头模式的警告消息" lightbox="../../media/wdav-headless-mode-1607.png":::
...
5. 双击启用 **无头 UI 模式** 设置，将该选项设置为 **已启用**。 单击“确定”。
...
4. 展开树以Windows **扫描Microsoft Defender 防病毒** \>  \> **组件**。

5. 双击"允许用户 **暂停扫描"** 设置，将该选项设置为 **"已禁用"**。 单击“确定”。
