...
- 在 Microsoft 365 Defender 门户中管理防篡改保护时，该设置将应用于租户范围，从而影响运行 Windows 10、Windows Server 2016 或 Windows Server 2019 的所有设备。 若要微调防篡改 (例如某些设备对防篡改保护，但其他设备) ，请使用 [Intune](#manage-tamper-protection-for-your-organization-using-intune) 或 [Configuration Manager 和租户附加](#manage-tamper-protection-for-your-organization-with-configuration-manager-version-2006)。
...
如果你是组织安全团队的一员，并且订阅包含[Intune，](/intune/fundamentals/what-is-intune)可以在 (上或) 上为组织在 Microsoft Endpoint Manager 管理中心 ([https://endpoint.microsoft.com](https://endpoint.microsoft.com)) 上打开防篡改保护。 当你想要微调防篡改保护设置时，请使用 Intune。 例如，如果你希望在某些设备上（而不是所有设备）启用防篡改保护，请使用 Intune。
...
- 你的Windows设备必须在 OS [1709](/windows/release-health/status-windows-10-1709)Windows 10 [1803、1809](/windows/release-health/status-windows-10-1803)或更高版本上运行。 [](/windows/release-health/status-windows-10-1809-and-windows-server-2019)  (有关版本详细信息，请参阅 Windows 10 release [information](/windows/release-health/release-information).) 
...
### <a name="are-you-using-windows-server-2016-or-windows-version-1709-1803-or-1809"></a>是否使用的是Windows Server 2016 1709 Windows 1803 或 1809 版本？
...
> [!NOTE]
> 该过程可用于将防篡改保护扩展到运行 Windows 10 Windows Server 2019 的设备。 请务必查看此过程中提到的资源的先决条件和其他信息。
...
2. In the [Microsoft Endpoint Manager admin center，](https://go.microsoft.com/fwlink/?linkid=2109431)go to **Endpoint security**  >  **Antivirus**， and then choose **+ Create Policy**. 
   ...
   - 在配置文件 **列表中**，选择Windows 安全中心 **预览 (体验) 。** <br/>
...
如果使用 Configuration Manager 版本 2006 和租户附加，篡改保护可以扩展到 Windows Server 2019。 请参阅 [租户附加：从管理中心创建 ](/mem/configmgr/tenant-attach/deploy-antivirus-policy)和部署终结点安全防病毒策略 (预览) 。
