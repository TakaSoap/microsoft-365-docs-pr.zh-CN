...
|使用 Configuration Manager 为 (启用) 或关闭篡改保护|[使用 Configuration Manager 版本 2006 的租户附加管理组织的防篡改保护](#manage-tamper-protection-for-your-organization-with-configuration-manager-version-2006)|
...
- 在 Microsoft 365 Defender 门户中管理篡改保护时，该设置将应用于租户范围，从而影响运行 Windows 10、Windows Server 2016 或 Windows Server 2019 的所有设备。 若要微调防篡改保护 (例如某些设备对防篡改保护，但其他设备) ，请使用 [Intune](#manage-tamper-protection-for-your-organization-using-intune) 或 [Configuration Manager 和租户附加](#manage-tamper-protection-for-your-organization-with-configuration-manager-version-2006)。
...
- 你的设备必须使用反恶意软件平台版本 4.18.2010.7 (或) 及) 及以上版本的反恶意软件引擎 1.1.17600.5 (。  ([管理Microsoft Defender 防病毒更新和应用](manage-updates-baselines-microsoft-defender-antivirus.md)比较基准 .) 
...
如果你是组织安全团队的一员，并且订阅包含[Intune，](/intune/fundamentals/what-is-intune)可以在 () 上或 Microsoft Endpoint Manager 管理中心中为组织关闭防篡改 [https://endpoint.microsoft.com](https://endpoint.microsoft.com) () 。 当你想要微调防篡改保护设置时，请使用 Intune。 例如，如果你希望在某些设备上（而不是所有设备）启用防篡改保护，请使用 Intune。
...
- 你的Windows设备必须Windows 10操作系统[1709、1803、1809](/windows/release-health/status-windows-10-1709)或更高版本[](/windows/release-health/status-windows-10-1809-and-windows-server-2019)。 [](/windows/release-health/status-windows-10-1803)  (有关版本详细信息，请参阅 Windows 10 release [information](/windows/release-health/release-information).) 

- 必须使用安全Windows，安全智能更新到版本[](https://www.microsoft.com/wdsi/definitions)1.287.60.0 (或) 。

- 你的设备必须使用反恶意软件平台版本 4.18.1906.3 (或) 以及反恶意软件引擎版本 1.1.15500.X (或) 以上版本。  ([管理Microsoft Defender 防病毒更新和应用](manage-updates-baselines-microsoft-defender-antivirus.md)比较基准 .) 
...
如果使用的是具有租户附加的 Configuration Manager 版本 2006，则防篡改保护可以扩展到 Windows Server 2019。 请参阅 [租户附加：从管理中心创建 ](/mem/configmgr/tenant-attach/deploy-antivirus-policy)和部署终结点安全防病毒策略 (预览) 。

### <a name="will-tamper-protection-affect-non-microsoft-antivirus-registration-in-the-windows-security-app"></a>篡改保护是否会影响非 Microsoft 防病毒注册在 Windows 安全中心 应用中？
...
组策略不适用于篡改保护。 打开防篡改Microsoft Defender 防病毒对设置所做的更改将被忽略。
...
[使用适用于Windows保护Endpoint Protection电脑Microsoft Intune](/intune/help-secure-windows-pcs-with-endpoint-protection-for-microsoft-intune)
