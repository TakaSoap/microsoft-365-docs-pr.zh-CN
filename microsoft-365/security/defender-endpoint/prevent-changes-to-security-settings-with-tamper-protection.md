...
篡改保护不会阻止您查看安全设置。 而且，防篡改保护不会影响非 Microsoft 防病毒应用向 Windows 安全中心 注册。 如果组织使用 Windows 10 企业版 E5，则单个用户不能更改防篡改保护设置;在这种情况下，防篡改保护由安全团队进行管理。
...
|打开或关闭 (设备的防篡改) 或关闭篡改保护|[在单个设备上管理篡改保护](#manage-tamper-protection-on-an-individual-device)|
...
- 目前，对于新部署，Microsoft 365 Defender门户中管理篡改保护的选项处于打开状态。 对于现有部署，可选择性地使用防篡改保护。 若要选择加入，在 Microsoft 365 Defender <a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">门户</a>中 **，设置** \> **终结点** \> **高级功能** \> **篡改保护"。**

- 使用 Microsoft 365 Defender门户管理篡改保护时，不需要使用 Intune 或租户附加方法。

- 在 Microsoft 365 Defender 门户中管理防篡改保护时，该设置将应用于租户范围，从而影响运行 Windows 10、Windows 10 企业版 多会话、Windows 11、Windows 11 Enterprise 多会话、Windows Server 2012 R2、Windows Server 2016、Windows Server 2019 或 Windows Server 2022。 若要微调防篡改保护 (例如某些设备对防篡改保护，但对另一些设备) ，请使用 [Intune](#manage-tamper-protection-for-your-organization-using-intune) 或 [Configuration Manager 及租户附加](#manage-tamper-protection-for-your-organization-with-configuration-manager-version-2006)。
...
- 你的设备必须使用反恶意软件平台版本 4.18.2010.7 (或) 及 (或) 及以上的反恶意软件引擎版本 1.1.17600.5。  ([管理Microsoft Defender 防病毒更新和应用比较基准](manage-updates-baselines-microsoft-defender-antivirus.md).) 
...
- 你的Windows必须运行操作系统[1709](/windows/release-health/status-windows-10-1709)Windows 11 Windows 10 [1803、1809](/windows/release-health/status-windows-10-1803)或[](/windows/release-health/status-windows-10-1809-and-windows-server-2019)更高版本。  (有关版本详细信息，请参阅 Windows 10 release [information](/windows/release-health/release-information).) 

- 必须使用安全Windows更新到版本 1.287.60.0 或 (或) 。 [](https://www.microsoft.com/wdsi/definitions)

- 你的设备必须使用反恶意软件平台版本 4.18.1906.3 (或) 以及反恶意软件引擎版本 1.1.15500.X (或) 以上版本。  ([管理Microsoft Defender 防病毒更新和应用比较基准](manage-updates-baselines-microsoft-defender-antivirus.md).) 
...
当检测到篡改尝试时，Microsoft 365 Defender门户[](/microsoft-365/security/defender-endpoint/portal-overview) () 。 [https://security.microsoft.com](https://security.microsoft.com)
...
若要了解有关威胁和漏洞&管理，请参阅威胁&漏洞管理[Microsoft 365 Defender。](/microsoft-365/security/defender-endpoint/tvm-dashboard-insights#threat--vulnerability-management-in-microsoft-defender-security-center)
...
如果使用的是具有租户附加的 Configuration Manager 版本 2006，则防篡改保护可以扩展到 Windows Server 2012 R2、Windows Server 2016、Windows Server 2019 和 Windows Server 2022。 请参阅 [租户附加：从管理中心创建 ](/mem/configmgr/tenant-attach/deploy-antivirus-policy)和部署终结点安全防病毒策略 (预览) 。
...
### <a name="can-i-configure-tamper-protection-with-microsoft-endpoint-configuration-manager"></a>我能否配置防篡改保护Microsoft Endpoint Configuration Manager？
...
[使用适用于Windows保护Endpoint Protection Microsoft Intune](/intune/help-secure-windows-pcs-with-endpoint-protection-for-microsoft-intune)
