...
ms.topic: article
ms.technology: mde
ms.openlocfilehash: 1fa254f9c7c63d3cd4e5a7a9ccbb2723e01c9966
ms.sourcegitcommit: c2d752718aedf958db6b403cc12b972ed1215c00
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/26/2021
ms.locfileid: "58568608"
---
...
- **使用 Microsoft Defender 为终结点配置Microsoft Endpoint Configuration Manager**
...
在Microsoft Endpoint Configuration Manager控制台中，载入过程将配置为控制台内的合规性设置的一部分。
...
5.  在 **"直接** 成员身份向导"上单击"下一步 **"，** 然后单击"**编辑查询语句"。**
     ...
     ![Microsoft Endpoint Configuration Manager wizard5 的图像。](images/configmgr-direct-membership.png)
...
9. 选择“**下一步**”。
    ...
    ![向导 9 Microsoft Endpoint Configuration Manager的图像。](images/configmgr-confirm.png)
...
从 Microsoft 365 Defender 门户中，可以下载可用于在 System Center Configuration Manager 中创建策略的".onboarding"策略，Windows 10部署该策略。
...
2. 在"部署方法"下，选择 **支持的版本** Microsoft Endpoint Configuration Manager。
...
16.  在 Microsoft Endpoint Configuration Manager控制台中，右键单击你刚刚创建的 Defender for Endpoint 策略，**然后选择部署**。
...
1. 从 Microsoft 365 Defender 门户中，设置设备管理 (下选择" ( >    >  **终结点** 载入) 。
...
4. 安装Microsoft Monitoring Agent (MMA) 。 <br>
...
4. 通过单击下一步确认新的攻击 **防护策略**。
    ...
    ![Microsoft Endpoint Configuration Manager 2 的图像。](images/0a6536f2c4024c08709cac8fcf800060.png)
...
5. 创建策略后，单击"关闭 **"。**
    ...
    ![控制台 1 Microsoft Endpoint Manager映像。](images/95d23a07c2c8bc79176788f28cef7557.png)
