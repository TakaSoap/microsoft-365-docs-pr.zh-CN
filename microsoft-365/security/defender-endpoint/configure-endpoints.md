...
|<ul><li> Windows 7 SP1 </li> <li>  Windows 7 SP1 Pro </li> <li>  Windows 8.1 专业版 </li> <li> Windows 8.1 企业版</li></ul>  | [Microsoft Monitoring Agent (MMA) ](onboard-downlevel.md) <br><br> **注意**：Microsoft Monitoring Agent现在为 Azure Log Analytics 代理。 若要了解更多信息，请参阅 [Log Analytics 代理概述](/azure/azure-monitor/platform/log-analytics-agent)。
 ...
 (<a id="fn1">1</a>) Windows Server 2016和 Windows Server 2012 R2 将需要按照 Onboard [Windows 中的说明进行载入](configure-server-endpoints.md#windows-server-2012-r2-and-windows-server-2016)。
...
[使用 Microsoft Endpoint Configuration Manager 载入设备](configure-endpoints-sccm.md)|可以使用 Microsoft Endpoint Manager () 版本 1606 或 Microsoft Endpoint Manager (当前分支) 版本 1602 或更早版本在设备上部署配置包。
