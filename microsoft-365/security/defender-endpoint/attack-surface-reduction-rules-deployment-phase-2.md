...
ms.locfileid: "62074506"
---
# <a name="asr-rules-deployment-phase-2-test"></a>ASR 规则部署阶段 2：测试
...
8. [可选]在 **范围标记窗格中** ，你可以将标记信息添加到特定设备。 您还可以使用基于角色的访问控制和范围标记，以确保适当的管理员对正确的 Intune 对象具有适当的访问权限和可见性。 了解更多： [使用基于角色的访问控制 (RBAC](/mem/intune/fundamentals/scope-tags)) Intune 中分布式 IT 的作用域标记。
...
>[!Note]
>如果你拥有 Microsoft Defender 365 E5 (或 Windows E5？) 许可证，此链接将打开 Microsoft Defender 365 报告>攻击面减少 >[配置](https://security.microsoft.com/asr?viewid=configuration)"选项卡。
...
## <a name="use-windows-event-viewer-review-as-an-alternative-to-the-attack-surface-reduction-rules-reporting-page-in-the-microsoft-365-defender-portal"></a>使用Windows查看事件查看器"作为攻击面减少规则报告页面（在 Microsoft 365 Defender 门户中）的替代方法
