...
1. 以 * [Microsoft 365 Defender](https://security.microsoft.com) **_** 或 _*_安全_ 管理员 **登录安全帐户。
...
1. 登录[以Microsoft 365 Defender并](https://security.microsoft.com)转到高级[搜寻页面](https://security.microsoft.com/hunting-package)。
