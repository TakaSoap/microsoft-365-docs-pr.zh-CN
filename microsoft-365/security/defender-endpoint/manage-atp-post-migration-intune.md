...
我们建议使用[Microsoft Endpoint Manager](/mem)，其中包括 Microsoft Intune (Intune) 来管理组织的威胁防护功能， (也称为终结点) 。 [详细了解Endpoint Manager。](/mem/endpoint-manager-overview)
