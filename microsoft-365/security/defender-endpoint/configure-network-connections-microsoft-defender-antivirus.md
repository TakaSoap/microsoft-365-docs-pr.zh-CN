...
> [!TIP]
> 请访问 Microsoft Defender for Endpoint[](https://demo.wd.microsoft.com?ocid=cx-wddocs-testground)演示网站，demo.wd.microsoft.com 确认以下功能是否正常工作：
>
> - 云端保护
> - 快速学习 (包括首次看到时阻止) 
> - 可能不需要的应用程序阻止
...
有关详细信息，请参阅使用命令行Microsoft Defender 防病毒[管理mpcmdrun.exe。](command-line-arguments-microsoft-defender-antivirus.md)
