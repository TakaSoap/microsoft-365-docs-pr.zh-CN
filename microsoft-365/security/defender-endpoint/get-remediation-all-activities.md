...
priority|字符串|为此修正活动设置的创建者设置的优先级 (高\中\低) |High
...
relatedComponent|字符串|此修正活动的相关组件 (安全建议计划的相关组件) |Microsoft Silverlight
