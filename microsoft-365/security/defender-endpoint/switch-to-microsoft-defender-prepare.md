...
Microsoft 365 Defender门户 () 是访问和配置 [https://security.microsoft.com](https://security.microsoft.com) Defender for Endpoint 的特性和功能的地方。 若要了解更多信息，请参阅门户[Microsoft 365 Defender概述](use.md)。
