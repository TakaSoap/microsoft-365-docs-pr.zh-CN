...
ms.openlocfilehash: 88742470e4ebb9f25ec8dad3419f659bf6e23b45
ms.sourcegitcommit: 4af23696ff8b44872330202fe5dbfd2a69d9ddbf
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 11/30/2021
ms.locfileid: "61221478"
---
...
|操作系统|指南|
|---|---|
|Windows 10或更高版本<br/><br/>Windows Server 2022<br/><br/>Windows Server 2019<br/><br/>Windows Server 版本 1803 或更高版本<br/><br/>Windows Server 2016<br/><br/>Windows Server 2012 R2|请参阅 [运行检测测试](run-detection-test.md)。<br/><br/>请访问 Defender for Endpoint 演示方案站点 () <https://demo.wd.microsoft.com> 并尝试一个或多个方案。 例如，尝试 **云提供的保护演示** 方案。|
...
|Windows 安全中心应用|1. 在Windows上，打开Windows 安全中心应用。<br/><br/>2. 选择 **病毒&威胁防护。**<br/><br/>3. **Who保护我？** 选择管理 **提供程序**。<br/><br/>4. 在"**安全提供程序"** 页上的"**防病毒**"下 **，Microsoft Defender 防病毒"打开"。**|
