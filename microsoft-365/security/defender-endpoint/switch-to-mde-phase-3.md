...
|Windows 安全中心应用|1. 在Windows上，打开Windows 安全中心应用。<br/><br/>2. 选择 **病毒&威胁防护**。<br/><br/>3. Who **保护我？"下，** 选择"**管理提供程序"**。<br/><br/>4. 在"**安全提供程序**"页上的"**防病毒**"下，Microsoft Defender 防病毒 **"已打开。**|
...
> 若要了解有关被动模式和主动模式的详细信息，请参阅有关[被动Microsoft Defender 防病毒的详细信息](microsoft-defender-antivirus-compatibility.md#more-details-about-microsoft-defender-antivirus-states)。
...
现在，你已载入 Defender for Endpoint，并且已卸载以前的非 Microsoft 解决方案，下一步是确保 Defender for Endpoint 正常工作。 执行此任务的一个好方法就是访问 Defender for Endpoint 演示方案 [https://demo.wd.microsoft.com](https://demo.wd.microsoft.com) 站点 () 。 尝试该页面上的一个或多个演示方案，包括以下方案：
