...
ms.topic: article
ms.technology: mde
ms.openlocfilehash: 2362f5c3e0dc9e54421b608e337d00dbb3437f5c
ms.sourcegitcommit: af575ade7b187af70f94db904b03f0471f56452a
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/26/2021
ms.locfileid: "53591041"
---
...
希望体验 Microsoft Defender for Endpoint？ [注册免费试用版](https://www.microsoft.com/microsoft-365/windows/microsoft-defender-atp?ocid=docs-wdatp-main-abovefoldlink)。
...
当你将设备添加到你的环境时，Defender for Endpoint 会设置具有连接详细信息的配置良好的设备。 可以在 Server 2019 Windows 10或Windows服务器。
...
2. 选择要添加的设备类型。 可以选择在 Server 2019 Windows 10或Windows服务器。
...
3. 将显示连接详细信息。 选择 **"** 复制"保存设备的密码。
    ...
    :::image type="content" source="../../media/add-machine-eval-lab-new.png" alt-text="使用连接详细信息添加的设备的图像":::
