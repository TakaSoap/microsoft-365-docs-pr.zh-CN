---
title: 受支持的安全服务提供商
description: 请参阅与以下项Microsoft Defender for Endpoint MSSP 列表
...
![Aujas 徽标的图像。](images/aujas-logo.png) | [Aujas 托管 MDE 服务](https://go.microsoft.com/fwlink/?linkid=2162429) | Aujas 网络安全在整个企业范围中提供 24*7 托管安全服务，Microsoft Defender for Endpoint网络防御中心进行保护。
...
:::image type="content" source="images/bt-logo.png" alt-text="!BT 徽标的图像。":::|[来自 BT 的托管终结点 Microsoft](https://www.globalservices.bt.com/en/solutions/solution/endpoint-security-and-protection-solutions)| 多年来，我们一直在自我保护，此专长使我们能够开发用于保护 Microsoft 客户的独特交易。 我们将在我们的全球安全操作中心中对Microsoft Defender for Endpoint资产进行 24x7x365 监控。
![云徽标Defender for Cloud图像。](images/cloudsecuritycenter-logo.png)| [云Defender for Cloud](https://go.microsoft.com/fwlink/?linkid=2099315) | InSpark 的云Defender for Cloud是一项 24x7 托管服务，可提供保护、检测&响应功能
...
![eSentire 日志的图像。](images/esentire-logo.png) | [eSentire 托管检测和响应](https://go.microsoft.com/fwlink/?linkid=2154970) | 通过安全机制进行 24x7 威胁调查和Microsoft Defender for Endpoint。
![徽标图像。](images/expel-logo.png)| [适用于托管的检测与响应Microsoft Defender for Endpoint](https://go.microsoft.com/fwlink/?linkid=2162430) | 通过检测安全机制中的安全风险，Microsoft Defender for Endpoint。
![Mandiant 徽标的图像。](images/mandiant-logo.png) | [针对 MDR 的 (防御) MDR Microsoft Defender for Endpoint](https://go.microsoft.com/fwlink/?linkid=2164352) | 通过 24/7 的一线 MDR 智能和来自 Mandiant 的专业知识来验证 Defender for Endpoint。
...
![sepagoSOC 徽标的图像。](images/sepago-logo.png)| [sepagoSOC](https://go.microsoft.com/fwlink/?linkid=2090491) | 通过开发环境中复杂的自动化工作流确保零信任的安全性
...
![零信任分析平台 (ZTAP) 图像。](images/ztap-logo.png)| [零信任分析平台 (ZTAP) ](https://go.microsoft.com/fwlink/?linkid=2090971) | 将警报减少 99%，并访问移动设备中的全部安全性功能
