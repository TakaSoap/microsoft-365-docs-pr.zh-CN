...
有关详细信息，[请参阅在](/intune/device-restrictions-configure)Intune 中Microsoft Intune配置Microsoft Defender 防病毒[设备限制Windows 10设置](/intune/device-restrictions-windows-10#microsoft-defender-antivirus)。 
