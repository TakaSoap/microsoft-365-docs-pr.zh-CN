...
> [!IMPORTANT]
> 2020 年 3 月 31 Microsoft Defender 防病毒，将删除更新合规性报告功能。 你可以继续使用 Microsoft Endpoint Manager[定义和](https://www.microsoft.com/microsoft-365/microsoft-endpoint-manager)查看安全合规性策略，从而可以更精细地控制安全功能和更新。
...
有关与更新合规性不相关的 Microsoft Defender 防病毒 服务相关的常见错误代码和事件 ID，请参阅Microsoft Defender 防病毒[事件](troubleshoot-microsoft-defender-antivirus.md)。
