...
> - 如果终结点在版本 1607 Windows 10版本运行，Windows 10[诊断数据必须设置为增强级别](/windows/configuration/configure-windows-diagnostic-data-in-your-organization#enhanced-level)。
> - 已满足所有要求 3 天
