...
本文介绍如何使用 Ansible 部署适用于 Linux 的 Defender for Endpoint。 成功的部署需要完成以下所有任务：
...
在开始使用之前，请参阅适用于 Linux 的 [Defender for Endpoint](microsoft-defender-endpoint-linux.md) 主页，了解当前软件版本的先决条件和系统要求说明。
