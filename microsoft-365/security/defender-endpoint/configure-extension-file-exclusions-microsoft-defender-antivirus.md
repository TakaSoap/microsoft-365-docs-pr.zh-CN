...
- 不包括重新分析在启动 Microsoft Defender 防病毒 服务后创建且已添加到排除列表的文件夹。 重新启动服务 (重新启动Windows) 新的重新分析点，以识别为有效的排除目标。
...
> [!NOTE]
> 检查 MpCmdRun 的排除项需要 Microsoft Defender 防病毒 CAMP 版本 4.18.2110-5.0 (2021 年 10 月) 或更高版本。
