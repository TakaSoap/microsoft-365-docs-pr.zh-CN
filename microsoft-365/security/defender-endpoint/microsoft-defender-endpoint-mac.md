...
添加排除项时，请注意适用于 Microsoft Defender 防病毒[的常见排除](/microsoft-365/security/defender-endpoint/common-exclusion-mistakes-microsoft-defender-antivirus)
