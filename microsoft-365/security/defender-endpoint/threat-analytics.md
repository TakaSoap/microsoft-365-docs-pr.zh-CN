...
:::image type="content" source="images/ta_dashboard.png" alt-text="威胁分析仪表板" lightbox="images/ta_dashboard.png":::

## <a name="view-a-threat-analytics-report"></a>查看威胁分析报告

每个威胁分析报告提供三个部分的信息： **概述**、分析员 **报告** 以及 **缓解**。
...
:::image type="content" source="images/ta-overview.png" alt-text="威胁分析报告的概述部分" lightbox="images/ta-overview.png":::
_威胁分析报告的概述部分_
...
本节中的缓解信息包含来自 [危险和漏洞管理 的数据，](next-gen-threat-and-vuln-mgt.md)其中还提供了报告中各个链接的详细深化信息。

:::image type="content" source="images/ta-mitigations.png" alt-text="威胁分析报告的缓解部分" lightbox="images/ta-mitigations.png":::
...
- 数据的范围基于基于角色的访问控制 (RBAC) 作用域。 你将看到可以访问的组中 [设备的状态](machine-groups.md)。
