...
- **对于注册的设备**：
    - 设备 ([设备) 通过](/mem/intune/user-help/enroll-your-device-in-intune-ios)应用注册Intune 公司门户强制执行 Intune 设备合规性策略。 这要求向最终用户分配一个Microsoft Intune许可证。
...
可以在 iOS 上部署 Microsoft Defender for Endpoint，Microsoft Endpoint Manager (MEM) 且受监督设备及不受监督的设备均受支持。 最终用户还可以直接从 Apple 应用商店 [安装应用](https://aka.ms/mdatpiosappstore)。
