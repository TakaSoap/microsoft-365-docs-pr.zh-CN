...
现在，可以使用上述Microsoft Defender 防病毒在 R2 和 Windows Server 2012 2016 上以被动模式运行。 有关详细信息，请参阅安装 [Microsoft Defender for Endpoint 的选项](configure-server-endpoints.md#options-to-install-microsoft-defender-for-endpoint)。
