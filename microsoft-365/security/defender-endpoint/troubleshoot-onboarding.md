...
> [!IMPORTANT]
> 以下仅适用于尚未收到 2020 年 8  月 (版本 4.18.2007.8) 更新的设备Microsoft Defender 防病毒。
>
...
> [!IMPORTANT]
> `disableAntiSpyware`从 (年 8 月版本 4.18.2007.8 开始，该设置将停止使用，并且将在所有 Windows 10 设备上忽略) 更新到 Microsoft Defender 防病毒。
...
1. 在应用程序Microsoft Endpoint Configuration Manager。
...
4. 指定有关软件中心的信息，然后选择"下一步 **"**。
    ...
    ![配置 4 Microsoft Endpoint Configuration Manager的图像。](images/mecm-4.png)
...
22. 在 **"内容"中** ，选择"下一 **步"**。
    ...
    ![Microsoft Endpoint Configuration Manager配置23 的图像。](images/mecm-23.png)
...
27. 在 **"摘要"中**，选择"下一 **步"**。
    ...
    然后，状态将显示"配置![Microsoft Endpoint Configuration Manager的图像29。](images/mecm-29.png)
