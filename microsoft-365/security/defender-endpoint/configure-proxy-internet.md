...
Microsoft Defender 防病毒[云提供的保护](cloud-protection-microsoft-defender-antivirus.md)可提供近乎即时的自动化保护，以抵御新的和新出现的威胁。 请注意，当 Defender 防病毒[是活动的反](manage-indicators.md)恶意软件解决方案时，自定义指示器需要连接;和[，EDR阻止模式](edr-in-block-mode.md)，即使使用非 Microsoft 解决方案作为主要的反恶意软件解决方案。
...
>
> 仅在运行版本 1803 或更高版本Windows包含 v20 的 URL 才需要。 例如，对于运行版本 1803 或Windows并载入到美国数据安全中心区域的设备 `us-v20.events.data.microsoft.com` ，存储。
>
