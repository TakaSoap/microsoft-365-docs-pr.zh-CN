...
- [Office 365 中的默认安全](secure-by-default.md)
- 自动调查改进：针对手动触发的电子邮件调查的常规警报、将邮箱更改视为单独的实体类别、删除冗余 URL 阻止操作，以及创建出站电子邮件群集以用于用户遭到入侵的调查。

## <a name="november-2020"></a>2020 年 11 月

- Review > Action Center > Remediation from Mail Submission and Action Log (Defender for Office 365 Plan 2 中更新了导出) 

## <a name="septemberoctober-2020"></a>2020 年 9 月/10 月

- [使用配置分析器检查策略](configuration-analyzer-for-security-policies.md)
- 威胁资源管理器中的扩展功能，包括主要目标用户、传输规则和连接器[ (](threat-explorer.md#new-features-in-threat-explorer-and-real-time-detections)威胁资源管理器[ (](threat-explorer.md)电子邮件中的 Office 365 Defender 信息，租户/用户策略)  (Defender for Office 365 计划 2) 
...
- [Microsoft](threat-explorer.md#improvements-to-threat-hunting-experience) Defender for Office 365 计划 1 或 (2 计划的搜寻体验改进) 
...
- 适用于[Office 365](campaigns.md)的 Microsoft Defender 中的市场活动视图的 (Microsoft Defender for Office 365 计划 2) 
...
- " **事件"** 小部件现在是"操作 **中心"小部件** 。  (若要查看安全小组件，在安全与&合规中心，转到威胁管理审查 \> .)  (Microsoft Defender for Office 365 计划 2) 

- [Microsoft 365 安全](safe-docs.md)文档 **(预览)**

## <a name="december-2019"></a>2019 年 12 月

- [使用](threat-explorer.md#new-features-in-threat-explorer-and-real-time-detections) Microsoft Defender for Office 365 计划 1 或 (2 导出 URL 单击数据进行脱机) 

- [使用 Microsoft Defender for Office 365 中的市场活动视图 (**预览** 版)  (](campaigns.md) Microsoft Defender for Office 365 计划 2) 
...
- [使用 Office 365](/office/office-365-management-api/office-365-management-activity-api-schema#office-365-advanced-threat-protection-and-threat-investigation-and-response-schema) 管理活动 API 与 Microsoft Defender for Office 365 自动调查和响应事件集成 (Defender for Office 365 计划 2) 

- [查看电子邮件头，并下载](investigate-malicious-email-that-was-delivered.md) Microsoft Defender for Office 365 (计划 1 或计划 2 电子邮件) 

## <a name="august-2019"></a>2019 年 8 月

- [查看 Microsoft](investigate-malicious-email-that-was-delivered.md#view-the-timeline-of-your-email) Defender for Office 365 (计划 1 或计划 2 的电子邮件时间线) 
...
- [查看网络钓鱼 URL，](threat-explorer.md#view-phishing-url-and-click-verdict-data) 然后单击 Microsoft Defender for Office 365 (计划 1 或计划 2 中的裁定) 

## <a name="microsoft-defender-for-office-365-plan-1-and-plan-2"></a>Microsoft Defender for Office 365 计划 1 和计划 2

你是否知道适用于 Office 365 的 Microsoft Defender 在两个计划中可用？ [详细了解每个计划包括哪些内容](defender-for-office-365.md#microsoft-defender-for-office-365-plan-1-and-plan-2)。
