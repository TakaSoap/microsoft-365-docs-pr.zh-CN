 ...
 **摘要：** 此解决方案将告知你 Office 365 中最常见的网络安全攻击的指示器是什么、如何积极确认任何给定的攻击以及如何响应它。
...
本系列文章可帮助你了解 Microsoft 365 中特定类型攻击可能的外观，并为你提供可采取响应的步骤。 它们是快速了解的入口点：
...
你的 Microsoft 365 订阅附带了一组强大的安全功能，可用于保护你的数据和用户。  使用 Microsoft 365 安全路线图 - 前 [30 天、前 90](security-roadmap.md) 天及之后的首要任务，实施 Microsoft 建议的最佳方案来保护 Microsoft 365 组织。
