...
Microsoft 提供各种云解决方案和服务，包括针对中小型企业的几个不同计划。 例如[，Microsoft 365 商业高级版](../../business/microsoft-365-business-overview.md)包括安全和设备管理功能以及生产力功能，如Office应用。 
...
**你不必拥有一个Microsoft 365购买和使用 Microsoft Defender for Business (预览版) 。** Microsoft Defender for Business (预览) 是一款适用于中小型企业的独立安全解决方案。 如果你已拥有其他订阅 (如 Microsoft 365 商业基础版 或 Standard) ，请考虑添加 Microsoft Defender for Business 以获得其他威胁防护功能。 

> [!TIP]
> 如果你的公司是小型企业或中型企业 (300) 并且你要注册 Microsoft Defender for Business 预览计划，请访问 [https://aka.ms/MDB-Preview](https://aka.ms/MDB-Preview) 。 若要了解更多信息，请参阅[获取 Microsoft Defender for Business。](get-defender-business.md)
...
> [!NOTE]
> 本文旨在提供 Microsoft Defender for Business 预览版和 (预览版中包含的威胁防护) Microsoft 365 商业高级版。 本文不用作服务说明或许可合同文档。 有关详细信息，请参阅Microsoft 365[安全与合规&指南](/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance)
...
| 反垃圾邮件保护 | 是 (设备)  | Yes (for Microsoft 365 email content， such as messages and attachments)  |
| 反恶意软件保护 | 是 (设备)  | Yes (for Microsoft 365 email content， such as messages and attachments)  |
...
Defender for Business (预览) 为中小型企业提供 Defender for Endpoint 的企业级功能。 下表将 Defender for Business 预览版中的安全特性 (与适用于终结点) 1 和 2 的 Microsoft Defender 进行比较。 <br/><br/>
