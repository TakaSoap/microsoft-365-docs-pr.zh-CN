...
如果现在运行的硬件运行 Windows 7 专业版或更高版本，可能满足 Microsoft 365 商业高级版的最低要求。 诸如 Cortana、Windows Hello 和多点触控之类的某些 Windows 10 功能需要使用仅在较新电脑上才有的特定硬件。 有关详细信息，请参阅 <a href="https://www.microsoft.com/windows/windows-10-specifications" target="_blank">Windows 10 专业版系统要求</a>。 
...
我们将在提供 Office 365 的地区向所有合作伙伴和客户提供 Microsoft 365 商业高级版。 请参阅 <a href="https://products.office.com/business/international-availability" target="_blank">Office 365 国际可用性</a>列表，了解有哪些语言版本以及在哪些国家和地区可用。 
...
### <a name="does-azure-active-directory-azure-ad-premium-p1-come-with-microsoft-365-business"></a>Microsoft 365 商业版是否附带 Azure Active Directory (Azure AD) Premium P1？ 

以前，Microsoft 365 商业版包含 Azure AD Premium Plan 1 功能的子集，包括条件访问、自助式密码重置和多重身份验证。 现在，我们正在将完整的 Azure AD Premium P1 许可证推出给 Microsoft 365 商业版订阅者，起初是向新客户，然后是向当前订阅者。 有关详细信息，请参阅 [Microsoft 365 商业版服务说明](https://docs.microsoft.com/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-business-service-description)和此[博客](https://techcommunity.microsoft.com/t5/small-and-medium-business-blog/azure-active-directory-premium-p1-is-coming-to-microsoft-365/ba-p/1275496)。
...
现在销售 Office 365 的合作伙伴可以使用相同的顾问式销售方法销售 Microsoft 365 商业高级版。 此外，我们将引入更多资源和培训，让你的销售团队了解客户的现有桌面环境、Active Directory 依赖性、移动性和安全性需求，从而采用与客户相关的方式有效传递 Microsoft 365 商业高级版的全部价值。 可在 Office Partner 门户上查找这些资源，网址为 [https://partners.office.com/microsoft365business](https://partners.office.com/microsoft365business)。 
...
Microsoft 提供了大量的精选资源，以供 CSP 合作伙伴推销、销售和支持 Microsoft 365 商业高级版。 可以在以下位置找到它们：[https://partners.office.com/microsoft365business](https://partners.office.com/microsoft365business)。
