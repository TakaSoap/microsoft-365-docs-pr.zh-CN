...
Microsoft 365 是融合同类的生产力工具、 安全性和设备管理功能的小型到中型企业的集成的解决方案。 
...
**企业级设备管理和安全功能** 
- 帮助提供从外部威胁像网络钓鱼和 Office 365 高级威胁保护与 Windows Defender 利用 Guard 复杂恶意软件保护 
-  帮助控制和管理如何敏感信息访问和使用 Office 365 数据丢失预防策略 （可在夏季完成，2018年） 传输和 Azure 信息保护计划 1 
-  帮助保护、 保留和备份您的数据与 Exchange Online Archiving  
-   Office 和 Intune 应用程序保护与其他移动应用程序的应用程序保护 
-  Windows 10 Pc、 MacOS 与移动设备使用 Intune 设备管理的设备管理 
-  跨设备-一致的安全配置保护公司数据跨设备-Windows Defender，始终和更新状态 
...
### <a name="who-should-consider-adopting-microsoft-365-business"></a>谁应该考虑采用 Microsoft 365 商业版？ 
...
Microsoft 365 企业版是免费提供美元 $20.00 用户每月基于_年度合同_，如果直接从 Microsoft 购买。时通过 Microsoft 合作伙伴购买，定价可能会因合作伙伴提供的服务和它们的定价模型上的 Microsoft 365 企业版。 
...
如果硬件运行立即运行 Windows 7 专业人员或更高版本，它可能符合 Microsoft 365 业务的最低要求。如 Cortana、 Windows Hello，和多点触控某些 Windows 10 功能需要才可用较新的 Pc 上的特定硬件。请参阅<a href="https://www.microsoft.com/windows/windows-10-specifications" target="_blank">Windows 10 专业人员的系统要求</a>的其他详细信息。 
...
Microsoft 365 业务为客户提供了启用员工的简单但功能强大方法用于其个人设备工作时提供的功能业务阻止这些设备访问、 保留和/或共享业务信息.更具体地说： 
* **Office 移动应用程序的应用程序保护**有助于保护 Office 数据，包括通过强制执行策略如经过了规定的时间段后自动删除业务数据的电子邮件、 日历、 联系人和 iOS 和 Android 的移动设备上的文档无法连接到服务，需要信息存储到 OneDrive for Business，仅需要 PIN 中的指纹验证从正在从 Office 应用程序复制到个人的应用程序访问 Office 应用程序，并防止公司数据。通过 Intune 其他移动应用程序的移动应用程序管理也是可用于 Microsoft 365 企业版订阅者。 
  
* 若要选择设置和强制执行的功能，如 Windows Defender 保护恶意软件、 自动更新和关闭屏幕过规定的一段时间后的**Windows 10 Pc 的设备管理**aallows 企业。此外，可以业务应用程序和数据通过管理中心完全擦除丢失或被盗 Windows 10 设备。 

* **适用于 iOS，Android 和 MacOS 设备管理**功能可帮助企业安全地管理包括 iOS、 Android、 Windows 和 macOS 设备不同设备生态系统。 
...
与 Microsoft 365 业务托管 Pc シ シ 术 シ Windows Defender，这是 Windows 10，保护抵御病毒、 恶意软件、 间谍软件和其他威胁比任何其他解决方案的更多计算机上的否。 1 防病毒功能。 使用 Microsoft 365 企业版，企业可以确保 Windows Defender 保护正在运行并始终保持最新所有 Windows 10 设备上。  
 
Windows 10 业务还包括 Windows Defender 利用 Guard，一组新的入侵防护功能。通过锁定文件夹和访问用户的重要文件防止未经授权的应用程序停止勒索软件中其跟踪其功能，受控文件夹访问之一。 
...
**Microsoft 365 业务**与移动应用程序管理和 Windows 10 专业人员启用远程管理，并帮助保护针对病毒、 恶意软件和设备结合使用 Office 365 应用程序和服务。它包括可能通过哪些设备和数据管理策略的简化的管理控制台。与 Microsoft 365 业务，可以最好地满足许多小型到中型企业。 
 
**Microsoft 365 企业版**是一套许可计划的增加的级别的合规性和安全管理提供通过 Microsoft 365 企业版和企业客户和那些具有超过 300 个用户的客户的设计。此外，Microsoft 365 企业版计划提供包括商业智能和分析工具的其他功能。
...
适用于 Csp Microsoft 365 业务试用版。试用版直接客户将提供更高版本。 
...
希望体验 Microsoft 365 业务的完整功能的客户必须在 Windows 7、 8.1 或 10 Pro<sup>[2](#footnote2)</sup>上运行其现有的桌面。现有的 Windows 10 专业人员 Pc 应创建者更新运行如果其尚未。 
...
是，Microsoft 365 企业版订阅者被授权完整 Intune 功能用于 iOS、 Android、 MacOS 和其他跨平台设备管理。可在完整 Intune 控制台中管理功能简化的管理控制台中 Microsoft 365 企业版，如第三方应用程序管理和配置等 WiFi 配置文件、 VPN 证书等内容不可用。   
  

### <a name="does-azure-active-directory-premium-p1-come-with-microsoft-365-business"></a>Azure Active Directory Premium P1 附带 Microsoft 365 Business？ 
Microsoft 365 企业版基于从技术构建的 microsoft 和它与 Azure Active Directory 共享某些功能时，就不完整版本。安全性和管理策略在 Microsoft 365 企业版中创建依赖于一些 Azure 功能，但不包括所有功能 （例如自助服务功能、 条件访问功能和报告）。客户可以选择作为 Microsoft 365 业务的一个加载项进行购买 Azure Active Directory Premium P1 或 P2。请[Microsoft 365 Business 服务说明](https://technet.microsoft.com/library/b042d1fd-c997-46d8-8c02-1df4c932f148)的详细信息，参阅 
...
尚不 Microsoft 合作伙伴的 IT 服务提供商可以了解 Microsoft 云解决方案提供商计划在[https://partners.office.com/microsoft365business](https://partners.office.com/microsoft365business)。

### <a name="where-can-i-learn-how-to-sell-microsoft-365-business"></a>在哪里可以了解如何销售 Microsoft 365 商业版？ 
现在销售的 Office 365 的合作伙伴可以使用相同的咨询销售方法销售 Microsoft 365 企业版。此外，我们将介绍更多资源和培训销售团队了解客户的现有桌面环境、 Active Directory シ、 移动和安全需要进行有效地通信 Microsoft 365 业务的完整值与客户相关的方式。在 Office 合作伙伴门户上查找这些资源[http://partners.office.com/microsoft365business](http://partners.office.com/microsoft365business)。 

### <a name="how-can-microsoft-365-business-help-partners-increase-the-profitability"></a>Microsoft 365 商业版如何帮助合作伙伴提高盈利能力？ 
Microsoft 365 业务有助于提高运营效率通过降低成本和提高到其他服务的销售收入伙伴。Forrester Research，Microsoft 365 业务总体经济影响 (TEI) 研究 2017 年 6 月 (https://partners.office.com/TEIBusiness)，演示 Microsoft 365 业务是否会对合作伙伴利润中积极的影响。 
...
Microsoft 提供的多种选择的 CSP 合作伙伴市场、 销售和支持 Microsoft 365 企业版的资源。它们可在找到[https://partners.office.com/microsoft365business](https://partners.office.com/microsoft365business)。

### <a name="what-up-sell-opportunities-does-microsoft-365-business-give-partners"></a>Microsoft 365 商业版会向合作伙伴提供哪些追加销售机会？ 
...
常规数据保护法规 (GDPR) 是全面的新隐私法律提供居民欧盟 （欧盟） 更好地控制其"个人数据"，并且需要组织维护的个人数据的完整性。GDPR 需要组织，该控件或个人数据绑定到欧盟居民只使用满足个人数据处理的 GDPR 要求的第三方数据处理器的过程。在年 3 月 2017 Microsoft 进行可用合同保证这些的保证。有关 Microsoft 如何帮助他们满足其其他 GDPR 义务问题的客户应了解的高级合规性和加载项 (例如 Azure 信息保护，数据丢失防护 Advnaced 作为可用的安全功能威胁保护、 等。）和其他套件 (例如 Microsoft 365 Enterprise E5)。若要了解详细信息，请访问[www.microsoft.com/gdpr](https://www.microsoft.com/gdpr)。
