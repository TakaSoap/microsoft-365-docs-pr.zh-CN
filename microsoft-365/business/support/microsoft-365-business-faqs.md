...
**企业级设备管理和安全功能** 
- 帮助提供与 Office 365 高级威胁防护计划1和 Windows Defender 利用防护机制类似的网络钓鱼 & 完善的恶意软件之类的外部威胁保护。 
-  帮助控制 & 管理如何使用 Office 365 数据丢失防护策略和 Azure 信息保护计划1来访问和传输敏感信息。 
-  使用 Exchange Online 存档帮助保护、保留和备份数据。  
-   Office 相关应用程序保护 & 其他具有 Intune 应用保护的移动应用程序。 
-  适用于 Windows 10 电脑的设备管理，MacOS & 使用 Intune 设备管理的 Mobiles 设备。 
-  具有多重身份验证、自助服务密码重置和条件访问的身份保护。
-  跨设备的一致性安全配置-跨设备保护公司数据-Windows Defender、始终启用和最新版本。 
...
- 确保连接到你的业务的设备安全，并帮助确保你的 iOS、Android、Windows 和 Mac 设备上的数据安全，以及你的 Windows 设备最新。

Microsoft 365 Business 与 Office 365 完全集成，为你提供熟悉的管理、帐单和24x7 支持的位置。 它包含企业级技术，为员工人数少于300的企业构建。 
...
Windows 10 商业版是一组云服务和设备管理功能，能够对 Windows 10 专业版加以补充并实现 Microsoft 365 商业版集中管理和安全控制。
...
如果你的设备具有 Windows 7、8 和 8.1 专业版的许可证，则 Microsoft 365 商业版会将操作系统升级到 Windows 10 专业版，此专业版是部署 Windows 10 商业版的先决条件。
> [!IMPORTANT]
...
是的，已授权 Microsoft 365 商业订阅者使用适用于 iOS、Android、MacOS 和其他跨平台设备管理的完整 Intune 功能。 在 Microsoft 365 商业版的简化管理控制台中不可用的功能（如第三方应用程序管理和 WiFi 配置文件的配置、VPN 证书等）可以在完整 Intune 控制台中进行管理。 
...
Microsoft 365 业务包括选择 Azure AD 高级 P1 （AADP P1）功能，如自助服务密码重置（使用 AD 写回、Azure MFA 和条件访问）。 它不包括 AADP P1 的全部。 有关详细信息，请参阅[Microsoft 365 商业服务说明](https://technet.microsoft.com/library/b042d1fd-c997-46d8-8c02-1df4c932f148)。 
...
一般数据保护条例 (GDPR) 是一项全面的新隐私法，使欧盟 (EU) 居民能够更好地控制其“个人资料”，并要求组织保持个人资料的完整性。 对于控制或处理与欧盟居民相关的个人资料的组织，GDPR 要求其只使用符合 GDPR 的个人资料处理要求的第三方数据处理器。 2017 年 3 月，Microsoft 提供了合同规定的担保以提供这些保证。 有关 Microsoft 如何帮助他们满足其额外的 GDPR 义务的客户应了解 Microsoft 365 企业中提供的高级合规性和安全功能（例如 Azure 信息保护、数据丢失预防、高级威胁防护等）以及其他套件（例如 Microsoft 365 企业版 E5）。 若要了解详细信息，请访问 [www.microsoft.com/gdpr](https://www.microsoft.com/gdpr)。
