...
|**设置**|**说明**|
|:-----|:-----|
|跳过 Cortana、OneDrive 和 OEM 注册  <br/> |跳过安装使用者应用程序，如 Cortana 和个人 OneDrive。 只要用户是设备上的本地管理员，设备用户就可以在以后安装这些设备。 由于设备将由 Microsoft 365 商业版管理，因此将跳过原始制造商注册。  <br/> |
...
|使用已配置的 AAD 帐户的 MDM 自动注册。  <br/> |用户标识将由 Azure Active Directory 管理，并且用户将使用其 Microsoft 365 商业版凭据登录到 Windows 和 Office 365。  <br/> |
