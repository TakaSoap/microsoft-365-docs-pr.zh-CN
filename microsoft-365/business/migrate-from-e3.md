...
Microsoft 365 商业高级版具有 50 GB 的存储限制，因为它使用 Exchange Online 计划1。 迁移到 Microsoft 365 商业高级版时，如果你的任何用户超过 50 GB 的邮箱存储，建议你为此用户分配 Exchange Online 计划2并删除 Exchange Online 计划1，因为这两种方法都不可行。
