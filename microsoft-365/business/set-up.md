...
购买Microsoft 365 商业高级版时，可以选择使用你拥有的域，或在注册期间购买[一个](sign-up.md)域。
...
在左侧导航上，选择"**设置**"，然后在"登录和安全"下，选择"保护 **Windows 10计算机"。** 选择 **"视图** "开始。 请参阅[保护Windows 10](secure-win-10-pcs.md)计算机，了解完整说明。
...
若要在Office iOS 或 Android 设备上安装设备，请参阅为用户[Microsoft 365 商业高级版移动设备](set-up-mobile-devices.md)。
