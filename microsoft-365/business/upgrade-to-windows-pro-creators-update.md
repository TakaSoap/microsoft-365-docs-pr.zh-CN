...
1. 若要升级到 Windows 10 专业版创意者更新, 您有多个选项。 可以执行下列操作：
    
    - 从[Microsoft 软件下载网站](https://go.microsoft.com/fwlink/?LinkID=836951 )安装升级-如果你登录的设备与您要更新的设备位于同一设备上, 请选择此选项。
    
      a. 在软件下载网站中, 单击 "**立即更新**" 以开始将设备升级到 Windows 10 Pro 创意者更新。 
