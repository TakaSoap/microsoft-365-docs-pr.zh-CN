...
观看有关将设备Windows到 Windows 10 专业版 的简短视频。<br><br>
...
请参阅[为Windows用户设置Microsoft 365设备以](set-up-windows-devices.md)完成设备Windows 10设置。 
  
请参阅[为企业用户设置Microsoft 365，](set-up-mobile-devices.md)以完成 Android 和 iOS 设备的设置。 
