...
> [!IMPORTANT]
> 如果要将与当前计划的数据相关服务的计划更改为较少 (降级) ，则需要手动备份任何要保留的数据。 有关详细信息，请参阅 [在更改计划前备份数据](back-up-data-before-switching-plans.md)。
...
- **如果你购买了两个订阅，但未在此处列出它们**，则可能是为不同的) 域 (不同的组织购买的。 订阅无法跨组织边界。
