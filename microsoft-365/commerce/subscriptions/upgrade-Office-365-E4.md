...
本文将分步说明从 Office 365 E4 升级到新订阅的过程。 有关从 Office 365 E4 升级时可用的选项的信息，请参阅 [Office 365 E4](important-information-e4.md)客户的重要信息。

> [!IMPORTANT]
> 本文仅适用于通过信用卡或发票直接从 Microsoft 购买的 Office 365 E4 订阅。 如果你的订阅是通过其他方式（例如通过合作伙伴或批量许可服务中心）购买的，请联系你的 Microsoft 帐户代表或合作伙伴，以帮助你升级计划。

## <a name="what-are-my-options-for-how-to-upgrade"></a>我提供了哪些升级选项？

升级计划的最简单方法是使用 Microsoft 365 管理中心中的"升级"选项卡。  但是，并非所有 **情况** 都支持使用"升级"选项卡。 如果您的方案不受支持，您可以手动升级计划。
...
如果你通过发票为新计划付款，或购买超过一定费用，则可能需要核实信用。 如果需要进行信用检查，升级最多可能需要两个工作日。 在信用检查完成之前，管理员无法访问 Microsoft 365 管理中心。 但是，在升级完成之前，用户仍可完全访问 E4 计划。
...
- **规划管理停机时间。** 计划升级期间，管理员无法使用 Microsoft 365 管理中心。 根据您拥有的用户数，升级可能需要几分钟到几小时。 我们建议你计划当不需要使用 Microsoft 365 管理中心进行更新时执行升级。
...
5. 在" **购物车** "页上，验证一切是否正确。 选择是按月还是按年支付，并验证数量下的 **许可证数量**。
    > [!NOTE]
    > 还会列出与 Office 365 E4 订阅关联的任何附加订阅，如 Office 365 额外文件存储。 但是，如果你有要升级到的订阅中包含的任何附加订阅，我们将删除它们。
6. 查看订单后，选择" **转到"以签出**。
...
如果还没有新订阅，可以购买另一个 Microsoft [365 商业版订阅](../try-or-buy-microsoft-365.md)。
...
3. 确保显示新订阅，并且许可证数量与 Office 365 E4 相同。
4. 如果你需要购买更多许可证，请按照购买或删除订阅许可证 [中的步骤操作](../licenses/buy-licenses.md)。

### <a name="step-3-reassign-licenses-to-users"></a>步骤 3：向用户重新分配许可证

可以使用 Microsoft 365 管理中心一次最多为 20 个用户重新分配许可证。 若要了解如何，请参阅 [将用户移动到其他订阅](move-users-different-subscription.md)。
