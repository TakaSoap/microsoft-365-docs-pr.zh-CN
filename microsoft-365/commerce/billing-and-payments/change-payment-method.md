...
> [!NOTE]
> 仅当您的订阅成本超过一定金额 (取决于服务位置) 时，按发票付款的选项才可用。 较大数额的发票付款可能要求进行信用检查。 若要了解详细信息，请参阅 [订阅的付费](pay-for-your-subscription.md)。
...
> [!NOTE]
> 如果你的订阅成本在一定数额的金钱下 (则此金额因服务位置) 而异，发票付款方式不可用作选项。 如果你的订阅费用超过一定金额，则可以选择按发票付款。 较大数额的发票付款可能要求进行信用检查。
